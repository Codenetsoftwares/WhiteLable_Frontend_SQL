    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        function f(t, e) {
          ...
          if (e.singleton) {
            var r = u++;
            (n = h || (h = c(e))), (i = d.bind(null, n, r, !1)), (o = d.bind(null, n, r, !0));
          } else
            (n = c(e)),
              (i = function (t, e, n) {
                var i = n.css,
      ...
      function (t, e, n) {
        ...
        (function (t) {
          ...
          if (o.CKEDITOR_VERSION)
            throw new i.b('ckeditor-duplicated-modules: Some CKEditor 5 modules are duplicated.', null);
      ...
      function (t, e, n) {
        ...
        var Mt = function (t, e) {
          ...
          if (n instanceof D) {
            var i = n.__data__;
            if (!st || i.length < St - 1) return i.push([t, e]), (this.size = ++n.size), this;
        ...
        (Et.prototype.clear = L),
          (Et.prototype.delete = j),
          (Et.prototype.get = V),
          (Et.prototype.has = z),
          (Et.prototype.set = Mt);
        var It = Et;
        ...
        var Rt = function (t, e, n) {
            '__proto__' == e && Ot
              ? Ot(t, e, { configurable: !0, enumerable: !0, value: n, writable: !0 })
              : (t[e] = n);
          },
        ...
        var pe = function (t) {
          ...
          var e = ae(t),
            n = [];
          for (var i in t) ('constructor' != i || (!e && ge.call(t, i))) && n.push(i);
          return n;
        };
        var be = function (t) {
        ...
        var Ne = function (t) {
          ...
          Fe = K(Le),
          Ue = g;
        ((Oe && '[object DataView]' != Ue(new Oe(new ArrayBuffer(1)))) ||
          (st && '[object Map]' != Ue(new st())) ||
          (Re && '[object Promise]' != Ue(Re.resolve())) ||
          (De && '[object Set]' != Ue(new De())) ||
          (Le && '[object WeakMap]' != Ue(new Le()))) &&
          (Ue = function (t) {
            var e = g(t),
        ...
        (Bn[Ln] =
          ...
          Bn['[object Uint32Array]'] =
            !0),
          (Bn['[object Error]'] = Bn[jn] = Bn['[object WeakMap]'] = !1);
        var Fn = function t(e, n, i, o, r, s) {
            ...
            if (h) {
              ...
              if (u == zn || u == Ln || (f && !r)) {
                if (((a = l || f ? {} : An(e)), !c)) return l ? Me(e, we(a, e)) : Ce(e, fe(a, e));
              } else {
                if (!Bn[u]) return r ? e : {};
                a = vn(e, u, c);
              }
          ...
          fire(t, ...e) {
            ...
            let o = (function t(e, n) {
              ...
              if (!e._events || !(i = e._events[n]) || !i.callbacks.length)
                return n.indexOf(':') > -1 ? t(e, n.substr(0, n.lastIndexOf(':'))) : null;
              return i.callbacks;
            })(this, i);
            if ((n.path.push(this), o)) {
              ...
              for (
                ...
                n.off.called && (delete n.off.called, ai(this, i, o[e].callback)),
                !n.stop.called);
                e++
              );
            }
        ...
        class ui {
          ...
          get index() {
            ...
            if (-1 == (t = this.parent.getChildIndex(this)))
              throw new Gn.b("view-node-not-found-in-parent: The node's parent does not contain this node.", this);
            return t;
          }
          get nextSibling() {
            const t = this.index;
        ...
        class ki extends ui {
          constructor(t, e, n) {
            ...
            (this._styles = new Map()),
              this._attrs.has('style') && (_i(this._styles, this._attrs.get('style')), this._attrs.delete('style')),
          ...
          *getAttributes() {
            yield* this._attrs.entries(),
              ...
              this._styles.size > 0 && (yield ['style', this.getAttribute('style')]);
          }
          getAttribute(t) {
          ...
          *getCustomProperties() {
          ...
          getIdentity() {
            const t = Array.from(this._classes).sort().join(','),
              ...
              n = Array.from(this._attrs)
                ...
                .join(' ');
            return (
              this.name + ('' == t ? '' : ` class="${t}"`) + ('' == e ? '' : ` style="${e}"`) + ('' == n ? '' : ` ${n}`)
            );
          }
          _clone(t = !1) {
            const e = [];
          ...
          _insertChild(t, e) {
            ...
            const i = (function (t) {
              ...
              return Array.from(t).map((t) =>
                'string' == typeof t ? new fi(t) : t instanceof mi ? new fi(t.data) : t,
              );
            })(e);
            for (const e of i)
          ...
          _setAttribute(t, e) {
            (e = String(e)),
              ...
              'class' == t ? vi(this._classes, e) : 'style' == t ? _i(this._styles, e) : this._attrs.set(t, e);
          }
          _removeAttribute(t) {
            return (
              this._fireChange('attributes', this),
          ...
          _removeStyle(t) {
            this._fireChange('attributes', this),
              (t = Array.isArray(t) ? t : [t]).forEach((t) => this._styles.delete(t));
          }
        ...
        class yi extends ki {
          ...
          is(t, e = null) {
            ...
            return e
              ? ('containerElement' == n && e == this.name) || super.is(t, e)
              : 'containerElement' == n || super.is(t);
          }
        }
        function xi() {
        ...
        var Pi = function (t, e, n) {
          return (
            (e = Ci(void 0 === e ? t.length - 1 : e, 0)),
            function () {
              for (var i = arguments, o = -1, r = Ci(i.length - e, 0), s = Array(r); ++o < r; ) s[o] = i[e + o];
              o = -1;
              for (var a = Array(e + 1); ++o < e; ) a[o] = i[o];
              return (a[e] = n(s)), Ti(t, this, a);
            }
          );
        };
        var Si = function (t) {
          ...
          Mi = Ot
            ? function (t, e) {
                return Ot(t, 'toString', { configurable: !0, enumerable: !1, value: Si(e), writable: !0 });
              }
            : Ai,
          Ei = 800,
          Ii = 16,
          ...
          return Ri(function (e, n) {
            ...
            for (
              r = t.length > 3 && 'function' == typeof r ? (o--, r) : void 0,
                s && Di(n[0], n[1], s) && ((r = o < 3 ? void 0 : r), (o = 1)),
                e = Object(e);
              ++i < o;
        ...
        const ji = Symbol('observableProperties'),
          ...
          Bi = {
            ...
            bind(...t) {
              ...
              t.forEach((t) => {
                if (e.has(t))
                  throw new Gn.b('observable-bind-rebind: Cannot bind the same property more that once.', this);
              });
              const n = new Map();
              return (
                t.forEach((t) => {
                ...
                { to: Hi, toMany: qi, _observable: this, _bindProperties: t, _to: [], _bindings: n }
              );
            },
            unbind(...t) {
                ...
                t.forEach((t) => {
                  ...
                  i.to.forEach((t) => {
                    (o = t[0]),
                      ...
                      (a = s[r]).delete(i),
                      a.size || delete s[r],
                      Object.keys(s).length || (n.delete(o), this.stopListening(o, 'change'));
                  }),
                    e.delete(t);
                });
              } else
        ...
        function Ui(t) {
          ji in t ||
            ...
            Object.defineProperty(t, Vi, { value: new Map() }),
            Object.defineProperty(t, zi, { value: new Map() }));
        }
        function Hi(...t) {
          const e = (function (...t) {
          ...
          e.to.forEach((t) => {
            if (t.properties.length && t.properties.length !== i)
              throw new Gn.b('observable-bind-to-properties-length: The number of properties must match.', this);
        ...
        class Gi extends yi {
          ...
          is(t, e = null) {
            const n = t && t.replace(/^view:/, '');
            return e
              ? ('editableElement' == n && e == this.name) || super.is(t, e)
              : 'editableElement' == n || super.is(t);
          }
          destroy() {
            this.stopListening();
          }
        ...
        class Ji {
              ...
              if (this.singleCharacters) return (t = new Zi(i, 0)), (this.position = t), this._next();
              {
                ...
                return (
                  i == this._boundaryEndParent
                    ? ((o = this.boundaries.end.offset), (n = new mi(i, 0, o)), (t = Zi._createAfter(n)))
                    : ((n = new mi(i, 0, i.data.length)), t.offset++),
                  (this.position = t),
          ...
          _formatReturnValue(t, e, n, i, o) {
            return (
              ...
              { done: !1, value: { type: t, item: e, previousPosition: n, nextPosition: i, length: o } }
            );
          }
        }
        class Zi {
          ...
          static _createAfter(t) {
            ...
            if (!t.parent)
              throw new Gn.b('view-position-after-root: You can not make position after root.', t, { root: t });
            return new Zi(t.parent, t.index + 1);
          }
          static _createBefore(t) {
            if (t.is('textProxy')) return new Zi(t.textNode, t.offsetInText);
            if (!t.parent)
              throw new Gn.b('view-position-before-root: You can not make position before root.', t, { root: t });
          ...
          *[Symbol.iterator]() {
          ...
          getTrimmed() {
            ...
            const n = t.nodeAfter,
              i = e.nodeBefore;
            return (
              n && n.is('text') && (t = new Zi(n, 0)), i && i.is('text') && (e = new Zi(i, i.data.length)), new Xi(t, e)
            );
          }
          isEqual(t) {
          ...
          *getRanges() {
          ...
          getSelectedElement() {
            ...
            let e = t.start.nodeAfter,
              n = t.end.nodeBefore;
            return (
              t.start.parent.is('text') &&
                t.start.isAtEnd &&
                t.start.parent.nextSibling &&
                (e = t.start.parent.nextSibling),
              t.end.parent.is('text') &&
                t.end.isAtStart &&
                t.end.parent.previousSibling &&
                (n = t.end.parent.previousSibling),
              e instanceof ki && e == n ? e : null
            );
          }
          setTo(t, e, n) {
            if (null === t) this._setRanges([]), this._setFakeOptions(e);
              ...
              (o = 'in' == e ? Xi._createIn(t) : 'on' == e ? Xi._createOn(t) : new Xi(Zi._createAt(t, e))),
                this._setRanges([o], i),
          ...
          setFocus(t, e) {
            ...
            const i = this.anchor;
            this._ranges.pop(),
              'before' == n.compareWith(i) ? this._addRange(new Xi(n, i), !0) : this._addRange(new Xi(i, n)),
              this.fire('change');
          }
          is(t) {
        ...
        class oo {
          ...
          add(t, e) {
            ...
            else if (e > this._items.length || e < 0) throw new Gn.b('collection-add-item-invalid-index', this);
          ...
          remove(t) {
            ...
            if (
              ('string' == typeof t
                ? ((n = t), (o = !(i = this._itemMap.get(n))), i && (e = this._items.indexOf(i)))
                : 'number' == typeof t
                  ? ((e = t), (o = !(i = this._items[e])), i && (n = i[r]))
                  : ((n = (i = t)[r]), (o = -1 == (e = this._items.indexOf(i)) || !this._itemMap.get(n))),
              o)
            )
              throw new Gn.b('collection-remove-404: Item not found.', this);
        ...
        class ro {
          constructor() {
            (this.selection = new io()),
              (this.roots = new oo({ idProperty: 'rootName' })),
        ...
        class ao extends ki {
          ...
          is(t, e = null) {
            const n = t && t.replace(/^view:/, '');
            return e
              ? ('attributeElement' == n && e == this.name) || super.is(t, e)
              : 'attributeElement' == n || super.is(t);
          }
          isSimilar(t) {
        ...
        class ho extends ki {
          constructor(t, e, n) {
            super(t, e, n), (this.getFillerOffset = uo);
          }
          is(t, e = null) {
            const n = t.replace(/^view:/, '');
          ...
          _insertChild(t, e) {
            if (e && (e instanceof ui || Array.from(e).length > 0))
        ...
        function wo(t) {
          let e;
          if ('string' == typeof t) {
            if (!(e = bo[t.toLowerCase()])) throw new Gn.b('keyboard-unknown-key: Unknown key name.', null, { key: t });
          } else e = t.keyCode + (t.altKey ? bo.alt : 0) + (t.ctrlKey ? bo.ctrl : 0) + (t.shiftKey ? bo.shift : 0);
          return e;
        }
        function ko(t) {
          return (
            'string' == typeof t && (t = _o(t)),
            t.map((t) => ('string' == typeof t ? wo(t) : t)).reduce((t, e) => e + t, 0)
          );
        }
        function _o(t) {
          return t.split(/\s*\+\s*/);
        ...
        class To {
          ...
          insert(t, e) {
            (function t(e, n) {
              for (const i of e) {
                if (!Io.some((t) => i instanceof t)) throw new Gn.b('view-writer-insert-invalid-node', n);
                i.is('text') || t(i.getChildren(), n);
              }
            })((e = pi(e) ? [...e] : [e]), this.document);
            const n = Co(t);
          ...
          rename(t, e) {
            ...
            return (
              this.insert(Zi._createAfter(e), n),
              this.move(Xi._createIn(e), Zi._createAt(n, 0)),
          ...
          _wrapChildren(t, e, n, i) {
            ...
            for (; o < n; ) {
              const e = t.getChild(o),
                ...
                a = e.is('emptyElement'),
                c = e.is('uiElement');
              if (s && this._wrapAttributeElement(i, e)) r.push(new Zi(t, o));
              else if (n || a || c || (s && Po(i, e))) {
                const n = i._clone();
                e._remove(),
                  n._appendChild(e),
                  t._insertChild(o, n),
              ...
              if (e.is('attributeElement'))
                if (e.isSimilar(i)) {
                  ...
                  e._remove(),
                    ...
                    r.push(new Zi(t, o), new Zi(t, o + s)),
                    (o += s),
                    (n += s - 1);
                } else
          ...
          _wrapPosition(t, e) {
            ...
            const r = o.nodeBefore,
              s = o.nodeAfter;
            return r instanceof fi && s instanceof fi ? Eo(r, s) : So(o);
          }
          ...
          _breakAttributes(t, e = !1) {
            ...
            if (i.is('text')) return this._breakAttributes(Mo(t), e);
            if (n == i.childCount) {
        ...
        function Mo(t) {
          ...
          return (
            ...
            t.parent.parent._insertChild(t.parent.index + 1, new fi(e)),
        ...
        const Lo = (t) => {
          ...
          Vo = 7;
        let zo = '';
        for (let t = 0; t < Vo; t++) zo += '​';
        function Bo(t) {
          return Do(t) && t.data.substr(0, Vo) === zo;
        }
        function Fo(t) {
          return t.data.length == Vo && Bo(t);
        }
        function Uo(t) {
          return Bo(t) ? t.data.slice(Vo) : t.data;
        }
        ...
        function Qo(t, e, n) {
          ...
          let f,
            m = 0;
          do {
            for (f = -m; f < l; f++) h[f] = u(f);
            for (f = l + m; f > l; f--) h[f] = u(f);
            (h[l] = u(l)), m++;
          } while (h[l] !== c);
          return d[l].slice(1);
        }
        ...
        class Xo {
          ...
          render() {
            ...
            if (t) {
              ...
              Bo(e.parent) ? (this._inlineFiller = e.parent) : (this._inlineFiller = tr(n, e.parent, e.offset));
              ...
              for (const o of r)
                if ('replace' === o) {
                  const o = e.equal + e.insert,
                    r = e.equal + e.delete,
                    s = t.getChild(o);
                  s && !s.is('uiElement') && this._updateElementMappings(s, n[r]), Jo(i[o]), e.equal++;
                } else e[o]++;
            }
          }
          ...
          _updateChildren(t, e) {
            ...
            const i = e.inlineFillerPosition,
              ...
              r = Array.from(
                this.domConverter.viewChildrenToDom(t, n.ownerDocument, { bind: !0, inlineFillerPosition: i }),
              );
            ...
            for (const a of t)
              'insert' === a
                ...
                : 'delete' === a
                  ...
                  : ((i = i.concat(Qo(o, r, er).map((t) => ('equal' === t ? 'replace' : t)))).push('equal'),
                    (o = []),
                    (r = [])),
                s[a]++;
          ...
          _updateFakeSelection(t) {
            ...
            n ||
              ((this._fakeSelectionContainer = n = e.createElement('div')),
              Object.assign(n.style, { position: 'fixed', top: 0, left: '-9999px', width: '42px' }),
              (n.textContent = ' ')),
        ...
        function tr(t, e, n) {
          ...
          {
            const o = t.createTextNode(zo);
            return Array.isArray(e) ? i.splice(n, 0, o) : Ko(e, n, o), o;
          }
        }
        function er(t, e) {
        ...
        class rr {
          constructor(t = {}) {
            (this.blockFiller = t.blockFiller || Lo),
          ...
          viewToDom(t, e, n = {}) {
            ...
            }
            {
              ...
              if (t.is('documentFragment'))
                (i = e.createDocumentFragment()), n.bind && this.bindDocumentFragments(i, t);
              else {
          ...
          *viewChildrenToDom(t, e, n = {}) {
          ...
          viewPositionToDom(t) {
            ...
            if (e.is('text')) {
              ...
              if (!n) return null;
              let i = t.offset;
              return Bo(n) && (i += Vo), { parent: n, offset: i };
            }
            {
              let n, i, o;
              if (0 === t.offset) {
                ...
                const e = t.nodeBefore;
                if (!(i = e.is('text') ? this.findCorrespondingDomText(e) : this.mapViewToDom(t.nodeBefore)))
                  return null;
                (n = i.parentNode), (o = i.nextSibling);
              }
              if (Do(o) && Bo(o)) return { parent: o, offset: Vo };
              return { parent: n, offset: i ? ir(i) + 1 : 0 };
            }
          }
          domToView(t, e = {}) {
            ...
            if (this.isComment(t)) return null;
            {
              ...
              if (this.isDocumentFragment(t)) (n = new Ao()), e.bind && this.bindDocumentFragments(t, n);
                ...
                (n = new ki(i)), e.bind && this.bindElements(t, n);
          ...
          *domChildrenToView(t, e = {}) {
          ...
          domPositionToView(t, e) {
            ...
            if (Do(t)) {
              ...
              let i = e;
              return n ? (Bo(t) && (i = (i -= Vo) < 0 ? 0 : i), new Zi(n, i)) : null;
            }
            if (0 === e) {
          ...
          focus(t) {
            ...
            if (e && e.ownerDocument.activeElement !== e) {
              const { scrollX: t, scrollY: n } = nr.window,
                i = [];
              ar(e, (t) => {
        ...
        var yr = function (t, e, n, i, o, r) {
          ...
          for (r.set(t, e), r.set(e, t); ++d < a; ) {
            ...
            if (u) {
              if (
                !wr(e, function (t, e) {
                  if (!kr(u, e) && (f === t || o(f, t, n, i, r))) return u.push(e);
                })
              ) {
                h = !1;
                break;
        ...
        var Ar = function (t) {
          ...
          zr = Vr ? Vr.valueOf : void 0;
        var Br = function (t, e, n, i, o, r, s) {
            switch (n) {
              case jr:
        ...
        var Qr = function (t, e, n, i, o, r) {
          ...
          if (u && !d) return r || (r = new It()), s || ie(t) ? yr(t, e, n, i, o, r) : Br(t, e, c, n, i, o, r);
          if (!(n & qr)) {
          ...
          _onMutations(t) {
            ...
            for (const o of t) {
              ...
              if ((!t || !t.is('uiElement')) && 'characterData' === o.type) {
                ...
                t && !i.has(t.parent)
                  ? n.set(t, { type: 'text', oldText: t.data, newText: Uo(o.target), node: t })
                  : !t && Bo(o.target) && i.add(e.mapDomToView(o.target.parentNode));
              }
            }
            const o = [];
        ...
        var gs = function (t, e, n) {
          ...
          function b() {
            ...
            if (((i = arguments), (o = this), (c = t), n)) {
              ...
              if (h) return clearTimeout(a), (a = setTimeout(g, e)), f(c);
            }
          ...
          return (
            ...
            B(n) &&
              ((d = !!n.leading),
              (r = (h = 'maxWait' in n) ? fs(hs(n.maxWait) || 0, e) : r),
        ...
        class ps extends ur {
          constructor(t) {
            super(t),
              (this._fireSelectionChangeDoneDebounced = gs((t) => this.document.fire('selectionChangeDone', t), 200));
          }
          observe() {
          ...
          _handleSelectionMove(t) {
            const e = this.document.selection,
              n = new no(e.getRanges(), { backward: e.isBackward, fake: !1 });
            (t != bo.arrowleft && t != bo.arrowup) || n.setTo(n.getFirstPosition()),
              (t != bo.arrowright && t != bo.arrowdown) || n.setTo(n.getLastPosition());
        ...
        class bs extends ur {
          constructor(t) {
            super(t),
              (this.mutationObserver = t.getObserver(Zr)),
          ...
          _handleSelectionChange(t) {
            ...
            if (
              !(
                (this.selection.isEqual(n) && this.domConverter.isDomSelectionCorrect(e)) ||
        ...
        class As {
          constructor(t) {
            ...
            if (
              ...
              Ts(this, e ? As.getDomRangeRects(t)[0] : t.getBoundingClientRect());
            else if (cr(t)) {
              const { innerWidth: e, innerHeight: n } = t;
              Ts(this, { top: 0, right: e, bottom: n, left: 0, width: e, height: n });
            } else Ts(this, t);
          }
          clone() {
            return new As(this);
          ...
          getIntersection(t) {
            ...
            return (
              ...
              e.width < 0 || e.height < 0 ? null : new As(e)
            );
          }
          ...
          isEqual(t) {
            for (const e of xs) if (this[e] !== t[e]) return !1;
            return !0;
          }
          contains(t) {
            const e = this.getIntersection(t);
          ...
          static getDomRangeRects(t) {
            ...
            if (n.length) for (const t of n) e.push(new As(t));
            else {
        ...
        function Ps({ target: t, viewportOffset: e = 0 }) {
          const n = Rs(t);
          let i = n,
            o = null;
          for (; i; ) {
            let r;
            Ms((r = Ds(i == n ? t : o)), () => Ls(t, i));
            const s = Ls(t, i);
            if ((Ss(i, s, e), i.parent != i)) {
        ...
        function Ss(t, e, n) {
          ...
          if (![o, i].every((t) => r.contains(t))) {
            ...
            Is(o, r) ? (a -= r.top - e.top + n) : Es(i, r) && (a += e.bottom - r.bottom + n),
              Ns(e, r) ? (s -= r.left - e.left + n) : Os(e, r) && (s += e.right - r.right + n),
              t.scrollTo(s, a);
          }
        }
        function Ms(t, e) {
          ...
          for (; t != n.document.body; )
            (o = e()),
              (i = new As(t).excludeScrollbarsAndBorders()).contains(o) ||
                (Is(o, i) ? (t.scrollTop -= i.top - o.top) : Es(o, i) && (t.scrollTop += o.bottom - i.bottom),
                Ns(o, i) ? (t.scrollLeft -= i.left - o.left) : Os(o, i) && (t.scrollLeft += o.right - i.right)),
              (t = t.parentNode);
        }
        function Es(t, e) {
        ...
        class js {
          constructor() {
            (this.document = new ro()),
              (this.domConverter = new rr()),
              ...
              (this._writer = new To(this.document)),
              this.addObserver(Zr),
              this.addObserver(bs),
              this.addObserver(ws),
              this.addObserver(es),
              this.addObserver(ps),
              this.addObserver(ks),
              mo.isAndroid && this.addObserver(_s),
              (function (t) {
          ...
          attachDomRoot(t, e = 'main') {
            ...
            for (const { name: e, value: o } of Array.from(t.attributes))
              (i[e] = o), 'class' === e ? this._writer.addClass(o.split(' '), n) : this._writer.setAttribute(e, o, n);
          ...
          scrollToTheSelection() {
            ...
            t && Ps({ target: this.domConverter.viewRangeToDom(t), viewportOffset: 20 });
          }
          focus() {
        ...
        class zs {
          ...
          get index() {
            ...
            if (null === (t = this.parent.getChildIndex(this)))
              throw new Gn.b("model-node-not-found-in-parent: The node's parent does not contain this node.", this);
            return t;
          }
          get startOffset() {
            let t;
        ...
        class Bs extends zs {
          ...
          _clone() {
            return new Bs(this.data, this.getAttributes());
          }
          static fromJSON(t) {
            return new Bs(t.data, t.attributes);
          }
        }
        class Fs {
          constructor(t, e, n) {
        ...
        class Us {
          ...
          indexToOffset(t) {
            ...
            if (!e)
              throw new Gn.b('model-nodelist-index-out-of-bounds: Given index cannot be found in the node list.', this);
        ...
        class Hs extends zs {
          ...
          _insertChild(t, e) {
            const n = (function (t) {
              if ('string' == typeof t) return [new Bs(t)];
              pi(t) || (t = [t]);
              return Array.from(t).map((t) =>
                'string' == typeof t ? new Bs(t) : t instanceof Fs ? new Bs(t.data, t.getAttributes()) : t,
              );
            })(e);
          ...
          static fromJSON(t) {
            ...
            if (t.children) {
              e = [];
              for (const n of t.children) n.name ? e.push(Hs.fromJSON(n)) : e.push(Bs.fromJSON(n));
            }
        ...
        class qs {
          constructor(t = {}) {
            ...
            (this.direction = e),
              ...
              t.startPosition
                ...
                : (this.position = $s._createAt(this.boundaries['backward' == this.direction ? 'end' : 'start'])),
          ...
          _next() {
            ...
            if (i instanceof Hs)
              return (
                this.shallow ? e.offset++ : (e.path.push(0), (this._visitedParent = i)),
                (this.position = e),
                Ws('elementStart', i, t, e, 1)
              );
            if (i instanceof Bs) {
              let o;
            ...
            return (
              ...
              this.ignoreElementEnd ? this._next() : Ws('elementEnd', n, t, e)
            );
          }
          _previous() {
            const t = this.position,
            ...
            if (i instanceof Hs)
              return (
                e.offset--,
                this.shallow
                  ? ((this.position = e), Ws('elementStart', i, t, e, 1))
                  : (e.path.push(i.maxOffset),
                    (this.position = e),
                    (this._visitedParent = i),
                    this.ignoreElementEnd ? this._previous() : Ws('elementEnd', i, t, e))
              );
            if (i instanceof Bs) {
              let o;
              if (this.singleCharacters) o = 1;
        ...
        class $s {
          ...
          get parent() {
            ...
            for (let e = 0; e < this.path.length - 1; e++)
              if (!(t = t.getChild(t.offsetToIndex(this.path[e]))))
                throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {
                  position: this,
                });
            if (t.is('text'))
              throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {
          ...
          get textNode() {
            ...
            return t instanceof Bs && t.startOffset < this.offset ? t : null;
          }
          get nodeAfter() {
            ...
            return (
              e.containsPosition(this) || e.start.isEqual(this)
                ...
                : (n = this.isEqual(t.deletionPosition)
                    ? $s._createAt(t.deletionPosition)
          ...
          static _createAfter(t, e) {
            if (!t.parent)
              throw new Gn.b('model-position-after-root: You cannot make a position after root.', [this, t], {
                root: t,
              });
          ...
          static _createBefore(t, e) {
            if (!t.parent)
              throw new Gn.b('model-position-before-root: You cannot make a position before root.', t, { root: t });
        ...
        class Gs {
          constructor(t, e = null) {
            (this.start = $s._createAt(t)),
              (this.end = e ? $s._createAt(e) : $s._createAt(t)),
              (this.start.stickiness = this.isCollapsed ? 'toNone' : 'toNext'),
              (this.end.stickiness = this.isCollapsed ? 'toNone' : 'toPrevious');
          }
          *[Symbol.iterator]() {
            yield* new qs({ boundaries: this, ignoreElementEnd: !0 });
          }
          get isCollapsed() {
            return this.start.isEqual(this.end);
          }
          ...
          getDifference(t) {
            ...
            return (
              this.isIntersecting(t)
                ? (this.containsPosition(t.start) && e.push(new Gs(this.start, t.start)),
                  this.containsPosition(t.end) && e.push(new Gs(t.end, this.end)))
                : e.push(new Gs(this.start, this.end)),
              e
            );
          }
          getIntersection(t) {
          ...
          getMinimalFlatRanges() {
            ...
            for (; n.path.length > e + 1; ) {
              ...
              0 !== e && t.push(new Gs(n, n.getShiftedBy(e))),
                (n.path = n.path.slice(0, -1)),
                n.offset++,
                (i = i.parent);
            }
          ...
          *getPositions(t = {}) {
          ...
          _getTransformedByMove(t, e, n, i = !1) {
            ...
            if (
              (1 == a.length
                ? (c = new Gs(a[0].start._getTransformedByDeletion(t, n), a[0].end._getTransformedByDeletion(t, n)))
                : 2 == a.length && (c = new Gs(this.start, this.end._getTransformedByDeletion(t, n))),
              (s = c ? c._getTransformedByInsertion(r, n, null !== l || i) : []),
              l)
            ) {
          ...
          static _createFromRanges(t) {
            if (0 === t.length)
              throw new Gn.b('range-create-from-ranges-empty-array: At least one range has to be passed.', null);
            if (1 == t.length) return t[0].clone();
            const e = t[0];
            t.sort((t, e) => (t.start.isAfter(e.start) ? 1 : -1));
            const n = t.indexOf(e),
              i = new this(e.start, e.end);
            if (n > 0) for (let e = n - 1; t[e].end.isEqual(i.start); e++) i.start = $s._createAt(t[e].start);
        ...
        class Ks {
          ...
          add(t, e) {
            (e = Js(e)),
              t instanceof Fs && (t = this._getSymbolForTextProxy(t)),
          ...
          _addSymbolForTextProxy(t, e, n) {
            ...
            let o, r;
            return (
              (o = this._textProxyRegistry.get(t)) || ((o = new Map()), this._textProxyRegistry.set(t, o)),
              (r = o.get(e)) || ((r = new Map()), o.set(e, r)),
              r.set(n, i),
              i
            );
          }
        ...
        class Zs {
          ...
          convertChanges(t, e, n) {
            ...
            for (const e of t.getChanges())
              'insert' == e.type
                ? this.convertInsert(Gs._createFromPositionAndShift(e.position, e.length), n)
                : 'remove' == e.type
          ...
          convertInsert(t, e) {
            ...
            for (const e of t) {
              const t = e.item,
                n = { item: t, range: Gs._createFromPositionAndShift(e.previousPosition, e.length) };
          ...
          convertMarkerAdd(t, e, n) {
            ...
            if (
              ...
              for (const n of e.getItems()) {
                ...
                const o = { item: n, range: Gs._createOn(n), markerName: t, markerRange: e };
          ...
          *getRanges() {
          ...
          setTo(t, e, n) {
            if (null === t) this._setRanges([]);
              ...
              if (!pi(t))
                throw new Gn.b('model-selection-setTo-not-selectable: Cannot set the selection to the given place.', [
                  this,
                  t,
                ]);
          ...
          setFocus(t, e) {
            ...
            this._ranges.length && this._popRange(),
              'before' == n.compareWith(i)
                ? (this._pushRange(new Gs(n, i)), (this._lastRangeBackward = !0))
                : (this._pushRange(new Gs(i, n)), (this._lastRangeBackward = !1)),
        ...
        class aa extends ta {
          constructor(t) {
            super(),
              (this.markers = new oo({ idProperty: 'name' })),
              (this._model = t.model),
              (this._document = t),
          ...
          *getRanges() {
          ...
          _setAttribute(t, e, n = !0) {
            ...
            return (
              ('low' != i || 'normal' != this._attributePriority.get(t)) &&
        ...
        function ca(t) {
          return t instanceof Fs || t instanceof Bs ? t.getAttributes() : null;
        }
        class la {
          constructor(t) {
            this._dispatchers = t;
        ...
        class fa extends la {
          elementToElement(t) {
            return this.add(
              (function (t) {
                return (
                  ((t = ua(t)).view = ga(t.view, 'container')),
                  (e) => {
                    e.on(
                      'insert:' + t.model,
                      (function (t) {
          ...
          attributeToElement(t) {
            return this.add(
              (function (t) {
                ...
                if (t.model.values) for (const e of t.model.values) t.view[e] = ga(t.view[e], 'attribute');
                    ...
                    (function (t) {
                      return (e, n, i) => {
                        ...
                        if (n.item instanceof ta || n.item instanceof sa) s.wrap(a.getFirstRange(), r);
                          ...
                          null !== n.attributeOldValue && o && (t = s.unwrap(t, o)),
          ...
          attributeToAttribute(t) {
            return this.add(
              (function (t) {
                let e = 'attribute:' + ((t = ua(t)).model.key ? t.model.key : t.model);
                t.model.name && (e += ':' + t.model.name);
                if (t.model.values) for (const e of t.model.values) t.view[e] = ba(t.view[e]);
                      ...
                      (function (t) {
                        return (e, n, i) => {
                          ...
                          c.insert(a.toViewPosition(s.start), o),
                            ...
                            s.isCollapsed ||
                              (c.insert(a.toViewPosition(s.end), r), i.mapper.bindElementToMarker(r, n.markerName)),
                            e.stop();
                        };
                      })(t.view),
                      { priority: t.converterPriority || 'normal' },
            ...
            : (n, i) =>
                (function (t, e, n) {
                  ...
                  if ('container' == n) i = e.createContainerElement(t.name, o);
                    ...
                    const n = { priority: t.priority || ao.DEFAULT_PRIORITY };
                  ...
                  if (t.classes) {
                    ...
                    else for (const t of n) e.addClass(t, i);
                  }
                  return i;
                })(t, i, e);
        }
        ...
        class ka extends la {
          ...
          attributeToAttribute(t) {
            return this.add(
              (function (t) {
                let e = null;
                ('string' == typeof (t = ua(t)).view || t.view.key) &&
                  (e = (function (t) {
        ...
        function _a(t) {
          const e = (function (t) {
              const e = t.view ? new bi(t.view) : null;
              return (n, i, o) => {
                let r = {};
                if (e) {
                ...
                o.writer.insert(s, a.position),
                  o.convertChildren(i.viewItem, o.writer.createPositionAt(s, 0)),
                  o.consumable.consume(i.viewItem, r);
                const c = o.getSplitParts(s);
                (i.modelRange = new Gs(
                  o.writer.createPositionBefore(s),
                  o.writer.createPositionAfter(c[c.length - 1]),
                )),
                  a.cursorParent
        ...
        function va(t) {
          return 'string' == typeof t.view
            ? t.view
            : 'object' == typeof t.view && 'string' == typeof t.view.name
              ? t.view.name
              : null;
        }
        ...
        class Aa {
          constructor(t) {
            (this.model = t),
              (this.view = new js()),
              (this.mapper = new Qs()),
              (this.downcastDispatcher = new Zs({ mapper: this.mapper }));
              ...
              this.downcastDispatcher.on(
                ...
                (t, e, n) => {
                  ...
                  for (const t of o.getRanges())
                    t.isCollapsed && t.end.parent.document && n.writer.mergeAttributes(t.start);
                  i.setSelection(null);
                },
                { priority: 'low' },
              ),
        ...
        class Ta {
          constructor(t, e = []) {
            ...
            for (const t of e)
              this._availablePlugins.set(t, t), t.pluginName && this._availablePlugins.set(t.pluginName, t);
          }
          *[Symbol.iterator]() {
          ...
          get(t) {
            ...
            if (!e) {
              ...
              let n = t;
              throw ('function' == typeof t && (n = t.pluginName || t.name), new Gn.b(e, this._editor, { plugin: n }));
            }
            return e;
          }
          has(t) {
          ...
          init(t, e = []) {
            const n = this,
              ...
              c = (function (t) {
                const e = [];
                for (const n of t) h(n) || e.push(n);
                return e.length ? e : null;
              })(t);
            if (c) {
              const t = 'plugincollection-plugin-not-found: Some plugins are not available and could not be loaded.';
              return (
                console.error(Object(Gn.a)(t), { plugins: c }),
                Promise.reject(new Gn.b(t, this._editor, { plugins: c }))
              );
            }
            return Promise.all(s.map(l))
              ...
              .then(() => r);
            function l(t) {
              if (!a.includes(t) && !n._plugins.has(t) && !o.has(t))
                return (function (t) {
                  ...
                  throw (
                    (console.error(Object(Gn.a)('plugincollection-load: It was not possible to load the plugin.'), {
                      plugin: t,
                    }),
                    e)
                  );
            ...
            if (n) {
              if (this._plugins.has(n))
                throw new Gn.b(
                  ...
                  null,
                  { pluginName: n, plugin1: this._plugins.get(n).constructor, plugin2: t },
                );
        ...
        class Ma {
          constructor(t = {}) {
            (this.uiLanguage = t.uiLanguage || 'en'),
              ...
              (this.uiLanguageDirection = Ea(this.uiLanguage)),
              (this.contentLanguageDirection = Ea(this.contentLanguage)),
              (this.t = (...t) => this._t(...t));
          }
          get language() {
            return (
          ...
          add(t, e) {
            ...
            t.is('text') || t.is('documentFragment')
              ...
              : (this._consumables.has(t)
                  ...
                  : ((n = new Na()), this._consumables.set(t, n)),
                n.add(e));
          }
          test(t, e) {
        ...
        class Oa {
          ...
          checkAttributeInSelection(t, e) {
            if (t.isCollapsed) {
              const n = [...t.getFirstPosition().getAncestors(), new Bs('', t.getAttributes())];
          ...
          *getValidRanges(t, e) {
          ...
          getNearestSelectionRange(t, e = 'both') {
            ...
            let n, i;
            ('both' != e && 'backward' != e) || (n = new qs({ startPosition: t, direction: 'backward' })),
              ('both' != e && 'forward' != e) || (i = new qs({ startPosition: t }));
          ...
          _compile() {
            const t = {},
              ...
              n = Object.keys(e);
            for (const i of n) t[i] = Da(e[i], i);
            for (const e of n) La(t, e);
            for (const e of n) ja(t, e);
            for (const e of n) Va(t, e), za(t, e);
            for (const e of n) Ba(t, e), Fa(t, e);
          ...
          *_getValidRangesForRange(t, e) {
            ...
            for (const o of t.getItems({ shallow: !0 }))
              o.is('element') && (yield* this._getValidRangesForRange(Gs._createIn(o), e)),
                this.checkAttribute(o, e) || (n.isEqual(i) || (yield new Gs(n, i)), (n = $s._createAfter(o))),
                (i = $s._createAfter(o));
        ...
        function Da(t, e) {
          ...
          return (
            ...
            Ua(t, n, 'allowIn'),
            Ua(t, n, 'allowContentOf'),
            Ua(t, n, 'allowWhere'),
            Ua(t, n, 'allowAttributes'),
            Ua(t, n, 'allowAttributesOf'),
            Ua(t, n, 'inheritTypesFrom'),
            (function (t, e) {
              for (const n of t) {
        ...
        class Wa {
          ...
          convert(t, e, n = ['$root']) {
            this.fire('viewCleanup', t),
              ...
              (this.conversionApi.consumable = Ia.createFrom(t)),
          ...
          _convertItem(t, e) {
            ...
            if (
              ...
              n.modelRange && !(n.modelRange instanceof Gs))
            )
              throw new Gn.b(
          ...
          _splitToAllowedParent(t, e) {
            ...
            for (const t of i.range.getWalker())
              if ('elementEnd' == t.type) o.push(t.item);
              else {
                const e = o.pop(),
                  n = t.item;
        ...
        class Ya {
          constructor(t, e) {
            (this.model = t),
              ...
              (this.upcastDispatcher = new Wa({ schema: t.schema })),
                ...
                (t, e, n) => {
                  if (n.schema.checkChild(e.modelCursor, '$text') && n.consumable.consume(e.viewItem)) {
                    ...
                    n.writer.insert(t, e.modelCursor),
                      (e.modelRange = Gs._createFromPositionAndShift(e.modelCursor, t.offsetSize)),
          ...
          toView(t) {
            ...
            const e = Gs._createIn(t),
              ...
              i = new To(new ro());
            if (
              (this.mapper.bindElements(t, n), this.downcastDispatcher.convertInsert(e, i), !t.is('documentFragment'))
            ) {
              const e = (function (t) {
                const e = [],
                  n = t.root.document;
        ...
        class $a {
          ...
          elementToElement(t) {
            ...
            for (const { model: e, view: n } of Ga(t))
          ...
          attributeToAttribute(t) {
            ...
            for (const { model: e, view: n } of Ga(t)) this.for('upcast').attributeToAttribute({ view: n, model: e });
          }
        ...
        function* Ga(t) {
          if (t.model.values)
            for (const e of t.model.values) {
              yield* Qa({ key: t.model.key, value: e }, t.view[e], t.upcastAlso ? t.upcastAlso[e] : void 0);
            }
        ...
        class Za {
          ...
          static fromJSON(t) {
            const e = [];
            for (const n of t) n.name ? e.push(Hs.fromJSON(n)) : e.push(Bs.fromJSON(n));
            return new Za(e);
          }
          _appendChild(t) {
            this._insertChild(this.childCount, t);
        ...
        function Xa(t, e) {
          const n = (e = nc(e)).reduce((t, e) => t + e.offsetSize, 0),
            i = t.parent;
          oc(t);
          const o = t.index;
          return i._insertChild(o, e), ic(i, o + e.length), ic(i, o), new Gs(t, t.getShiftedBy(n));
        }
        function tc(t) {
          if (!t.isFlat)
            throw new Gn.b(
        ...
        function ec(t, e) {
          ...
          const n = tc(t);
          return Xa((e = e._getTransformedByDeletion(t.start, t.end.offset - t.start.offset)), n);
        }
        function nc(t) {
          const e = [];
          t instanceof Array || (t = [t]);
          for (let n = 0; n < t.length; n++)
            if ('string' == typeof t[n]) e.push(new Bs(t[n]));
            else if (t[n] instanceof Fs) e.push(new Bs(t[n].data, t[n].getAttributes()));
            else if (t[n] instanceof Za || t[n] instanceof Us) for (const i of t[n]) e.push(i);
            else t[n] instanceof zs && e.push(t[n]);
          for (let t = 1; t < e.length; t++) {
            ...
            n instanceof Bs &&
              i instanceof Bs &&
              rc(n, i) &&
              (e.splice(t - 1, 2, new Bs(i.data + n.data, i.getAttributes())), t--);
          }
          return e;
        }
        function ic(t, e) {
          const n = t.getChild(e - 1),
            i = t.getChild(e);
          if (n && i && n.is('text') && i.is('text') && rc(n, i)) {
            const o = new Bs(n.data + i.data, n.getAttributes());
        ...
        function oc(t) {
          ...
          if (e) {
            ...
            const r = new Bs(e.data.substr(0, i), e.getAttributes()),
        ...
        class ac extends Ja {
          ...
          _validate() {
            ...
            for (const t of this.range.getItems({ shallow: !0 })) {
              if (null !== this.oldValue && !sc(t.getAttribute(this.key), this.oldValue))
                throw new Gn.b(
          ...
          _execute() {
            sc(this.oldValue, this.newValue) ||
              (function (t, e, n) {
                oc(t.start), oc(t.end);
                for (const i of t.getItems({ shallow: !0 })) {
                  const t = i.is('textProxy') ? i.textNode : i;
                  null !== n ? t._setAttribute(e, n) : t._removeAttribute(e), ic(t.parent, t.index);
                }
                ic(t.end.parent, t.end.index);
          ...
          static fromJSON(t, e) {
            return new ac(Gs.fromJSON(t.range, e), t.key, t.oldValue, t.newValue, t.baseVersion);
          }
        }
        class cc extends Ja {
          constructor(t, e) {
          ...
          _execute() {
            tc(Gs._createFromPositionAndShift(this.sourcePosition, this.howMany));
          }
          static get className() {
        ...
        class lc extends Ja {
          ...
          _validate() {
            ...
            if (n + this.howMany > t.maxOffset)
              throw new Gn.b('move-operation-nodes-do-not-exist: The nodes which should be moved do not exist.', this);
            ...
            if (
              ...
              'prefix' == li(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())
            ) {
          ...
          _execute() {
            ec(Gs._createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition);
          }
          toJSON() {
            const t = super.toJSON();
            return (
        ...
        class dc extends Ja {
          ...
          getReversed() {
            const t = this.position.root.document.graveyard,
              e = new $s(t, [0]);
            return new lc(this.position, this.nodes.maxOffset, e, this.baseVersion + 1);
          }
          _validate() {
          ...
          _execute() {
            const t = this.nodes;
            (this.nodes = new Us([...t].map((t) => t._clone(!0)))), Xa(this.position, t);
          }
          toJSON() {
            const t = super.toJSON();
          ...
          static fromJSON(t, e) {
            const n = [];
            for (const e of t.nodes) e.name ? n.push(Hs.fromJSON(e)) : n.push(Bs.fromJSON(e));
            const i = new dc($s.fromJSON(t.position, e), n, t.baseVersion);
        ...
        class hc extends Ja {
          ...
          clone() {
            return new hc(this.name, this.oldRange, this.newRange, this._markers, this.affectsData, this.baseVersion);
          }
          getReversed() {
            return new hc(
              this.name,
          ...
          static fromJSON(t, e) {
            return new hc(
              t.name,
              t.oldRange ? Gs.fromJSON(t.oldRange, e) : null,
              t.newRange ? Gs.fromJSON(t.newRange, e) : null,
              e.model.markers,
              t.affectsData,
              t.baseVersion,
            );
        ...
        class uc extends Ja {
          ...
          static fromJSON(t, e) {
            return new uc($s.fromJSON(t.position, e), t.oldName, t.newName, t.baseVersion);
          }
        }
        class fc extends Ja {
          constructor(t, e, n, i, o) {
          ...
          clone() {
            return new fc(this.root, this.key, this.oldValue, this.newValue, this.baseVersion);
          }
          getReversed() {
            return new fc(this.root, this.key, this.newValue, this.oldValue, this.baseVersion + 1);
          }
          _validate() {
            if (this.root != this.root.root || this.root.is('documentFragment'))
              throw new Gn.b('rootattribute-operation-not-a-root: The element to change is not a root element.', this, {
                root: this.root,
                key: this.key,
              });
          ...
          static fromJSON(t, e) {
            ...
            return new fc(e.getRoot(t.root), t.key, t.oldValue, t.newValue, t.baseVersion);
          }
        }
        class mc extends Ja {
          constructor(t, e, n, i, o) {
          ...
          getReversed() {
            const t = this.targetPosition._getTransformedByMergeOperation(this),
              ...
              i = new gc(t, this.howMany, this.graveyardPosition, this.baseVersion + 1);
          ...
          _validate() {
            const t = this.sourcePosition.parent,
              e = this.targetPosition.parent;
            if (!t.parent)
              throw new Gn.b('merge-operation-source-position-invalid: Merge source position is invalid.', this);
            if (!e.parent)
              throw new Gn.b('merge-operation-target-position-invalid: Merge target position is invalid.', this);
          ...
          _execute() {
            const t = this.sourcePosition.parent;
            ec(Gs._createIn(t), this.targetPosition), ec(Gs._createOn(t), this.graveyardPosition);
          }
          toJSON() {
            const t = super.toJSON();
            return (
        ...
        class gc extends Ja {
          constructor(t, e, n, i) {
            super(i),
              ...
              (this.howMany = e),
              (this.insertionPosition = gc.getInsertionPosition(t)),
          ...
          _validate() {
            ...
            if (!t || t.maxOffset < e)
              throw new Gn.b('split-operation-position-invalid: Split position is invalid.', this);
          ...
          _execute() {
            ...
            if (this.graveyardPosition)
              ec(Gs._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
            else {
              const e = t._clone();
              Xa(this.insertionPosition, e);
            }
            ec(
              new Gs($s._createAt(t, this.splitPosition.offset), $s._createAt(t, t.maxOffset)),
        ...
        class bc {
          ...
          insert(t, e, n = 0) {
            if ((this._assertWriterUsedCorrectly(), t instanceof Bs && '' == t.data)) return;
            const i = $s._createAt(e, n);
            if (t.parent) {
              if (yc(t.root, i.root)) return void this.move(Gs._createOn(t), i);
              if (t.root.document)
                throw new Gn.b(
            ...
            const o = i.root.document ? i.root.document.version : null,
              r = new dc(i, t, o);
            if (
              (t instanceof Bs && (r.shouldReceiveAttributes = !0),
              ...
              for (const [e, n] of t.markers) {
                const t = $s._createAt(n.root, 0),
                  o = {
                    range: new Gs(n.start._getCombined(t, i), n.end._getCombined(t, i)),
                    usingOperation: !0,
                    affectsData: !0,
                  };
          ...
          insertText(t, e, n, i) {
            e instanceof Za || e instanceof Hs || e instanceof $s
          ...
          appendText(t, e, n) {
            e instanceof Za || e instanceof Hs
          ...
          setAttribute(t, e, n) {
            if ((this._assertWriterUsedCorrectly(), n instanceof Gs)) {
              ...
              for (const n of i) wc(this, t, e, n);
            } else kc(this, t, e, n);
          }
          setAttributes(t, e) {
          ...
          removeAttribute(t, e) {
            if ((this._assertWriterUsedCorrectly(), e instanceof Gs)) {
              ...
              for (const e of n) wc(this, t, null, e);
          ...
          clearAttributes(t) {
            ...
            if (t instanceof Gs) for (const n of t.getItems()) e(n);
            else e(t);
          }
          move(t, e, n) {
            if ((this._assertWriterUsedCorrectly(), !(t instanceof Gs)))
              throw new Gn.b('writer-move-invalid-range: Invalid range to move.', this);
            ...
            const o = t.root.document ? t.root.document.version : null,
              r = new lc(t.start, t.end.offset - t.start.offset, i, o);
          ...
          remove(t) {
            ...
            for (const t of e)
              this._addOperationForAffectedMarkers('move', t),
                vc(t.start, t.end.offset - t.start.offset, this.batch, this.model);
          }
          merge(t) {
            this._assertWriterUsedCorrectly();
            const e = t.nodeBefore,
              n = t.nodeAfter;
            if ((this._addOperationForAffectedMarkers('merge', t), !(e instanceof Hs)))
              throw new Gn.b('writer-merge-no-element-before: Node before merge position must be an element.', this);
            if (!(n instanceof Hs))
              throw new Gn.b('writer-merge-no-element-after: Node after merge position must be an element.', this);
          ...
          _merge(t) {
            const e = $s._createAt(t.nodeBefore, 'end'),
              ...
              s = new mc(n, t.nodeAfter.maxOffset, e, o, r);
            this.batch.addOperation(s), this.model.applyOperation(s);
          }
          rename(t, e) {
            if ((this._assertWriterUsedCorrectly(), !(t instanceof Hs)))
              throw new Gn.b(
                'writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.',
                this,
              );
            const n = t.root.document ? t.root.document.version : null,
              i = new uc($s._createBefore(t), t.name, e, n);
          ...
          split(t, e) {
            ...
            let n,
              ...
              o = t.parent;
            if (!o.parent)
              throw new Gn.b('writer-split-element-no-parent: Element with no parent can not be split.', this);
            if ((e || (e = o.parent), !t.parent.getAncestors({ includeSelf: !0 }).includes(e)))
              throw new Gn.b('writer-split-invalid-limit-element: Limit element is not a position ancestor.', this);
            do {
            ...
            return { position: t, range: new Gs($s._createAt(n, 'end'), $s._createAt(i, 0)) };
          }
          wrap(t, e) {
            if ((this._assertWriterUsedCorrectly(), !t.isFlat))
              throw new Gn.b('writer-wrap-range-not-flat: Range to wrap is not flat.', this);
            const n = e instanceof Hs ? e : new Hs(e);
            if (n.childCount > 0)
              throw new Gn.b('writer-wrap-element-not-empty: Element to wrap with is not empty.', this);
            if (null !== n.parent)
              throw new Gn.b(
            ...
            const i = new Gs(t.start.getShiftedBy(1), t.end.getShiftedBy(1));
            this.move(i, $s._createAt(n, 0));
          }
          unwrap(t) {
            if ((this._assertWriterUsedCorrectly(), null === t.parent))
              throw new Gn.b('writer-unwrap-element-no-parent: Trying to unwrap an element which has no parent.', this);
          ...
          addMarker(t, e) {
            ...
            if (this.model.markers.has(t))
              throw new Gn.b('writer-addMarker-marker-exists: Marker with provided name already exists.', this);
            if (!i)
              throw new Gn.b('writer-addMarker-no-range: Range parameter is required when adding a new marker.', this);
          ...
          updateMarker(t, e) {
            ...
            if (!i)
              throw new Gn.b('writer-updateMarker-marker-not-exists: Marker with provided name does not exists.', this);
            ...
            o && e.usingOperation !== i.managedUsingOperations
              ? e.usingOperation
                ? _c(this, n, null, c, s)
                : (_c(this, n, a, null, s), this.model.markers._set(n, c, void 0, s))
          ...
          removeMarker(t) {
            ...
            if (!this.model.markers.has(e))
              throw new Gn.b('writer-removeMarker-no-marker: Trying to remove marker which does not exist.', this);
          ...
          setSelectionAttribute(t, e) {
            ...
            else for (const [e, n] of Vs(t)) this._setSelectionAttribute(e, n);
          }
        ...
        function _c(t, e, n, i, o) {
          const r = t.model,
            s = r.document,
            a = new hc(e, n, i, r.markers, o, s.version);
        ...
        class xc {
          ...
          bufferMarkerChange(t, e, n, i) {
            ...
            o
              ? ((o.newRange = n),
                (o.affectsData = i),
                null == o.oldRange && null == o.newRange && this._changedMarkers.delete(t))
          ...
          getChanges(t = { includeChangesInGraveyard: !1 }) {
            ...
            for (let t = 1; t < e.length; t++) {
              const n = e[t - 1],
                ...
                o =
                  ...
                  '$text' == n.name &&
                  '$text' == i.name &&
                  n.position.isEqual(i.position),
                r =
                  'insert' == n.type &&
                  'insert' == i.type &&
                  '$text' == n.name &&
                  '$text' == i.name &&
                  n.position.parent == i.position.parent &&
                  n.position.offset + n.length == i.position.offset,
                s =
                  'attribute' == n.type &&
                  'attribute' == i.type &&
                  n.position.parent == i.position.parent &&
                  ...
                  i.range.isFlat &&
                  n.position.offset + n.length == i.position.offset &&
                  n.attributeKey == i.attributeKey &&
                  n.attributeOldValue == i.attributeOldValue &&
                  n.attributeNewValue == i.attributeNewValue;
              (o || r || s) &&
                (e[t - 1].length++,
            ...
            return (
              ...
              (this._cachedChanges = e.slice().filter(Cc)),
          ...
          _makeSnapshot(t) {
            this._elementSnapshots.has(t) || this._elementSnapshots.set(t, Ac(t.getChildren()));
          }
          _handleChange(t, e) {
            ...
            for (const n of e) {
              ...
              if (
                ...
                ('insert' == n.type &&
                  (t.offset <= n.offset
                    ? (n.offset += t.howMany)
                    : t.offset < o && ((n.howMany += t.nodesToHandle), (t.nodesToHandle = 0))),
              ...
              if ('attribute' == t.type) {
                if ('insert' == n.type)
                  if (t.offset < n.offset && i > n.offset) {
                    ...
                    t.offset >= n.offset &&
                      t.offset < o &&
                      (i > o ? ((t.nodesToHandle = i - o), (t.offset = o)) : (t.nodesToHandle = 0));
        ...
        function Mc(t, e) {
          return (function (t) {
            return (
              !!t && 1 == t.length && /[\u0300-\u036f\u1ab0-\u1aff\u1dc0-\u1dff\u20d0-\u20ff\ufe20-\ufe2f]/.test(t)
            );
          })(t.charAt(e));
        }
        const Ec = '$graveyard';
        class Ic {
          constructor(t) {
            (this.model = t),
              (this.version = 0),
              (this.history = new Pc(this)),
              (this.selection = new sa(this)),
              (this.roots = new oo({ idProperty: 'rootName' })),
              (this.differ = new xc(t.markers)),
              (this._postFixers = new Set()),
              (this._hasSelectionChangedFromTheLastChangeBlock = !1),
              this.createRoot('$root', Ec),
              this.listenTo(
                t,
                'applyOperation',
                (t, e) => {
          ...
          createRoot(t = '$root', e = 'main') {
            if (this.roots.get(e))
              throw new Gn.b('model-document-createRoot-name-exists: Root with specified name already exists.', this, {
                name: e,
              });
            const n = new pc(this, t, e);
          ...
          getRootNames() {
            return Array.from(this.roots, (t) => t.rootName).filter((t) => t != Ec);
          }
          registerPostFixer(t) {
            this._postFixers.add(t);
          }
        ...
        class Oc {
          ...
          _remove(t) {
            const e = t instanceof Rc ? t.name : t,
        ...
        class Lc {
          ...
          getSelectionRange() {
            return this.nodeToSelect
              ? Gs._createOn(this.nodeToSelect)
          ...
          _setAffectedBoundaries(t) {
            this._affectedStart || (this._affectedStart = Dc.fromPosition(t, 'toPrevious')),
              (this._affectedEnd && !this._affectedEnd.isBefore(t)) ||
                (this._affectedEnd && this._affectedEnd.detach(), (this._affectedEnd = Dc.fromPosition(t, 'toNext')));
          }
          _mergeSiblingsOf(t, e) {
            if (!(t instanceof Hs)) return;
            const n = this._canMergeLeft(t, e),
              i = this._canMergeRight(t, e),
              o = Dc._createBefore(t);
            o.stickiness = 'toNext';
            const r = Dc._createAfter(t);
            if (((r.stickiness = 'toNext'), n)) {
              const t = Dc.fromPosition(this.position);
              (t.stickiness = 'toNext'),
                this._affectedStart.isEqual(o) &&
                  (this._affectedStart.detach(),
                  (this._affectedStart = Dc._createAt(o.nodeBefore, 'end', 'toPrevious'))),
                this.writer.merge(o),
                o.isEqual(this._affectedEnd) &&
                  e.isLast &&
                  (this._affectedEnd.detach(), (this._affectedEnd = Dc._createAt(o.nodeBefore, 'end', 'toNext'))),
                (this.position = t.toPosition()),
                t.detach();
            }
            if (i) {
              if (!this.position.isEqual(r)) throw new Gn.b('insertcontent-invalid-insertion-position', this);
              this.position = $s._createAt(r.nodeBefore, 'end');
              const t = Dc.fromPosition(this.position, 'toPrevious');
              this._affectedEnd.isEqual(r) &&
                (this._affectedEnd.detach(), (this._affectedEnd = Dc._createAt(r.nodeBefore, 'end', 'toNext'))),
                this.writer.merge(r),
                r.getShiftedBy(-1).isEqual(this._affectedStart) &&
                  e.isFirst &&
                  (this._affectedStart.detach(), (this._affectedStart = Dc._createAt(r.nodeBefore, 0, 'toPrevious'))),
                (this.position = t.toPosition()),
                t.detach();
            }
          ...
          _tryAutoparagraphing(t, e) {
            ...
            this._getAllowedIn(n, this.position.parent) &&
              ...
              (n._appendChild(t), this._handleNode(n, e));
          }
        ...
        function jc(t, e, n = {}) {
          ...
          t.change((t) => {
            ...
            const r = i.start,
              s = Dc.fromPosition(i.end, 'toNext');
            if (
              ...
              n.doNotAutoparagraph && i ? zc(t, e, i) : Vc(t, r, e);
            }
            s.detach();
          });
        }
        function Vc(t, e, n) {
          ...
          t.insert(i, e), zc(t, n, t.createPositionAt(i, 0));
        }
        function zc(t, e, n) {
        ...
        function Fc(t, e, n = {}) {
          ...
          for (; (l = a.next()); ) {
            if (l.done) return;
            const n = Uc(c, l.value);
            if (n)
              return void (e instanceof sa
                ? t.change((t) => {
            ...
            return 'word' === t.unit
              ...
              : (function (t, e) {
                  ...
                  if (n) {
                    ...
                    for (; Sc(i, o) || ('character' == e && Mc(i, o)); )
                      t.next(), (o = t.position.offset - n.startOffset);
                  }
                  return t.position;
            ...
            : (function (t, e) {
                ...
                if (c || l) {
                  const t = n.nodeAfter && i.nodeBefore && n.nodeAfter.parent === i.nodeBefore.parent,
                    o = c && (!t || !Qc(n.nodeAfter, e)),
                    r = l && (!t || !Qc(i.nodeBefore, e));
                  let d = n,
                    h = i;
                  return o && (d = $s._createBefore(Gc(s, e))), r && (h = $s._createAfter(Gc(a, e))), new Gs(d, h);
                }
                return null;
              })(t, e);
        }
        ...
        class Kc {
          constructor() {
            (this.markers = new Oc()),
              (this.document = new Ic(this)),
              (this.schema = new Oa()),
              (this._pendingChanges = []),
              (this._currentWriter = null),
              ['insertContent', 'deleteContent', 'modifySelection', 'getSelectedContent', 'applyOperation'].forEach(
                (t) => this.decorate(t),
              ),
              this.on(
                'applyOperation',
          ...
          change(t) {
            return 0 === this._pendingChanges.length
              ? (this._pendingChanges.push({ batch: new Ka(), callback: t }), this._runPendingChanges()[0])
              : t(this._currentWriter);
          }
          enqueueChange(t, e) {
            'string' == typeof t ? (t = new Ka(t)) : 'function' == typeof t && ((e = t), (t = new Ka())),
          ...
          insertContent(t, e, n) {
            return (function (t, e, n, i) {
              return t.change((o) => {
                let r;
                const s = (r = n
                  ? n instanceof ta || n instanceof sa
                    ? n
                    : o.createSelection(n, i)
                  : t.document.selection).getFirstPosition();
                r.isCollapsed || t.deleteContent(r, { doNotAutoparagraph: !0 });
                const a = new Lc(t, o, s);
                let c;
                (c = e.is('documentFragment') ? e.getChildren() : [e]), a.handleNodes(c, { isFirst: !0, isLast: !0 });
          ...
          _runPendingChanges() {
            ...
            for (this.fire('_beforeChanges'); this._pendingChanges.length; ) {
              ...
              this._currentWriter = new bc(this, e);
        ...
        class Xc {
          constructor(t) {
            ...
            (this.config = new Yn(t, this.constructor.defaultConfig)),
              this.config.define('plugins', e),
              (this.plugins = new Ta(this, e)),
              (this.commands = new Ca());
        ...
        class il {
          constructor() {
            (this._domParser = new DOMParser()),
              (this._domConverter = new rr({ blockFiller: jo })),
        ...
        class ol {
          ...
          *names() {
          ...
          add(t, e) {
            if (this.has(t))
              throw new Gn.b('componentfactory-item-exists: The item already exists in the component factory.', this, {
                name: t,
              });
            this._components.set(rl(t), { callback: e, originalName: t });
          }
          create(t) {
            if (!this.has(t))
              throw new Gn.b(
        ...
        class al {
          constructor(t) {
            (this.editor = t),
              (this.componentFactory = new ol(t)),
              (this.focusTracker = new sl()),
        ...
        function ll(t) {
          const { view: e, element: n, text: i, isDirectHost: o = !0 } = t,
            r = e.document;
          cl.has(r) || (cl.set(r, new Map()), r.registerPostFixer((t) => hl(r, t))),
            cl.get(r).set(n, { text: i, isDirectHost: o }),
            e.change((t) => hl(r, t));
        }
        function dl(t, e) {
        ...
        function hl(t, e) {
          const n = cl.get(t);
          let i = !1;
          for (const [t, o] of n) ul(e, t, o) && (i = !0);
          return i;
        }
        function ul(t, e, n) {
        ...
        class ml extends al {
          ...
          _initPlaceholder() {
            ...
            o && ll({ view: e, element: n, text: o, isDirectHost: !1 });
          }
        }
        class gl extends oo {
          constructor(t) {
        ...
        const pl = 'http://www.w3.org/1999/xhtml';
        class bl {
          constructor(t) {
            Object.assign(this, Cl(Tl(t))), (this._isRendered = !1), (this._revertData = null);
          }
          render() {
          ...
          *getViews() {
            yield* (function* t(e) {
              if (e.children) for (const n of e.children) Il(n) ? yield n : Nl(n) && (yield* t(n));
            })(this);
          }
          static bind(t, e) {
            return {
              to: (n, i) => new kl({ eventNameOrFunction: n, attribute: n, observable: t, emitter: e, callback: i }),
              if: (n, i, o) => new _l({ observable: t, emitter: e, attribute: n, valueIfTrue: i, callback: o }),
            };
          }
          static extend(t, e) {
            if (t._isRendered)
          ...
          _renderNode(t) {
            let e;
            if ((e = t.node ? this.tag && this.text : this.tag ? this.text : !this.text))
              throw new Gn.b(
          ...
          _renderElement(t) {
            let e = t.node;
            return (
              e || (e = t.node = document.createElementNS(this.ns || pl, this.tag)),
          ...
          _renderAttributes(t) {
            ...
            for (e in this.attributes)
              if (
                ...
                (n = this.attributes[e]),
                s && (s.attributes[e] = i),
                (o = B(n[0]) && n[0].ns ? n[0].ns : null),
                vl(n))
              ) {
                const a = o ? n[0].value : n;
                s && Rl(e) && a.unshift(i), this._bindToObservable({ schema: a, updater: xl(r, e, o), data: t });
              } else
                'style' == e && 'string' != typeof n[0]
                  ? this._renderStyleAttribute(n[0], t)
                  : (s && i && Rl(e) && n.unshift(i),
                    El(
                      (n = n
                        .map((t) => (t && t.value) || t)
          ...
          _renderStyleAttribute(t, e) {
            ...
            for (const i in t) {
              const o = t[i];
              vl(o) ? this._bindToObservable({ schema: [o], updater: Al(n, i), data: e }) : (n.style[i] = o);
            }
          }
          _renderElementChildren(t) {
            ...
            for (const r of this.children)
              ...
              } else if (Il(r)) i || (r.isRendered || r.render(), n.appendChild(r.element));
              else if (Zo(r)) n.appendChild(r);
              else if (i) {
                const e = { children: [], bindings: [], attributes: {} };
                t.revertData.children.push(e),
                  r._renderNode({ node: n.childNodes[o++], isApplying: !0, revertData: e });
        ...
        class _l extends wl {
          getValue(t) {
            return !El(super.getValue(t)) && (this.valueIfTrue || !0);
          }
        }
        function vl(t) {
          return !!t && (t.value && (t = t.value), Array.isArray(t) ? t.some(vl) : t instanceof wl);
        }
        function yl(t, e, { node: n }) {
          let i = (function (t, e) {
            return t.map((t) => (t instanceof wl ? t.getValue(e) : t));
          })(t, n);
          El((i = 1 == t.length && t[0] instanceof _l ? i[0] : i.reduce(Sl, ''))) ? e.remove() : e.set(i);
        }
        function xl(t, e, n) {
          return {
            set(i) {
        ...
        function Tl(t) {
          return qn(t, (t) => {
            if (t && (t instanceof wl || Nl(t) || Il(t) || Ol(t))) return t;
          });
        }
        function Cl(t) {
          if (
            ...
            t.attributes &&
              (function (t) {
                for (const e in t) t[e].value && (t[e].value = [].concat(t[e].value)), Pl(t, e);
              })(t.attributes);
            const e = [];
            if (t.children)
              if (Ol(t.children)) e.push(t.children);
              else for (const n of t.children) Nl(n) || Il(n) || Zo(n) ? e.push(n) : e.push(new bl(n));
            t.children = e;
          }
          return t;
        }
        ...
        class Dl {
          ...
          get bindTemplate() {
            return this._bindTemplate ? this._bindTemplate : (this._bindTemplate = bl.bind(this, this));
          }
          createCollection() {
            const t = new gl();
          ...
          setTemplate(t) {
            this.template = new bl(t);
          }
          extendTemplate(t) {
            bl.extend(this.template, t);
          }
          render() {
            if (this.isRendered)
              throw new Gn.b('ui-view-render-already-rendered: This View has already been rendered.', this);
        ...
        class Ll extends Dl {
          ...
          _renderBodyCollection() {
            const t = this.locale,
              e = (this._bodyCollectionContainer = new bl({
                tag: 'div',
                attributes: {
        ...
        class Vl extends Ll {
          ...
          _createVoiceLabel(t) {
            ...
            return (
              (n.text = e('bn')),
              n.extendTemplate({ attributes: { id: `ck-editor__aria-label_${t}`, class: 'ck-voice-label' } }),
              n
            );
          }
        }
        ...
        class Bl extends zl {
          ...
          render() {
            ...
            t.change((n) => {
              ...
              n.setAttribute('aria-label', e('bm', [this.name]), i);
            });
          }
        }
        function Fl(t) {
        ...
        class Hl extends Dl {
          constructor(t) {
            ...
            this.set('isActive', !1),
              ...
              (this._contentPanelPlaceholder = new bl({
                tag: 'div',
                attributes: {
                ...
                attributes: {
                  ...
                  style: {
                    width: e.to('isSticky', (t) =>
                      t ? Ul(this._contentPanelPlaceholder.getBoundingClientRect().width) : null,
                    ),
          ...
          render() {
            super.render(),
              ...
              this.listenTo(nr.window, 'scroll', () => {
                this._checkIfShouldBeSticky();
              }),
            ...
            this.limiterElement
              ...
              this.isSticky
                ? ((this._isStickyToTheLimiter =
                  ...
                  (this._marginLeft = this._isStickyToTheLimiter ? null : Ul(-nr.window.scrollX)))
        ...
        class ql {
          ...
          get first() {
            return this.focusables.find(Wl) || null;
          }
          get last() {
            return this.focusables.filter(Wl).slice(-1)[0] || null;
          }
          get next() {
        ...
        class $l extends Dl {
          constructor(t) {
            ...
            const e = this.bindTemplate,
              n = this.t;
            this.set('ariaLabel', n('bl')),
              (this.items = this.createCollection()),
              (this.focusTracker = new sl()),
              (this.keystrokes = new Jc()),
              this.set('isVertical', !1),
              this.set('class'),
              (this._focusCycler = new ql({
          ...
          fillFromConfig(t, e) {
            t.map((t) => {
              '|' == t
                ? this.items.add(new Yl())
                : e.has(t)
                  ? this.items.add(e.create(t))
                  : console.warn(
                      Object(Gn.a)('toolbarview-item-unavailable: The requested toolbar item is unavailable.'),
                      { name: t },
                    );
            });
          }
        ...
        class Gl extends Vl {
          constructor(t, e) {
            super(t), (this.stickyPanel = new Hl(t)), (this.toolbar = new $l(t)), (this.editable = new Bl(t, e));
          }
          render() {
            super.render(),
        ...
        class Ql extends Xc {
          constructor(t, e) {
            super(e),
              Wn(t) && (this.sourceElement = t),
              (this.data.processor = new il()),
              this.model.document.createRoot(),
              (this.ui = new ml(this, new Gl(this.locale, this.editing.view))),
              (function (t) {
                if (!W(t.updateSourceElement))
                  throw new Gn.b(
          ...
          static create(t, e = {}) {
            return new Promise((n) => {
              ...
              n(
                i
                  .initPlugins()
                  .then(() => i.ui.init(Wn(t) ? t : null))
                  .then(() => {
                    if (!Wn(t) && e.initialData)
                      throw new Gn.b(
        ...
        class Zl extends ts {
          ...
          onDomEvent(t) {
            const e = { dataTransfer: new Jl(t.clipboardData ? t.clipboardData : t.dataTransfer) };
            'drop' == t.type &&
              (e.dropRange = (function (t, e) {
                ...
                n.caretRangeFromPoint && n.caretRangeFromPoint(i, o)
                  ...
                  : e.rangeParent && ((r = n.createRange()).setStart(e.rangeParent, e.rangeOffset), r.collapse(!0));
                return r ? t.domConverter.domRangeToView(r) : t.document.selection.getFirstRange();
              })(this.view, t)),
              this.fire(t.type, t, e);
          }
        }
        const Xl = ['figcaption', 'li'];
        class td extends Kl {
          ...
          init() {
            ...
            (this._htmlDataProcessor = new il()),
              n.addObserver(Zl),
              this.listenTo(
                i,
                'clipboardInput',
                      ...
                      (o = (function (t) {
                        return (
                          (t = t
                            ...
                            .replace(/^\s/, '&nbsp;')
                            .replace(/\s$/, '&nbsp;')
                            .replace(/\s\s/g, ' &nbsp;')).indexOf('</p><p>') > -1 && (t = `<p>${t}</p>`),
                          t
                        );
                      })(i.getData('text/plain'))),
                    (o = this._htmlDataProcessor.toView(o)),
                    this.fire('inputTransformation', { content: o, dataTransfer: i }),
                      ...
                      (function t(e) {
                        ...
                        if (e.is('text') || e.is('textProxy')) n = e.data;
                          ...
                          for (const o of e.getChildren()) {
                            const e = t(o);
                            i &&
                              (i.is('containerElement') || o.is('containerElement')) &&
                              (Xl.includes(i.name) || Xl.includes(o.name) ? (n += '\n') : (n += '\n\n')),
                              (n += e),
                              (i = o);
                          }
                        }
          ...
          forceDisabled(t) {
            this._disableStack.add(t),
              1 == this._disableStack.size &&
                (this.on('set:isEnabled', nd, { priority: 'highest' }), (this.isEnabled = !1));
          }
          clearForceDisabled(t) {
            this._disableStack.delete(t),
              0 == this._disableStack.size && (this.off('set:isEnabled', nd), this.refresh());
          }
          execute() {}
          destroy() {
            this.stopListening();
              ...
              !(function (t, e, n, i) {
                ...
                if (o) {
                  ...
                  const i = !(r.start.isAtStart && r.end.isAtEnd),
                    o = s == a;
                  t.deleteContent(n, { leaveUnmerged: i }), i && (o ? rd(e, n.focus) : e.setSelection(a, 0));
                }
            ...
            e.on('keydown', (t, n) => {
              if (this.isEnabled && n.keyCode == bo.enter) {
                ...
                e.once('enter', (t) => (i = t), { priority: 'highest' }),
                  e.fire('enter', new Xr(e, n.domEvent, { isSoft: n.shiftKey })),
            ...
            t.change((n) => {
              !(function (t, e, n) {
                ...
                if (i) {
                  ...
                  ld(e, o.end), e.removeSelectionAttribute(n.getAttributeKeys()), e.setSelectionAttribute(i);
                } else {
                  const i = !(o.start.isAtStart && o.end.isAtEnd);
                  t.deleteContent(n, { leaveUnmerged: i }), a ? ld(e, n.focus) : i && e.setSelection(s, 0);
                }
              })(t, n, e.selection),
                this.fire('afterExecute', { writer: n });
            });
        ...
        class hd extends Kl {
          ...
          init() {
            ...
            e.register('softBreak', { allowWhere: '$text', isInline: !0 }),
              ...
              n.for('downcast').elementToElement({ model: 'softBreak', view: (t, e) => e.createEmptyElement('br') }),
              i.addObserver(sd),
              t.commands.add('shiftEnter', new cd(t)),
              this.listenTo(
                o,
                'enter',
                (e, n) => {
        ...
        class fd extends ed {
          constructor(t, e) {
            super(t), (this._buffer = new ud(t.model, e)), (this._batches = new WeakSet());
          }
          get buffer() {
            return this._buffer;
          }
          ...
          execute(t = {}) {
            ...
            e.enqueueChange(this._buffer.batch, (t) => {
              ...
              this._buffer.lock(),
                e.deleteContent(e.createSelection(r)),
                i && e.insertContent(t.createText(i, n.selection.getAttributes()), r.start),
                s ? t.setSelection(s) : a && t.setSelection(r.start.getShiftedBy(o)),
                this._buffer.unlock(),
        ...
        for (let t = 112; t <= 135; t++) gd.push(t);
        function pd(t) {
            ...
            return (
              t.forEach((t) => {
                'equal' == t
                  ? (r(), o++)
                  : 'insert' == t
                    ? (s('insert') ? i.values.push(e[o]) : (r(), (i = { type: 'insert', index: o, values: [e[o]] })),
                      o++)
                    : s('delete')
                      ? i.howMany++
          ...
          })(Qo(t.oldChildren, t.newChildren, bd), t.newChildren);
        ...
        class wd {
          ...
          handle(t, e) {
            if (
              (function (t) {
                ...
                for (const e of t) if ('children' === e.type && !pd(e)) return !0;
                return !1;
              })(t)
            )
          ...
          _handleContainerChildrenMutations(t, e) {
            ...
            if (f === u) return;
            const m = Qo(f, u),
              { firstChangeAt: g, insertions: p, deletions: b } = _d(m);
            let w = null;
            e && (w = this.editing.mapper.toModelRange(e.getFirstRange()));
            const k = u.substr(g, p),
              _ = this.editor.model.createRange(
                this.editor.model.createPositionAt(s, g),
                this.editor.model.createPositionAt(s, g + b),
              );
          ...
          _handleTextMutation(t, e) {
            ...
            if (i === n) return;
            const o = Qo(i, n),
              { firstChangeAt: r, insertions: s, deletions: a } = _d(o);
            let c = null;
        ...
        class vd extends Kl {
          ...
          init() {
            const t = this.editor,
              e = new fd(t, t.config.get('typing.undoStep') || 20);
        ...
        class yd extends ed {
          constructor(t, e) {
            super(t), (this.direction = e), (this._buffer = new ud(t.model, t.config.get('typing.undoStep')));
          }
          get buffer() {
            return this._buffer;
          }
          execute(t = {}) {
            ...
            e.enqueueChange(this._buffer.batch, (i) => {
              ...
              const o = i.createSelection(t.selection || n.selection),
                r = o.isCollapsed;
              if (
                (o.isCollapsed && e.modifySelection(o, { direction: this.direction, unit: t.unit }),
              ...
              o
                ...
                e.deleteContent(o, { doNotResetEntireContent: r }),
        ...
        class xd extends ur {
          constructor(t) {
            ...
            e.on('keyup', (t, e) => {
              ...
              e.on('keydown', (t, e) => {
                const o = {};
                if (e.keyCode == bo.delete) (o.direction = 'forward'), (o.unit = 'character');
                else {
                  if (e.keyCode != bo.backspace) return;
                  (o.direction = 'backward'), (o.unit = 'codePoint');
                }
                const r = mo.isMac ? e.altKey : e.ctrlKey;
        ...
        class Ad extends Kl {
          ...
          init() {
            ...
            if (
              (e.addObserver(xd),
              t.commands.add('forwardDelete', new yd(t, 'forward')),
              t.commands.add('delete', new yd(t, 'backward')),
              this.listenTo(n, 'delete', (n, i) => {
                ...
                t.execute('forward' == i.direction ? 'forwardDelete' : 'delete', o),
                  i.preventDefault(),
        ...
        function Sd(t, e, n) {
          let i = Pd.get(t);
          i || ((i = new Map()), Pd.set(t, i)), i.set(e, n);
        }
        function Md(t) {
          return [t];
        }
        ...
        function Id(t, e, n) {
          (t = t.slice()), (e = e.slice());
          const i = new Nd(n.document, n.useRelations, n.forceWeakRemove);
          ...
          for (; a < t.length; ) {
            ...
            const s = e[o],
              c = Ed(n, s, i.getContext(n, s, !0)),
              l = Ed(s, n, i.getContext(s, n, !1));
          ...
          return (
            Od(t, s.nextBaseVersionB),
            Od(e, s.nextBaseVersionA),
        ...
        function jd(t, e) {
          ...
          for (let i = 0; i < t.length; i++) {
            const o = t[i],
              r = new lc(o.start, o.end.offset - o.start.offset, e, 0);
            n.push(r);
        ...
        Sd(ac, ac, (t, e, n) => {
          if (t.key === e.key) {
            const i = t.range.getDifference(e.range).map((e) => new ac(e, t.key, t.oldValue, t.newValue, 0)),
              o = t.range.getIntersection(e.range);
            return (
              o && n.aIsStrong && i.push(new ac(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new Cd(0)] : i
            );
          }
          return [t];
        }),
          Sd(ac, dc, (t, e) => {
            if (t.range.start.hasSameParentAs(e.position) && t.range.containsPosition(e.position)) {
              const n = t.range
                ...
                .map((e) => new ac(e, t.key, t.oldValue, t.newValue, t.baseVersion));
              if (e.shouldReceiveAttributes) {
                const i = Dd(e, t.key, t.oldValue);
                i && n.unshift(i);
              }
              return n;
            }
          ...
          Sd(ac, mc, (t, e) => {
            ...
            t.range.start.hasSameParentAs(e.deletionPosition) &&
              ...
              n.push(Gs._createFromPositionAndShift(e.graveyardPosition, 1));
            const i = t.range._getTransformedByMergeOperation(e);
            return i.isCollapsed || n.push(i), n.map((e) => new ac(e, t.key, t.oldValue, t.newValue, t.baseVersion));
          }),
          Sd(ac, lc, (t, e) => {
            return (function (t, e) {
              ...
              return r;
            })(t.range, e).map((e) => new ac(e, t.key, t.oldValue, t.newValue, t.baseVersion));
          }),
          Sd(ac, gc, (t, e) => {
          ...
          Sd(dc, lc, (t, e) => ((t.position = t.position._getTransformedByMoveOperation(e)), [t])),
          Sd(dc, gc, (t, e) => ((t.position = t.position._getTransformedBySplitOperation(e)), [t])),
          Sd(dc, mc, (t, e) => ((t.position = t.position._getTransformedByMergeOperation(e)), [t])),
          Sd(
            hc,
            dc,
            (t, e) => (
          ...
          Sd(hc, lc, (t, e, n) => {
            if (
              (t.oldRange && (t.oldRange = Gs._createFromRanges(t.oldRange._getTransformedByMoveOperation(e))),
              t.newRange)
            ) {
              if (n.abRelation) {
          ...
          Sd(lc, dc, (t, e) => {
            const n = Gs._createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByInsertOperation(
              e,
              !1,
            )[0];
            return (
                ...
                0 === l.length
                  ...
                  : 1 == l.length
                    ? o.start.isBefore(i.start) || o.start.isEqual(i.start)
                      ...
                      : l.push(h)
                    : l.splice(1, 0, h)),
              0 === l.length ? [new Cd(t.baseVersion)] : jd(l, r)
            );
          }),
          Sd(lc, gc, (t, e, n) => {
            ...
            if (o.start.hasSameParentAs(e.splitPosition) && o.containsPosition(e.splitPosition)) {
              ...
              return (t = t._getTransformedBySplitOperation(e)), jd([new Gs(o.start, e.splitPosition), t], i);
            }
          ...
          Sd(lc, mc, (t, e, n) => {
            ...
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && i.containsPosition(e.sourcePosition))
              if ('remove' != t.type || n.forceWeakRemove) {
                ...
                t.howMany > 1 &&
                  (n.push(new lc(t.sourcePosition, t.howMany - 1, t.targetPosition, 0)),
                ...
                const l = new lc(o, e.howMany, c, 0);
          ...
          Sd(uc, dc, (t, e) => ((t.position = t.position._getTransformedByInsertOperation(e)), [t])),
          Sd(uc, mc, (t, e) =>
          ...
          Sd(uc, lc, (t, e) => ((t.position = t.position._getTransformedByMoveOperation(e)), [t])),
          Sd(uc, uc, (t, e, n) => {
          ...
          Sd(
            ...
            (t, e) => (
              ...
              (t.insertionPosition = gc.getInsertionPosition(t.splitPosition)),
              [t]
            ),
          ),
          Sd(gc, mc, (t, e, n) => {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
              ...
              const i = new $s(e.graveyardPosition.root, n),
                o = gc.getInsertionPosition(new $s(e.graveyardPosition.root, n)),
                r = new gc(i, 0, null, 0);
              return (
          ...
          Sd(gc, gc, (t, e, n) => {
            ...
            if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) {
              ...
              if ((o && !i) || (!(i && !o) && n.aIsStrong)) {
                const n = [];
                return (
                  e.howMany && n.push(new lc(e.moveTargetPosition, e.howMany, e.splitPosition, 0)),
                  t.howMany && n.push(new lc(t.splitPosition, t.howMany, t.moveTargetPosition, 0)),
                  n
                );
              }
              return [new Cd(0)];
            ...
            if (e.splitPosition.isEqual(t.insertionPosition) && 'splitBefore' == n.baRelation) {
              ...
              return [t, new lc(t.insertionPosition, 1, i, 0)];
            }
            return (
        ...
        class Vd extends ed {
          ...
          _restoreSelection(t, e, n) {
            const i = this.editor.model,
              ...
              r = [];
            for (const e of t) {
              const t = zd(e, n).find((t) => t.start.root != o.graveyard);
              t && r.push(t);
            }
            r.length &&
              i.change((t) => {
        ...
        class Ud extends Kl {
          ...
          init() {
            const t = this.editor;
            (this._undoCommand = new Bd(t)),
              (this._redoCommand = new Fd(t)),
              ...
              ? 'string' == typeof t
                ...
                : (n &&
                    (n = (function (t) {
                      return mo.isMac
                        ? _o(t)
                            .map((t) => po[t.toLowerCase()] || t)
                            .reduce((t, e) => (t.slice(-1) in go ? t + e : t + '+' + e))
                        : t;
                    })(n)),
        ...
        class Gd extends Kl {
          init() {
            const t = this.editor,
              e = t.locale,
              n = t.t,
              i = 'ltr' == e.uiLanguageDirection ? Yd : $d,
              o = 'ltr' == e.uiLanguageDirection ? $d : Yd;
            this._addButton('undo', n('bj'), 'CTRL+Z', i), this._addButton('redo', n('bk'), 'CTRL+Y', o);
          }
          _addButton(t, e, n, i) {
            const o = this.editor;
            o.ui.componentFactory.add(t, (r) => {
              ...
              return (
                ...
                this.listenTo(a, 'execute', () => o.execute(t)),
                a
              );
            });
          }
        ...
        class Kd extends Kl {
          ...
          init() {
            this.set('hasAny', !1),
              (this._actions = new oo({ idProperty: '_id' })),
              this._actions.delegate('add', 'remove').to(this);
          }
          add(t) {
            if ('string' != typeof t)
              throw new Gn.b('pendingactions-add-invalid-message: The message must be a string.', this);
        ...
        class Zd extends Kl {
          ...
          createLoader(t) {
            if (!this.createUploadAdapter)
              return (
                console.warn(Object(Gn.a)('filerepository-no-upload-adapter: Upload adapter is not defined.')), null
              );
            const e = new Xd(Promise.resolve(t), this.createUploadAdapter);
            return (
              this.loaders.add(e),
          ...
          destroyLoader(t) {
            const e = t instanceof Xd ? t : this.getLoader(t);
            e._destroy(),
        ...
        class Xd {
          ...
          read() {
            ...
            return (
              (this.status = 'reading'),
              this._filePromiseWrapper.promise
            ...
            (t && t.length == eh) ||
              ((t = (function (t) {
                ...
                for (let t = 0; t < n.length; t++) {
                  const i = nh.charAt(n[t] % nh.length);
        ...
        class oh extends Kl {
          ...
          init() {
            ...
            t && (this.editor.plugins.get(Zd).createUploadAdapter = (e) => new rh(e, t, this.editor.t));
          }
        }
        class rh {
          constructor(t, e, n) {
            ...
            e instanceof RegExp ? (i = e) : (r = e),
              ...
              t.model.document.on('change', (e, n) => {
                ...
                h.length &&
                  u.length &&
                  t.model.enqueueChange((t) => {
                    if (!1 !== s(t, h)) for (const e of u.reverse()) t.remove(e);
                  });
              });
          }
        }
        function ch(t, e, n) {
          return e
            ...
            .map((e) => n.createRange(n.createPositionAt(t, e[0]), n.createPositionAt(t, e[1])));
        }
        function lh(t, e) {
          return (n, i) => {
        ...
        class uh extends Kl {
          init() {
            const t = this.editor;
            t.model.schema.extend('$text', { allowAttributes: hh }),
              t.model.schema.setAttributeProperties(hh, { isFormatting: !0, copyOnEnter: !0 }),
              t.conversion.attributeToElement({
                model: hh,
                view: 'strong',
                upcastAlso: ['b', { styles: { 'font-weight': 'bold' } }],
              }),
              t.commands.add(hh, new dh(t, hh)),
              t.keystrokes.set('CTRL+B', hh);
          }
        }
        var fh =
        ...
        class gh extends Kl {
          init() {
            const t = this.editor,
              e = t.t;
            t.ui.componentFactory.add(mh, (n) => {
              const i = t.commands.get(mh),
                o = new Wd(n);
              return (
                o.set({ label: e('d'), icon: fh, keystroke: 'CTRL+B', tooltip: !0, isToggleable: !0 }),
                o.bind('isOn', 'isEnabled').to(i, 'value', 'isEnabled'),
                this.listenTo(o, 'execute', () => t.execute(mh)),
                o
              );
            });
          }
        ...
        class bh extends Kl {
          init() {
            const t = this.editor;
            t.model.schema.extend('$text', { allowAttributes: ph }),
              t.model.schema.setAttributeProperties(ph, { isFormatting: !0, copyOnEnter: !0 }),
              t.conversion.attributeToElement({
                model: ph,
                view: 'i',
                upcastAlso: ['em', { styles: { 'font-style': 'italic' } }],
              }),
              t.commands.add(ph, new dh(t, ph)),
              t.keystrokes.set('CTRL+I', ph);
          }
        }
        var wh =
        ...
        class _h extends Kl {
          init() {
            const t = this.editor,
              e = t.t;
            t.ui.componentFactory.add(kh, (n) => {
              const i = t.commands.get(kh),
                o = new Wd(n);
              return (
                o.set({ label: e('e'), icon: wh, keystroke: 'CTRL+I', tooltip: !0, isToggleable: !0 }),
                o.bind('isOn', 'isEnabled').to(i, 'value', 'isEnabled'),
                this.listenTo(o, 'execute', () => t.execute(kh)),
                o
              );
            });
          }
        ...
        class yh extends ed {
          ...
          execute(t = {}) {
            ...
            e.change((t) => {
              if (r) {
                const e = o.filter((t) => xh(t) || Th(n, t));
                this._applyQuote(t, e);
              } else this._removeQuote(t, o.filter(xh));
            });
          }
          _getValue() {
            const t = vh(this.editor.model.document.selection.getTopMostBlocks());
            return !(!t || !xh(t));
          }
          _checkEnabled() {
        ...
        function Ah(t, e) {
          ...
          for (; i < e.length; ) {
            ...
            n || (n = t.createPositionBefore(r)),
              (s && r.nextSibling == s) || (o.push(t.createRange(n, t.createPositionAfter(r))), (n = null)),
              i++;
          }
          return o;
        }
        ...
        class Ch extends Kl {
          init() {
            const t = this.editor,
              e = t.model.schema;
            t.commands.add('blockQuote', new yh(t)),
          ...
          init() {
            ...
            t.ui.componentFactory.add('blockQuote', (n) => {
              const i = t.commands.get('blockQuote'),
                o = new Wd(n);
              return (
                o.set({ label: e('f'), icon: Ph, tooltip: !0, isToggleable: !0 }),
                o.bind('isOn', 'isEnabled').to(i, 'value', 'isEnabled'),
                this.listenTo(o, 'execute', () => t.execute('blockQuote')),
                o
              );
            });
          }
          ...
          init() {
            ...
            e.add('ckfinder', (e) => {
              const i = t.commands.get('ckfinder'),
                o = new Wd(e);
              return (
                o.set({ label: n('g'), icon: Mh, tooltip: !0 }),
                  ...
                  e.on('file:choose:resizedImage', (e) => {
                    ...
                    if (n) Oh(t, [n]);
                      ...
                      const e = t.plugins.get('Notification'),
                        n = t.locale.t;
                      e.showWarning(n('ar'), { title: n('as'), namespace: 'ckfinder' });
                    }
                  });
              }),
              window.CKFinder[e](n);
        ...
        function Oh(t, e) {
          if (t.commands.get('imageUpload').isEnabled) t.execute('imageInsert', { source: e });
          else {
            const e = t.plugins.get('Notification'),
              n = t.locale.t;
            e.showWarning(n('at'), { title: n('au'), namespace: 'ckfinder' });
          }
        }
        class Rh extends Kl {
          static get pluginName() {
          ...
          init() {
            const t = this.editor;
            t.commands.add('ckfinder', new Nh(t));
          }
        }
        const Dh = /^data:(\S*?);base64,/;
        class Lh {
          constructor(t, e, n) {
            if (!t) throw new Gn.b('fileuploader-missing-file: File must be provided as the first argument', null);
            if (!e) throw new Gn.b('fileuploader-missing-token: Token must be provided as the second argument.', null);
            if (!n)
              throw new Gn.b(
                'fileuploader-missing-api-address: Api address must be provided as the third argument.',
                null,
              );
            (this.file = (function (t) {
              ...
              ? (function (t, e = 512) {
                  try {
                    ...
                    throw new Gn.b(
                      'fileuploader-decoding-image-data-error: Problem with decoding Base64 image data.',
                      null,
                    );
                  }
                })(t)
              ...
              new Promise((n, i) => {
                e.addEventListener('load', () => {
                  ...
                  return t < 200 || t > 299
                    ? o.message
                      ? i(
                          new Gn.b('fileuploader-uploading-data-failed: Uploading file failed.', this, {
                            message: o.message,
                          }),
                        )
                      : i(o.error)
        ...
        ci(Lh, ei);
        const jh = { refreshInterval: 36e5, autoRefresh: !0 };
        class Vh {
          constructor(t, e = jh) {
            if (!t)
              throw new Gn.b(
            ...
            this.set('value', e.initValue),
                          ...
                          i.open('GET', t),
                            i.addEventListener('load', () => {
                              ...
                              return t < 200 || t > 299
                                ? n(
                                    new Gn.b(
                                      'token-cannot-download-new-token: Cannot download new token from the provided url.',
                                      null,
                                    ),
                                  )
                                : e(o);
              ...
              (this._options = Object.assign({}, jh, e));
          }
          init() {
            return new Promise((t, e) => {
              this._options.autoRefresh && this._startRefreshing(),
                this.value ? t(this) : this._refreshToken().then(t).catch(e);
            });
          }
          _refreshToken() {
            return this._refresh()
              .then((t) => this.set('value', t))
              .then(() => this);
          }
          destroy() {
          ...
          static create(t, e = jh) {
            return new Vh(t, e).init();
          }
        }
        ci(Vh, Fi);
        var zh = Vh;
        class Bh extends Kl {
          ...
          init() {
            ...
            if (this.tokenUrl) return (this.token = new Bh.Token(this.tokenUrl)), this.token.init();
            this.token = null;
          }
        }
        Bh.Token = zh;
        class Fh extends Kl {
          ...
          init() {
            const t = this.editor,
              ...
              i = e.uploadUrl;
            n &&
              ((this._uploadGateway = new Fh._UploadGateway(n, i)),
              (t.plugins.get(Zd).createUploadAdapter = (t) => new Uh(this._uploadGateway, t)));
          }
        }
        class Uh {
          constructor(t, e) {
        ...
        Fh._UploadGateway = class {
          constructor(t, e) {
            if (!t) throw new Gn.b('uploadgateway-missing-token: Token must be provided.', null);
            if (!e) throw new Gn.b('uploadgateway-missing-api-address: Api address must be provided.', null);
            (this._token = t), (this._apiAddress = e);
          }
          upload(t) {
            return new Lh(t, this._token, this._apiAddress);
          }
        };
        class Hh extends ur {
          constructor(t) {
          ...
          _updateObservedElements(t, e) {
            ...
            if (n) {
              for (const t of n.querySelectorAll('img'))
                this._observedElements.has(t) ||
                  (this.listenTo(t, 'load', (t, e) => this._fireEvents(e)), this._observedElements.add(t));
              for (const e of this._observedElements)
                t.contains(e) || (this.stopListening(e), this._observedElements.delete(e));
            }
          }
          _fireEvents(t) {
        ...
        class Wh {
          ...
          add(t, e) {
            ...
            const o = n[0];
            i === o || Yh(i, o) || this.fire('change:top', { oldDescriptor: i, newDescriptor: o, writer: e });
          }
          remove(t, e) {
            const n = this._stack,
              i = n[0];
        ...
        function Yh(t, e) {
          return t && e && t.priority == e.priority && Gh(t.classes) == Gh(e.classes);
        }
        function $h(t, e) {
          return t.priority > e.priority || (!(t.priority < e.priority) && Gh(t.classes) > Gh(e.classes));
        }
        function Gh(t) {
        ...
        function Xh(t, e, n = {}) {
          return (
            mo.isEdge || e.setAttribute('contenteditable', 'false', t),
            e.addClass(Kh, t),
              ...
              (function (t, e) {
                const n = e.createUIElement('div', { class: 'ck ck-widget__selection-handler' }, function (t) {
                  const e = this.toDomElement(t),
                    n = new Hd();
                  return n.set('content', Qh), n.render(), e.appendChild(n.element), e;
                });
            ...
            (function (t, e, n, i) {
              ...
              t,
              e,
              (t, e, n) => n.addClass(i(e.classes), t),
              (t, e, n) => n.removeClass(i(e.classes), t),
            ),
            t
          );
          function i(t) {
        ...
        function ou(t) {
          ...
          return e &&
            (function (t) {
              return !!t.getCustomProperty('image') && Zh(t);
            })(e)
            ? e
            : null;
        }
        ...
        class lu extends Kl {
          init() {
            ...
            t.editing.view.addObserver(Hh),
              ...
              i.for('dataDowncast').elementToElement({ model: 'image', view: (t, e) => du(e) }),
                  ...
                  (function () {
                    ...
                    function t(t, e, n) {
                      ...
                      if (null === e.attributeNewValue) {
                        ...
                        t.data &&
                          (i.removeAttribute('srcset', o),
                          i.removeAttribute('sizes', o),
                          t.width && i.removeAttribute('width', o));
                      } else {
                        const t = e.attributeNewValue;
                        t.data &&
                          (i.setAttribute('srcset', t.data, o),
                          i.setAttribute('sizes', '100vw', o),
                          t.width && i.setAttribute('width', t.width, o));
                      }
                    }
                  })(),
                ),
                  ...
                  (function () {
                    ...
                    function t(t, e, n) {
                      ...
                      const o = n.convertItem(i, e.modelCursor),
                        r = vh(o.modelRange.getItems());
                      r &&
                        (n.convertChildren(e.viewItem, n.writer.createPositionAt(r, 0)),
        ...
        class fu extends Kl {
                  ...
                  for (const t of o.getRanges())
                    for (const e of t) {
                      ...
                      Zh(t) &&
                        ...
                        (s = t),
                        t == r && i.setSelection(o.getRanges(), { fake: !0, label: tu(r) }));
                    }
                },
                { priority: 'low' },
              ),
          ...
          _onMousedown(t, e) {
            ...
            if (!Zh(r) && !(r = r.findAncestor(Zh))) return;
          ...
          _onKeydown(t, e) {
            ...
            !(function (t) {
              ...
              ? !(function (t) {
                ...
                ? n === bo.enter && (o = this._handleEnterKey(e.shiftKey))
                : (o = this._selectAllNestedEditableContent() || this._selectAllContent())
              : (o = this._handleArrowKeys(i)),
              o && (e.preventDefault(), t.stop());
          }
          _handleDelete(t) {
          ...
          _clearPreviouslySelectedWidgets(t) {
            for (const e of this._previouslySelected) t.removeClass(Jh, e);
        ...
        class gu extends ed {
          refresh() {
            ...
            (this.isEnabled = ru(t)),
              ru(t) && t.hasAttribute('alt') ? (this.value = t.getAttribute('alt')) : (this.value = !1);
          }
          execute(t) {
            const e = this.editor.model,
              n = e.document.selection.getSelectedElement();
        ...
        class pu extends Kl {
          init() {
            this.editor.commands.add('imageTextAlternative', new gu(this.editor));
          }
        }
        function bu({ emitter: t, activator: e, callback: n, contextElements: i }) {
              ...
              e.setTemplate({
                ...
                attributes: {
                  class: [
                    ...
                    n.if('errorText', 'ck-labeled-input__status_error'),
        ...
        class xu extends Dl {
          constructor(t) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.saveButtonView = this._createButton(e('bd'), vu, 'ck-button-save')),
              (this.saveButtonView.type = 'submit'),
              (this.cancelButtonView = this._createButton(e('be'), yu, 'ck-button-cancel', 'cancel')),
              (this._focusables = new gl()),
              (this._focusCycler = new ql({
          ...
          _createLabeledInputView() {
            const t = this.locale.t,
              e = new wu(this.locale, ku);
            return (e.label = t('ca')), (e.inputView.placeholder = t('ca')), e;
          }
        }
        function Au({ element: t, target: e, positions: n, limiter: i, fitInViewport: o }) {
          W(e) && (e = e()), W(i) && (i = i());
          const r = (function (t) {
              ...
              (function (t, e, n, i, o) {
                ...
                return (
                  t.some((t) => {
                    ...
                    return (
                      o && (f = o.getIntersectionArea(h)),
                      o && !i ? f > c && m() : !o && i ? u > a && m() : f > c && u >= a ? m() : f >= c && u > a && m(),
                      u === l
                    );
                  }),
                  r ? [s, r] : null
                );
              })(n, a, s, t, e) || Tu(n[0], a, s);
          } else [l, c] = Tu(n[0], a, s);
          let { left: d, top: h } = Cu(c);
          if (r) {
            const t = Cu(new As(r)),
              e = ys(r);
        ...
        function Cu({ left: t, top: e }) {
          const { scrollX: n, scrollY: i } = nr.window;
            ...
            this.set('top', 0),
              ...
              this.setTemplate({
                ...
                attributes: {
                  ...
                  style: { top: e.to('top', Pu), left: e.to('left', Pu) },
                },
                children: this.content,
              });
          }
        ...
        function Eu(t) {
          return Wn(t) ? t : vs(t) ? t.commonAncestorContainer : 'function' == typeof t ? Eu(t()) : null;
        }
        function Iu(t, e) {
          return t.top - e.height - Mu.arrowVerticalOffset;
        }
        function Nu(t) {
          return t.bottom + Mu.arrowVerticalOffset;
        }
        (Mu.arrowHorizontalOffset = 25),
          (Mu.arrowVerticalOffset = 10),
          (Mu._getOptimalPosition = Au),
          (Mu.defaultPositions = {
            northArrowSouth: (t, e) => ({ top: Iu(t, e), left: t.left + t.width / 2 - e.width / 2, name: 'arrow_s' }),
            northArrowSouthEast: (t, e) => ({
              top: Iu(t, e),
              left: t.left + t.width / 2 - e.width + Mu.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northArrowSouthWest: (t, e) => ({
              top: Iu(t, e),
              left: t.left + t.width / 2 - Mu.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            northWestArrowSouth: (t, e) => ({ top: Iu(t, e), left: t.left - e.width / 2, name: 'arrow_s' }),
            northWestArrowSouthWest: (t, e) => ({
              top: Iu(t, e),
              left: t.left - Mu.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            northWestArrowSouthEast: (t, e) => ({
              top: Iu(t, e),
              left: t.left - e.width + Mu.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northEastArrowSouth: (t, e) => ({ top: Iu(t, e), left: t.right - e.width / 2, name: 'arrow_s' }),
            northEastArrowSouthEast: (t, e) => ({
              top: Iu(t, e),
              left: t.right - e.width + Mu.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northEastArrowSouthWest: (t, e) => ({
              top: Iu(t, e),
              left: t.right - Mu.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            southArrowNorth: (t, e) => ({ top: Nu(t), left: t.left + t.width / 2 - e.width / 2, name: 'arrow_n' }),
            ...
            southWestArrowNorth: (t, e) => ({ top: Nu(t), left: t.left - e.width / 2, name: 'arrow_n' }),
            ...
            southEastArrowNorth: (t, e) => ({ top: Nu(t), left: t.right - e.width / 2, name: 'arrow_n' }),
        ...
        class Lu extends Kl {
          ...
          add(t) {
            if (this.hasView(t.view))
              throw new Gn.b('contextualballoon-add-view-exist: Cannot add configuration of the same view twice.', [
                this,
                t,
              ]);
          ...
          _createRotatorView() {
            const t = new ju(this.editor.locale),
          ...
          _createFakePanelsView() {
            const t = new Vu(this.editor.locale, this.view);
            return (
        ...
        class ju extends Dl {
          constructor(t) {
            ...
            this.set('isNavigationVisible', !0),
              (this.focusTracker = new sl()),
              (this.buttonPrevView = this._createButtonView(e('bq'), Ou)),
              (this.buttonNextView = this._createButtonView(e('br'), Ru)),
              (this.content = this.createCollection()),
              this.setTemplate({
                tag: 'div',
          ...
          updatePosition() {
            if (this.numberOfPanels) {
              const { top: t, left: e } = this._balloonPanelView,
                { width: n, height: i } = new As(this._balloonPanelView.element);
        ...
        class Fu extends Kl {
          ...
          _createButton() {
            ...
            t.ui.componentFactory.add('imageTextAlternative', (n) => {
              const i = t.commands.get('imageTextAlternative'),
                o = new Wd(n);
              return (
                o.set({ label: e('bs'), icon: zu, tooltip: !0 }),
                o.bind('isEnabled').to(i, 'isEnabled'),
                this.listenTo(o, 'execute', () => this._showForm()),
                o
              );
            });
          }
                ...
                ou(e.selection)
                  ? this._isVisible &&
                    (function (t) {
                      ...
                      if (ou(t.editing.view.document.selection)) {
                        const n = Bu(t);
                        e.updatePosition(n);
                      }
                    })(t)
          ...
          _showForm() {
            ...
            this._isInBalloon || this._balloon.add({ view: this._form, position: Bu(t) }),
        ...
        class qu extends Dl {
          constructor(t) {
            super(t),
              (this.buttonView = new Wd(t)),
              (this._fileInputView = new Wu(t)),
        ...
        class Qu extends Kl {
          init() {
            ...
            t.ui.componentFactory.add('imageUpload', (n) => {
              ...
              return (
                i.set({ acceptedType: 'image/*', allowMultipleFiles: !0 }),
                i.buttonView.set({ label: e('p'), icon: Yu, tooltip: !0 }),
                i.buttonView.bind('isEnabled').to(o),
                i.on('done', (e, n) => {
                  const i = Array.from(n).filter($u);
        ...
        var Ku = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250"><rect rx="4"/></svg>';
        n(52), n(54), n(56);
        class Ju extends Kl {
          constructor(t) {
            super(t), (this.placeholder = 'data:image/svg+xml;utf8,' + encodeURIComponent(Ku));
          }
          init() {
          ...
          uploadStatusChange(t, e, n) {
            ...
            if (!n.consumable.consume(e.item, t.name)) return;
            const s = i.plugins.get(Zd),
              a = r ? e.attributeNewValue : null,
              c = this.placeholder,
              l = i.editing.mapper.toViewElement(o),
              d = n.writer;
            if ('reading' == a) return Zu(l, d), void Xu(c, l, d);
            if ('uploading' == a) {
        ...
        function Xu(t, e, n) {
          ...
          i.getAttribute('src') !== t && n.setAttribute('src', t, i),
            ef(e, 'placeholder') ||
              n.insert(
                n.createPositionAfter(i),
                (function (t) {
        ...
        class of {
          ...
          rename(t, e) {
            const n = new ki(t, e.getAttributes(), e.getChildren());
        ...
        class rf extends ed {
          ...
          execute(t) {
            ...
            n.change((e) => {
              ...
              for (const t of o) sf(e, n, i, t);
            });
          }
        }
        function sf(t, e, n, i) {
          const o = n.createLoader(i);
          o && su(t, e, { uploadId: o.id });
        }
        class af extends Kl {
          static get requires() {
            return [Zd, Ih];
          ...
          init() {
            ...
            n.extend('image', { allowAttributes: ['uploadId', 'uploadStatus'] }),
              t.commands.add('imageUpload', new rf(t)),
              ...
              this.listenTo(t.editing.view.document, 'clipboardInput', (e, n) => {
                if (
                  ...
                  return;
                const i = Array.from(n.dataTransfer.files).filter((t) => !!t && $u(t)),
              ...
              t.plugins.has('Clipboard') &&
                this.listenTo(t.plugins.get('Clipboard'), 'inputTransformation', (e, n) => {
                  const i = Array.from(t.editing.view.createRangeIn(n.content))
                    .filter(
                      (t) =>
                        (function (t) {
                          return (
                            !(!t.is('element', 'img') || !t.getAttribute('src')) &&
                            (t.getAttribute('src').match(/^data:image\/\w+;base64,/g) ||
                              t.getAttribute('src').match(/^blob:/g))
                          );
                        })(t.item) && !t.item.getAttribute('uploadProcessed'),
                    )
                    .map((t) => ({ promise: Gu(t.item), imageElement: t.item }));
                  if (!i.length) return;
                  const r = new of();
                  for (const t of i) {
            ...
            return (
              ...
              t
                ...
                .catch((n) => {
                  ...
                  'error' == t.status && n && s.showWarning(n, { title: o('al'), namespace: 'upload' }),
                    a(),
                    i.enqueueChange('transparent', (t) => {
                      t.remove(e);
                    });
        ...
        class df extends ed {
          refresh() {
            const t = this.editor.model,
              e = vh(t.document.selection.getSelectedBlocks());
            (this.value = !!e && e.is('paragraph')), (this.isEnabled = !!e && hf(e, t.schema));
          }
          execute(t = {}) {
            const e = this.editor.model,
              n = e.document;
            e.change((i) => {
              ...
              for (const t of o) !t.is('paragraph') && hf(t, e.schema) && i.rename(t, 'paragraph');
            });
          }
        }
        function hf(t, e) {
          ...
          init() {
            ...
            t.commands.add('paragraph', new df(t)),
              ...
              n.upcastDispatcher.on(
                'element',
                (t, e, n) => {
                  n.consumable.test(e.viewItem, { name: e.viewItem.name }) &&
                    mf(e.viewItem, e.modelCursor, n.schema) &&
                    Object.assign(e, ff(e.viewItem, e.modelCursor, n));
                },
                { priority: 'low' },
              ),
              n.upcastDispatcher.on(
                ...
                (t, e, n) => {
                  e.modelRange ||
                    (mf(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, ff(e.viewItem, e.modelCursor, n)));
                },
                { priority: 'lowest' },
              ),
        ...
        class gf extends ed {
          ...
          refresh() {
            const t = vh(this.editor.model.document.selection.getSelectedBlocks());
            (this.value = !!t && this.modelElements.includes(t.name) && t.name),
              (this.isEnabled = !!t && this.modelElements.some((e) => pf(t, e, this.editor.model.schema)));
          }
          execute(t) {
            const e = this.editor.model,
              n = e.document,
              i = t.value;
            e.change((t) => {
              const o = Array.from(n.selection.getSelectedBlocks()).filter((t) => pf(t, i, e.schema));
          ...
          init() {
            ...
            for (const i of e)
              i.model !== bf &&
                ...
                n.push(i.model));
            this._addDefaultH1Conversion(t), t.commands.add('heading', new gf(t, n));
          }
          afterInit() {
            const t = this.editor,
            ...
            e &&
              this.listenTo(e, 'afterExecute', (e, i) => {
                ...
                n.some((t) => o.is(t.model)) && !o.is(bf) && 0 === o.childCount && i.writer.rename(o, bf);
              });
          }
          _addDefaultH1Conversion(t) {
            t.conversion
              .for('upcast')
              .elementToElement({ model: 'heading1', view: 'h1', converterPriority: Zn.get('low') + 1 });
          }
        }
        class kf {
          constructor(t, e) {
        ...
        class vf extends Dl {
              ...
              this.on('change:isOpen', () => {
                this.isOpen &&
                  ('auto' === this.panelPosition
                    ? (this.panelView.position = vf._getOptimalPosition({
          ...
          get _panelPositions() {
            const { southEast: t, southWest: e, northEast: n, northWest: i } = vf.defaultPanelPositions;
            return 'ltr' === this.locale.uiLanguageDirection ? [t, e, n, i] : [e, t, i, n];
          }
        }
        (vf.defaultPanelPositions = {
        ...
        class xf extends Wd {
          ...
          _createArrowView() {
            const t = new Hd();
            return (t.content = yf), t.extendTemplate({ attributes: { class: 'ck-dropdown__arrow' } }), t;
          }
        }
        n(60);
        class Af extends Dl {
        ...
        function Sf(t, e = xf) {
          ...
          return (
            ...
            n instanceof xf ? n.bind('isOn').to(o, 'isOpen') : n.arrowView.bind('isOn').to(o, 'isOpen'),
            (function (t) {
              (function (t) {
                t.on('render', () => {
                  bu({
                ...
                (function (t) {
                  t.on('execute', (e) => {
                    e.source instanceof Pf || (t.isOpen = !1);
                  });
                })(t),
                (function (t) {
        ...
        function Mf(t, e) {
          const n = t.locale,
            i = (t.listView = new Af(n));
          i.items.bindTo(e).using(({ type: t, model: e }) => {
            if ('separator' === t) return new Cf(n);
            if ('button' === t || 'switchbutton' === t) {
              const i = new Tf(n);
              let o;
              return (
                (o = 'button' === t ? new Wd(n) : new Pf(n)).bind(...Object.keys(e)).to(e),
          ...
          init() {
            ...
            t.ui.componentFactory.add('heading', (e) => {
              const r = {},
                ...
                l = [a];
              for (const t of n) {
                const e = { type: 'button', model: new kf({ label: t.title, class: t.class, withText: !0 }) };
                'paragraph' === t.model
        ...
        class Of extends Kl {
          init() {
            ...
            n.register('caption', { allowIn: 'image', allowContentOf: '$block', isLimit: !0 }),
              ...
              t.conversion.for('upcast').elementToElement({ view: Nf, model: 'caption' });
            i.downcastDispatcher.on(
              'insert:caption',
              Rf((t) => t.createContainerElement('figcaption'), !1),
            );
            const s = (function (t, e) {
              return (n) => {
                const i = n.createEditableElement('figcaption');
                return n.setCustomProperty('imageCaption', !0, i), ll({ view: t, element: i, text: e }), eu(i, n);
              };
            })(e, r('ak'));
            o.downcastDispatcher.on('insert:caption', Rf(s)),
          ...
          _updateCaptionVisibility(t) {
            ...
            const s = Df(o.getFirstPosition().parent);
            if ((s && (i = e.toViewElement(s)), i))
              return n
                ? n === i
                  ? jf(i, t)
                  : (Lf(n, t), (this._lastSelectedCaption = i), jf(i, t))
                : ((this._lastSelectedCaption = i), jf(i, t));
            if (n) {
              const e = Lf(n, t);
          ...
          _insertMissingModelCaptionElement(t) {
            ...
            for (const t of n)
              if ('insert' == t.type && '$text' != t.name) {
                ...
                if ((n.is('image') && !If(n) && i.push(n), !n.is('image') && n.childCount))
                  for (const t of e.createRangeIn(n).getItems()) t.is('image') && !If(t) && i.push(t);
              }
        ...
        const qf = {
            full: { name: 'full', title: 'Full size image', icon: Bf, isDefault: !0 },
            side: { name: 'side', title: 'Side image', icon: Hf, className: 'image-style-side' },
            alignLeft: {
              name: 'alignLeft',
          ...
          Wf = { full: Bf, left: Ff, right: Hf, center: Uf };
        function Yf(t = []) {
          return t.map($f);
        }
        function $f(t) {
          if ('string' == typeof t) {
            const e = t;
            qf[e]
              ? (t = Object.assign({}, qf[e]))
              : (console.warn(Object(Gn.a)('image-style-not-found: There is no such image style of given name.'), {
                  name: e,
                }),
                (t = { name: e }));
          } else if (qf[t.name]) {
          ...
          return 'string' == typeof t.icon && Wf[t.icon] && (t.icon = Wf[t.icon]), t;
        }
        class Gf extends Kl {
          static get pluginName() {
          ...
          init() {
            ...
            const o = Yf(t.config.get('image.styles'));
            e.extend('image', { allowAttributes: 'imageStyle' });
            const r = (function (t) {
              return (e, n, i) => {
                if (!i.consumable.consume(n.item, e.name)) return;
                const o = zf(n.attributeNewValue, t),
            ...
            i.downcastDispatcher.on('attribute:imageStyle:image', r),
              ...
              t.commands.add('imageStyle', new Vf(t, o));
          }
        }
        n(71);
        class Qf extends Kl {
          ...
          init() {
            const t = (function (t, e) {
              ...
              return t;
            })(Yf(this.editor.config.get('image.styles')), this.localizedDefaultStylesTitles);
          ...
          _createButton(t) {
            ...
            e.ui.componentFactory.add(n, (n) => {
              const i = e.commands.get('imageStyle'),
                o = new Wd(n);
              return (
                o.set({ label: t.title, icon: t.icon, tooltip: !0, isToggleable: !0 }),
                o.bind('isEnabled').to(i, 'isEnabled'),
                o.bind('isOn').to(i, 'value', (e) => e === t.name),
                this.listenTo(o, 'execute', () => e.execute('imageStyle', { value: t.name })),
                o
              );
            });
          }
        ...
        class Kf extends Kl {
          ...
          register(t, { ariaLabel: e, items: n, getRelatedElement: i, balloonClassName: o = 'ck-toolbar-container' }) {
            const r = this.editor,
              s = r.t,
              a = new $l(r.locale);
            if (((a.ariaLabel = e || s('av')), this._toolbarDefinitions.has(t)))
              throw new Gn.b('widget-toolbar-duplicated: Toolbar with the given id was already added.', this, {
                toolbarId: t,
              });
        ...
        function Xf(t, e, n) {
          return n.createRange(tm(t, e, !0, n), tm(t, e, !1, n));
        }
        function tm(t, e, n, i) {
            ...
            n.change((e) => {
              if (i.isCollapsed) {
                ...
                if (i.hasAttribute('linkHref')) {
                  const a = Xf(s, i.getAttribute('linkHref'), n);
        ...
        class nm extends ed {
          ...
          execute() {
            ...
            e.change((t) => {
              const o = n.isCollapsed ? [Xf(n.getFirstPosition(), n.getAttribute('linkHref'), e)] : n.getRanges();
              for (const e of o)
        ...
        var om = function (t, e, n) {
            var i = t.length;
            return (n = void 0 === n ? i : n), !e && n >= i ? t : im(t, e, n);
          },
          rm = RegExp('[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]');
        var sm = function (t) {
          return rm.test(t);
        };
        var am = function (t) {
          ...
          fm = '[\\ud800-\\udbff][\\udc00-\\udfff]',
          mm = '(?:' + lm + '|' + dm + ')' + '?',
          gm = '[\\ufe0e\\ufe0f]?' + mm + ('(?:\\u200d(?:' + [hm, um, fm].join('|') + ')[\\ufe0e\\ufe0f]?' + mm + ')*'),
          pm = '(?:' + [hm + lm + '?', lm, um, fm, cm].join('|') + ')',
          bm = RegExp(dm + '(?=' + dm + ')|' + pm + gm, 'g');
        var wm = function (t) {
          return t.match(bm) || [];
        };
        var km = function (t) {
          return sm(t) ? wm(t) : am(t);
        };
        var _m = function (t, e) {
          ...
          vm = 1 / 0,
          ym = o ? o.prototype : void 0,
          xm = ym ? ym.toString : void 0;
        var Am = function t(e) {
          if ('string' == typeof e) return e;
          if (Wt(e)) return _m(e, t) + '';
          if (os(e)) return xm ? xm.call(e) : '';
          var n = e + '';
          return '0' == n && 1 / e == -vm ? '-0' : n;
        };
        var Tm = function (t) {
          return null == t ? '' : Am(t);
        };
        var Cm = (function (t) {
          return function (e) {
            e = Tm(e);
            var n = sm(e) ? km(e) : void 0,
              i = n ? n[0] : e.charAt(0),
              o = n ? om(n, 1).join('') : e.slice(1);
            return i[t]() + o;
          };
        })('toUpperCase');
        const Pm = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
          Sm = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        function Mm(t, e) {
        ...
        class Om {
          ...
          handleBackwardMovement(t, e) {
            ...
            return this._isGravityOverridden
              ? jm(t, n) && this._hasSelectionAttribute
              ...
              : jm(t, n) && !this._hasSelectionAttribute
                ...
                : t.isAtEnd && Lm(t, n)
                  ? this._hasSelectionAttribute
                    ? void (Vm(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
                    : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0)
                  : t.isAtStart
                    ? this._hasSelectionAttribute
        ...
        function Vm(t, e) {
          return Rm(t.getShiftedBy(-1), e);
        }
        n(73);
        const zm = 'ck-link_selected',
          Bm = 'automatic',
          Fm = 'manual',
          Um = /^(https?:)?\/\//;
        class Hm extends Kl {
          ...
          init() {
            ...
            t.model.schema.extend('$text', { allowAttributes: 'linkHref' }),
              t.conversion.for('dataDowncast').attributeToElement({ model: 'linkHref', view: Mm }),
              t.conversion
                .for('editingDowncast')
            ...
            const n = (function (t, e) {
              const n = { 'Open in a new tab': t('ax'), Downloadable: t('ay') };
              ...
              (function (t) {
                ...
                if (t)
                  for (const [n, i] of Object.entries(t)) {
                    const t = Object.assign({}, i, { id: `link${Cm(n)}` });
                    e.push(t);
                  }
                return e;
              })(t.config.get('link.decorators')),
            );
            this._enableAutomaticDecorators(n.filter((t) => t.mode === Bm)),
              this._enableManualDecorators(n.filter((t) => t.mode === Fm)),
              (function ({ view: t, model: e, emitter: n, attribute: i, locale: o }) {
                const r = new Om(e, n, i),
                  ...
                  (t, e) => {
                    ...
                    (l =
                      ('ltr' === c && n) || ('rtl' === c && i)
                        ...
                        : r.handleBackwardMovement(a, e)) && t.stop();
                  },
                  ...
                  view: (e, i) => {
                    if (e) {
                      const e = n.get(t.id).attributes,
                        o = i.createAttributeElement('a', e, { priority: 5 });
          ...
          _setupLinkHighlight() {
            ...
            e.document.registerPostFixer((e) => {
              ...
              let o = !1;
              if (i.hasAttribute('linkHref')) {
                const r = Xf(i.getFirstPosition(), i.getAttribute('linkHref'), t.model),
                  s = t.editing.mapper.toViewRange(r);
                for (const t of s.getItems()) t.is('a') && !t.hasClass(zm) && (e.addClass(zm, t), n.add(t), (o = !0));
              }
              return o;
            }),
              t.conversion.for('editingDowncast').add((t) => {
                function i() {
                  e.change((t) => {
                    for (const e of n.values()) t.removeClass(zm, e), n.delete(e);
                  });
                }
        ...
        class Wm extends Dl {
          constructor(t, e = []) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.saveButtonView = this._createButton(n('bd'), vu, 'ck-button-save')),
              (this.saveButtonView.type = 'submit'),
              (this.cancelButtonView = this._createButton(n('be'), yu, 'ck-button-cancel', 'cancel')),
            ...
            e.length && i.push('ck-link-form_layout-vertical'),
          ...
          _createUrlInput() {
            const t = this.locale.t,
              e = new wu(this.locale, ku);
            return (e.label = t('bf')), (e.inputView.placeholder = 'https://example.com'), e;
          }
          _createButton(t, e, n, i) {
            const o = new Wd(this.locale);
            return (
          ...
          _createManualDecoratorSwitches(t) {
            ...
            for (const n of t) {
              const t = new Pf(this.locale);
              t.set({ name: n.id, label: n.label, withText: !0 }),
        ...
        class Gm extends Dl {
          constructor(t) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.unlinkButtonView = this._createButton(e('az'), Ym, 'unlink')),
              (this.editButtonView = this._createButton(e('ba'), $m, 'edit')),
              this.set('href'),
              (this._focusables = new gl()),
              (this._focusCycler = new ql({
                focusables: this._focusables,
          ...
          _createPreviewButton() {
            const t = new Wd(this.locale),
              ...
              n = this.t;
            return (
              t.set({ withText: !0, tooltip: n('bb') }),
              t.extendTemplate({
                attributes: {
                  class: ['ck', 'ck-link-actions__preview'],
                  href: e.to('href', (t) => t && Em(t)),
                  target: '_blank',
                },
              }),
              t.bind('label').to(this, 'href', (t) => t || n('bc')),
        ...
        class Jm extends Kl {
          ...
          init() {
            const t = this.editor;
            t.editing.view.addObserver(qm),
              (this.actionsView = this._createActionsView()),
              (this.formView = this._createFormView()),
              (this._balloon = t.plugins.get(Lu)),
          ...
          _createFormView() {
            const t = this.editor,
              ...
              n = new Wm(t.locale, e.manualDecorators);
            return (
          ...
          _addFormView() {
            ...
            this._balloon.add({ view: this.formView, position: this._getBalloonPositionData() }),
              this._balloon.visibleView === this.formView && this.formView.urlInputView.select(),
          ...
          _getSelectedLinkElement() {
            const t = this.editor.editing.view,
              e = t.document.selection;
            if (e.isCollapsed) return Zm(e.getFirstPosition());
            {
        ...
        class Xm extends ed {
          ...
          execute() {
            const t = this.editor.model,
              e = t.document,
              n = Array.from(e.selection.getSelectedBlocks()).filter((e) => eg(e, t.schema)),
              i = !0 === this.value;
            t.change((t) => {
              if (i) {
        ...
        function tg(t, e, n) {
          ...
          if (i.is('listItem')) {
            ...
            for (; o && o.is('listItem') && o.getAttribute('listIndent') >= n; )
              r > o.getAttribute('listIndent') && (r = o.getAttribute('listIndent')),
                o.getAttribute('listIndent') == r && t[e ? 'unshift' : 'push'](o),
        ...
        function og(t, e, n, i) {
          ...
          if (((a = sg(a)), s.insert(a, o), l && 'listItem' == l.name)) {
            ...
            for (const t of n)
              if (t.item.is('li')) {
                ...
                rg(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), (n.position = i);
              }
          } else {
          ...
          rg(s, o, o.nextSibling), rg(s, o.previousSibling, o);
        }
        function rg(t, e, n) {
          return !e || !n || ('ul' != e.name && 'ol' != e.name)
            ? null
            : e.name != n.name || e.getAttribute('class') !== n.getAttribute('class')
              ? null
        ...
        function ug(t, e, n) {
          const i = n.mapper.toViewElement(e.item).parent,
            o = n.writer;
          rg(o, i, i.nextSibling), rg(o, i.previousSibling, i);
            ...
            if (o.length > 0) {
              for (let e = 0; e < o.length; e++) {
                ...
                if (((t = i.insert(t, o[e]).end), e > 0)) {
                  const e = rg(i, n, n.nextSibling);
                  e && e.parent == n && t.offset--;
                }
              }
              rg(i, t.nodeBefore, t.nodeAfter);
            }
          }
        }
        function mg(t, e, n) {
            ...
            const a = (function (t, e, n) {
              ...
              for (const s of e)
                if ('ul' == s.name || 'ol' == s.name) r = n.convertItem(s, r).modelCursor;
                  ...
                  c &&
                    ((t = e.modelCursor.parent.is('listItem') ? e.modelCursor.parent : _g(e.modelCursor)),
              ...
              !n || e.is('ul') || e.is('ol') || e._remove(),
                e.is('text')
                  ? (i && (e._data = e.data.replace(/^\s+/, '')),
                    (!e.nextSibling || e.nextSibling.is('ul') || e.nextSibling.is('ol')) &&
        ...
        function kg(t, [e, n]) {
          ...
          if (((i = n ? this.createSelection(n) : this.document.selection), o && o.is('listItem'))) {
            ...
            if (
              ...
              if (t > 0)
                for (; o && o.is('listItem'); )
                  o._setAttribute('listIndent', o.getAttribute('listIndent') + t), (o = o.nextSibling);
            }
          }
        }
        function _g(t) {
          const e = new qs({ startPosition: t });
          let n;
          do {
            n = e.next();
        ...
        function vg(t, e, n, i, o, r) {
          const s = ag(e.nodeBefore, { sameIndent: !0, smallerIndent: !0, listIndent: t, foo: 'b' }),
            a = o.mapper,
            c = o.writer,
          ...
          for (const t of [...i.getChildren()])
            (t.is('ul') || t.is('ol')) &&
              ((d = c.move(c.createRangeOn(t), d).end), rg(c, t, t.nextSibling), rg(c, t.previousSibling, t));
        }
        class yg extends Kl {
          static get requires() {
            return [uf];
          ...
          init() {
            ...
            t.model.document.registerPostFixer((e) =>
              (function (t, e) {
                ...
                for (const t of n)
                  if ('insert' == t.type && 'listItem' == t.name) r(t.position);
                    ...
                    if ('$text' != t.name) {
                      const n = t.position.nodeAfter;
                      n.hasAttribute('listIndent') && (e.removeAttribute('listIndent', n), (o = !0)),
                        n.hasAttribute('listType') && (e.removeAttribute('listType', n), (o = !0));
                    }
                ...
                function s(t) {
                  ...
                  for (; t && t.is('listItem'); ) {
                    ...
                    if (r > n) {
                      let s;
                      null === i ? ((i = r - n), (s = n)) : (i > r && (i = r), (s = r - i)),
              ...
              n.mapper.registerViewToModelLength('li', xg),
              e.mapper.registerViewToModelLength('li', xg),
              n.mapper.on('modelToViewPosition', wg(n.view)),
              n.mapper.on(
                'viewToModelPosition',
                (function (t) {
                  return (e, n) => {
              ...
              e.mapper.on('modelToViewPosition', wg(n.view)),
              n.downcastDispatcher.on('insert', fg, { priority: 'high' }),
              n.downcastDispatcher.on('insert:listItem', dg(t.model)),
              e.downcastDispatcher.on('insert', fg, { priority: 'high' }),
              e.downcastDispatcher.on('insert:listItem', dg(t.model)),
              n.downcastDispatcher.on('attribute:listType:listItem', hg, { priority: 'high' }),
              n.downcastDispatcher.on('attribute:listType:listItem', ug, { priority: 'low' }),
                ...
                (function (t) {
                  return (e, n, i) => {
                    ...
                    const s = o.parent,
                      ...
                      c = r.createRangeOn(s);
                    r.remove(c),
                      a && a.nextSibling && rg(r, a, a.nextSibling),
                      vg(n.attributeOldValue + 1, n.range.start, c.start, o, i, t),
                      og(n.item, o, i, t);
                ...
                (function (t) {
                  return (e, n, i) => {
                    const o = i.mapper
                        ...
                        .getLastMatchingPosition((t) => !t.item.is('li')).nodeAfter,
                      r = i.writer;
                    r.breakContainer(r.createPositionBefore(o)), r.breakContainer(r.createPositionAfter(o));
                    const s = o.parent,
                      a = s.previousSibling,
                      ...
                      l = r.remove(c);
                    a && a.nextSibling && rg(r, a, a.nextSibling),
                      vg(i.mapper.toModelElement(o).getAttribute('listIndent') + 1, n.position, c.start, o, i, t);
                    for (const t of r.createRangeIn(l).getItems()) i.mapper.unbindViewElement(t);
                    e.stop();
                  };
                })(t.model),
              ),
              n.downcastDispatcher.on('remove', mg, { priority: 'low' }),
              e.upcastDispatcher.on('element:ul', pg, { priority: 'high' }),
              e.upcastDispatcher.on('element:ol', pg, { priority: 'high' }),
              e.upcastDispatcher.on('element:li', bg, { priority: 'high' }),
              e.upcastDispatcher.on('element:li', gg),
              t.model.on('insertContent', kg, { priority: 'high' }),
              t.commands.add('numberedList', new Xm(t, 'numbered')),
              t.commands.add('bulletedList', new Xm(t, 'bulleted')),
              t.commands.add('indentList', new ng(t, 'forward')),
              t.commands.add('outdentList', new ng(t, 'backward'));
            ...
            this.listenTo(i, 'enter', (t, e) => {
              ...
              this.listenTo(
                ...
                (t, e) => {
                  ...
                  const o = i.parent;
                  'listItem' === o.name &&
                    ((o.previousSibling && 'listItem' === o.previousSibling.name) ||
                      (this.editor.execute('outdentList'), e.preventDefault(), t.stop()));
                },
                { priority: 'high' },
              );
        ...
        function xg(t) {
          ...
          for (const n of t.getChildren())
            if ('ul' == n.name || 'ol' == n.name) for (const t of n.getChildren()) e += xg(t);
          return e;
        }
        var Ag =
        ...
        class Cg extends Kl {
          init() {
            const t = this.editor.t;
            cg(this.editor, 'numberedList', t('q'), Ag), cg(this.editor, 'bulletedList', t('r'), Tg);
          }
        }
        function Pg(t, e) {
          return (t) => {
        ...
        function Sg(t, e, n, i) {
          ...
          return (o.getFillerOffset = Ig), t.insert(t.createPositionAt(o, 0), e.getMediaViewElement(t, n, i)), o;
        }
        function Mg(t) {
          const e = t.getSelectedElement();
        ...
        class Dg {
          ...
          _getMedia(t) {
            if (!t) return new Lg(this.locale);
            t = t.trim();
            for (const e of this.providerDefinitions) {
              ...
              for (const e of i) {
                ...
                if (i) return new Lg(this.locale, t, i, n);
              }
            }
            return null;
          }
        ...
        class jg extends Kl {
          ...
          constructor(t) {
            super(t),
                ...
                providers: [
                  {
                    ...
                    html: (t) => {
                      return (
                        ...
                        `<iframe src="https://www.dailymotion.com/embed/video/${t[1]}" ` +
                        'style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" width="480" height="270" allowfullscreen allow="autoplay"></iframe></div>'
                      );
                    },
                  },
                  {
                    ...
                    html: (t) => {
                      return (
                        ...
                        `<iframe src="https://open.spotify.com/embed/${t[1]}" ` +
                        'style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe></div>'
                      );
                    },
                  },
                  {
                    ...
                    html: (t) => {
                      return (
                        ...
                        `<iframe src="https://www.youtube.com/embed/${t[1]}" ` +
                  ...
                  },
                  {
                    ...
                    html: (t) => {
                      return (
                        '<div style="position: relative; padding-bottom: 100%; height: 0; padding-bottom: 56.2493%;">' +
                        `<iframe src="https://player.vimeo.com/video/${t[1]}" ` +
              ...
              (this.registry = new Dg(t.locale, t.config.get('mediaEmbed')));
          }
          init() {
            const t = this.editor,
              e = t.model.schema,
              ...
              r = this.registry;
            t.commands.add('mediaEmbed', new Ng(t)),
              ...
              i.for('dataDowncast').elementToElement({
                ...
                view: (t, e) => {
                  ...
                  return Sg(e, r, n, { renderMediaPreview: n && o });
                },
              }),
              i.for('dataDowncast').add(Pg(r, { renderMediaPreview: o })),
              i.for('editingDowncast').elementToElement({
                model: 'media',
                view: (t, e) => {
                  const i = t.getAttribute('url');
                  return (function (t, e, n) {
                    return e.setCustomProperty('media', !0, t), Xh(t, e, { label: n });
                  })(Sg(e, r, i, { renderForEditingView: !0 }), e, n('am'));
                },
              }),
              i.for('editingDowncast').add(Pg(r, { renderForEditingView: !0 })),
              i
                .for('upcast')
                .elementToElement({
          ...
          init() {
            ...
            this.listenTo(t.plugins.get(td), 'inputTransformation', () => {
              ...
              t.commands.get('undo').on(
                ...
                () => {
                  this._timeoutId &&
                    (nr.window.clearTimeout(this._timeoutId),
        ...
        class Bg extends Dl {
          ...
          _createUrlInput() {
            const t = this.locale.t,
              ...
              n = e.inputView;
            return (
              (this._urlInputViewInfoDefault = t('bg')),
              (this._urlInputViewInfoTip = t('bh')),
              (e.label = t('bi')),
        ...
        class Ug extends Kl {
          ...
          init() {
            const t = this.editor,
              ...
              n = t.plugins.get(jg).registry;
            (this.form = new Bg(
              (function (t, e) {
                return [
                  (e) => {
                    if (!e.url.length) return t('ao');
                  },
                  (n) => {
                    if (!e.hasMedia(n.url)) return t('ap');
                  },
                ];
              })(t.t, n),
              t.locale,
          ...
          _setUpDropdown(t, e, n) {
            ...
            t.bind('isEnabled').to(n),
              ...
              r.set({ label: o('an'), icon: Fg, tooltip: !0 }),
              r.on(
                'open',
                () => {
        ...
        function Hg(t, e) {
          ...
          const n = new of(),
            i = (function (t, e) {
              const n = e.createRangeIn(t),
                i = new bi({ name: /^p|h\d+$/, styles: { 'mso-list': /.*/ } }),
                o = [];
              for (const t of n)
          ...
          i.forEach((t, r) => {
            ...
            const s = (function (t, e) {
              return (
                (function (t, e) {
                  const n = new bi({ name: 'span', styles: { 'mso-list': 'Ignore' } }),
                    i = e.createRangeIn(t);
        ...
        function qg(t) {
          ...
          return (
            n &&
              ((e.id = parseInt(n.match(/(^|\s+)l(\d+)/i)[2])),
              (e.order = parseInt(n.match(/\s*lfo(\d+)/i)[1])),
              (e.indent = parseInt(n.match(/\s*level(\d+)/i)[1]))),
            e
          );
        }
        function Wg(t) {
        ...
        const Yg = /id=("|')docs-internal-guid-[-0-9a-f]+("|')/i;
        class $g {
          isActive(t) {
            return Yg.test(t);
          }
            ...
            !(function (t, e) {
              ...
              (function (t, e) {
                for (const n of e.createRangeIn(t)) {
                  ...
                  if (t.is('li')) {
                    const n = t.nextSibling;
                    n && Wg(n) && (e.remove(n), e.insertChild(t.childCount, n, t));
                  }
                  if (Wg(t)) {
                    let n = t.getChild(0);
                    for (; Wg(n); ) e.unwrapElement(n), (n = t.getChild(0));
                  }
                }
              })(t.content, e),
              (function (t, e) {
          ...
          i.length &&
            (function (t, e, n) {
              if (t.length === e.length)
                for (let i = 0; i < t.length; i++) {
                  const o = `data:${e[i].type};base64,${Jg(e[i].hex)}`;
                ...
                if (i)
                  for (const t of i) {
                    ...
                    t.includes('\\pngblip') ? (n = 'image/png') : t.includes('\\jpegblip') && (n = 'image/jpeg'),
                      n && o.push({ hex: t.replace(e, '').replace(/[^\da-fA-F]/g, ''), type: n });
                  }
                return o;
              })(e),
              n,
        ...
        const Zg = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
          Xg = /xmlns:o="urn:schemas-microsoft-com/i;
        class tp {
          isActive(t) {
            return Zg.test(t) || Xg.test(t);
          }
          execute(t) {
            const { body: e, stylesString: n } = Qg(t.dataTransfer.getData('text/html'));
            Hg(e, n), Kg(e, t.dataTransfer.getData('text/rtf')), (t.content = e);
          }
        }
        function ep(t, e) {
          let n = e.parent;
              ...
              if (l) {
                if ((n.writer.insert(c, l.position), n.consumable.consume(i, { name: !0 }), o.length))
                  ...
                  n.writer.insert(t, n.writer.createPositionAt(c, 'end')),
                    ip(n.writer, n.writer.createPositionAt(t, 'end'));
                }
                (e.modelRange = n.writer.createRange(
                  n.writer.createPositionBefore(c),
                  n.writer.createPositionAfter(c),
                )),
                  l.cursorParent
        ...
        function rp(t) {
          return (e) => {
            e.on(`element:${t}`, (t, e, n) => {
              ...
              n.convertChildren(i, s),
                o.childCount || n.writer.insertElement('paragraph', s),
                (e.modelRange = n.writer.createRange(
                  n.writer.createPositionBefore(o),
                  n.writer.createPositionAfter(o),
                )),
                (e.modelCursor = e.modelRange.end);
            });
          };
        ...
        class ap {
          ...
          next() {
            ...
            if (this._isSpanned(this._row, this._column))
              ...
              (o > 1 || r > 1) && this._recordSpans(this._row, this._column, r, o, e),
                (this._nextCellAtColumn = this._column + o),
                (n = this._shouldSkipRow() || this._shouldSkipColumn()),
                (i = this._formatOutValue(e, this._column, !1, r, o));
            }
        ...
        function cp(t) {
          return !!t.getCustomProperty('table') && Zh(t);
        }
        function lp(t) {
          const e = t.getSelectedElement();
          return e && cp(e) ? e : null;
        }
        function dp(t) {
          const e = ep('table', t.getFirstPosition());
          return e && cp(e.parent) ? e.parent : null;
        }
        function hp(t = {}) {
          return (e) =>
            e.on('insert:table', (e, n, i) => {
              ...
              i.writer.insert(i.writer.createPositionAt(s, 0), a),
                r &&
                  (c = (function (t, e) {
                    return e.setCustomProperty('table', !0, t), Xh(t, e, { hasSelectionHandler: !0 });
                  })(s, i.writer));
              const l = new ap(o),
                d = {
              ...
              for (const e of l) {
                const { row: n, cell: r } = e,
                  s = yp(vp(n, d), a, i),
                  c = o.getChild(n),
                  l = h.get(n) || kp(c, n, s, i);
                h.set(n, l), i.consumable.consume(r, 'insert'), wp(e, d, i.writer.createPositionAt(l, 'end'), i, t);
              }
              const u = i.mapper.toViewPosition(n.range.start);
              i.mapper.bindElements(o, r ? c : s), i.writer.insert(u, r ? c : s);
            });
        }
        function up(t = {}) {
          return (e) =>
            e.on('insert:tableRow', (e, n, i) => {
              const o = n.item;
              if (!i.consumable.consume(o, 'insert')) return;
              const r = o.parent,
                s = Cp(i.mapper.toViewElement(r)),
                a = r.getChildIndex(o),
                c = new ap(r, { startRow: a, endRow: a }),
                l = {
                ...
                d = new Map();
              for (const e of c) {
                const n = yp(vp(a, l), s, i),
                  r = d.get(a) || kp(o, a, n, i);
                d.set(a, r),
                  i.consumable.consume(e.cell, 'insert'),
                  wp(e, l, i.writer.createPositionAt(r, 'end'), i, t);
              }
            });
        }
        function fp(t = {}) {
          return (e) =>
            e.on('insert:tableCell', (e, n, i) => {
              const o = n.item;
              if (!i.consumable.consume(o, 'insert')) return;
              const r = o.parent,
                s = r.parent,
                a = s.getChildIndex(r),
                c = new ap(s, { startRow: a, endRow: a }),
                l = {
              ...
              for (const e of c)
                if (e.cell === o) {
                  ...
                  return void wp(e, l, i.writer.createPositionAt(n, r.getChildIndex(o)), i, t);
                }
            });
        }
        function mp(t = {}) {
          const e = !!t.asWidget;
          return (t) =>
            t.on('attribute:headingRows:table', (t, n, i) => {
              const o = n.item;
              if (!i.consumable.consume(n.item, t.name)) return;
              const r = Cp(i.mapper.toViewElement(o)),
                s = n.attributeOldValue,
                a = n.attributeNewValue;
              if (a > s) {
                const t = Array.from(o.getChildren()).filter(({ index: t }) => c(t, s - 1, a));
                Tp(t, yp('thead', r, i), i, 'end');
                for (const n of t) for (const t of n.getChildren()) pp(t, 'th', i, e);
                Ap('tbody', r, i);
              } else {
                Tp(
                  Array.from(o.getChildren())
                    .filter(({ index: t }) => c(t, a - 1, s))
                    .reverse(),
                  yp('tbody', r, i),
                  i,
                  0,
                );
                const t = new ap(o, { startRow: a ? a - 1 : a, endRow: s - 1 }),
                  n = {
                    headingRows: o.getAttribute('headingRows') || 0,
                    headingColumns: o.getAttribute('headingColumns') || 0,
                  };
                for (const o of t) bp(o, n, i, e);
                Ap('thead', r, i);
              }
              function c(t, e, n) {
                return t > e && t < n;
        ...
        function gp(t = {}) {
          const e = !!t.asWidget;
          return (t) =>
            t.on('attribute:headingColumns:table', (t, n, i) => {
              const o = n.item;
              if (!i.consumable.consume(n.item, t.name)) return;
              const r = {
                  headingRows: o.getAttribute('headingRows') || 0,
                ...
                a = n.attributeNewValue,
                c = (s > a ? s : a) - 1;
              for (const t of new ap(o)) t.column > c || bp(t, r, i, e);
            });
        }
        function pp(t, e, n, i) {
          const o = n.writer,
          ...
          let s;
          if (i) {
            (s = eu(o.createEditableElement(e, r.getAttributes()), o)),
        ...
        function wp(t, e, n, i, o) {
          const r = o && o.asWidget,
            s = _p(t, e),
            a = r ? eu(i.writer.createEditableElement(s), i.writer) : i.writer.createContainerElement(s),
            c = t.cell,
            l = c.getChild(0),
        ...
        function _p(t, e) {
          const { row: n, column: i } = t,
            { headingColumns: o, headingRows: r } = e;
        ...
        class Sp extends ed {
          ...
          refresh() {
            const t = ep('table', this.editor.model.document.selection.getFirstPosition());
            this.isEnabled = !!t;
          }
          execute() {
            const t = this.editor,
              ...
              i = ep('tableCell', e.getFirstPosition()).parent,
              o = i.parent,
              r = o.getChildIndex(i),
        ...
        class Mp extends ed {
          ...
          execute() {
            const t = this.editor,
              e = t.model.document.selection,
              n = t.plugins.get('TableUtils'),
              i = ep('tableCell', e.getFirstPosition()),
              o = i.parent.parent,
              { column: r } = n.getCellLocation(i),
        ...
        class Ep extends ed {
          ...
          refresh() {
            const t = ep('tableCell', this.editor.model.document.selection.getFirstPosition());
            this.isEnabled = !!t;
          }
          execute() {
            const t = ep('tableCell', this.editor.model.document.selection.getFirstPosition()),
        ...
        class Ip extends ed {
          ...
          execute() {
            const t = this.editor.model,
              e = ep('tableCell', t.document.selection.getFirstPosition()),
              n = this.value,
              i = this.direction;
            t.change((t) => {
              ...
              !(function (t, e, n) {
                Np(t) ||
                  (Np(e) && n.remove(n.createRangeIn(e)), n.move(n.createRangeIn(t), n.createPositionAt(e, 'end')));
                n.remove(t);
              })(s, r, t);
              ...
              t.setAttribute(c, l + d, r),
                ...
                a.childCount ||
                  (function (t, e) {
                    const n = t.parent,
                      i = n.getChildIndex(t);
                    for (const { cell: t, row: o, rowspan: r } of new ap(n, { endRow: i })) {
                      const n = o + r - 1 >= i;
                      n && np('rowspan', r - 1, t, e);
                    }
                    e.remove(t);
                  })(a, t);
            });
            ...
            const e = this.editor.plugins.get('TableUtils'),
              n = this.isHorizontal
                ? (function (t, e, n) {
                    ...
                    const o = 'right' == e ? t : i,
                      r = 'right' == e ? i : t,
                      { column: s } = n.getCellLocation(o),
                      { column: a } = n.getCellLocation(r),
                ...
                : (function (t, e) {
                    ...
                    const a = parseInt(t.getAttribute('rowspan') || 1),
                      ...
                      h = l.find(
                        ({ row: t, rowspan: n, column: i }) => i === d && ('down' == e ? t === c : c === t + n),
                      );
                    return h && h.cell;
                  })(t, this.direction);
            if (!n) return;
        ...
        class Op extends ed {
          ...
          execute() {
            const t = this.editor.model,
              e = ep('tableCell', t.document.selection.getFirstPosition()).parent,
              n = e.parent,
              i = n.getChildIndex(e),
              o = n.getAttribute('headingRows') || 0;
            t.change((t) => {
              o && i <= o && np('headingRows', o - 1, n, t, 0);
              const r = [...new ap(n, { endRow: i })],
                s = new Map();
              r
                .filter(({ row: t, rowspan: e }) => t === i && e > 1)
                .forEach(({ column: t, cell: e, rowspan: n }) => s.set(t, { cell: e, rowspanToSet: n - 1 })),
                r
                  .filter(({ row: t, rowspan: e }) => t <= i - 1 && t + e > i)
                  .forEach(({ cell: e, rowspan: n }) => np('rowspan', n - 1, e, t));
              const a = i + 1,
                c = new ap(n, { includeSpanned: !0, startRow: a, endRow: a });
              let l;
              for (const { row: e, column: i, cell: o } of [...c])
                if (s.has(i)) {
                  ...
                  t.move(t.createRangeOn(o), a), np('rowspan', r, o, t), (l = o);
                } else l = o;
              t.remove(e);
            });
          }
        ...
        class Rp extends ed {
          ...
          execute() {
            ...
            t.change((t) => {
              ...
              for (const { cell: e, column: n, colspan: i } of s)
                n <= a && i > 1 && n + i > a ? np('colspan', i - 1, e, t) : n === a && t.remove(e);
            });
          }
        }
        class Dp extends ed {
          ...
          execute(t = {}) {
            const e = this.editor.model,
              n = ep('tableCell', e.document.selection.getFirstPosition()).parent,
              i = n.parent,
            ...
            e.change((t) => {
              if (s) {
                const e = (function (t, e, n) {
                  const i = [],
                    o = new ap(t, { startRow: e > n ? n : 0, endRow: e - 1 });
                  for (const { row: t, rowspan: n, cell: r } of o) n > 1 && t + n > e && i.push(r);
                  return i;
                })(i, s, o);
                for (const n of e) Lp(n, s, t);
              }
              np('headingRows', s, i, t, 0);
            });
          }
          _isInHeading(t, e) {
        ...
        function Lp(t, e, n) {
          ...
          c > 1 && (s.colspan = c);
          const l = o.getChildIndex(i),
            d = l + r,
            h = [...new ap(o, { startRow: l, endRow: d, includeSpanned: !0 })];
          let u;
          for (const { row: e, column: i, cell: r, cellIndex: a } of h)
            if ((r === t && void 0 === u && (u = i), void 0 !== u && u === i && e === d)) {
              const t = o.getChild(e);
              ip(n, n.createPositionAt(t, a), s);
            }
          np('rowspan', r, t, n);
        }
        class jp extends ed {
          ...
          execute(t = {}) {
            const e = this.editor.model,
              n = e.document.selection,
              i = this.editor.plugins.get('TableUtils'),
              o = ep('tableCell', n.getFirstPosition()),
              r = o.parent.parent,
              { column: s } = i.getCellLocation(o);
            if (t.forceValue === this.value) return;
            const a = this.value ? s : s + 1;
            e.change((t) => {
              np('headingColumns', a, r, t, 0);
            });
          }
          _isInHeading(t, e) {
            const n = parseInt(e.getAttribute('headingColumns') || 0),
              i = this.editor.plugins.get('TableUtils'),
              { column: o } = i.getCellLocation(t);
            return !!n && o < n;
          }
        }
        class Vp extends Kl {
          ...
          insertRows(t, e = {}) {
            ...
            n.change((e) => {
              ...
              if ((n > i && e.setAttribute('headingRows', n + o, t), 0 === i || i === t.childCount))
                return void zp(e, t, i, o, this.getColumns(t));
              const r = new ap(t, { endRow: i });
              let s = 0;
          ...
          insertColumns(t, e = {}) {
            ...
            n.change((e) => {
              ...
              if (0 === i || r === i) {
                for (const n of t.getChildren()) Bp(o, e, e.createPositionAt(n, i ? 'end' : 0));
                return;
              }
              const s = new ap(t, { column: i, includeSpanned: !0 });
              for (const { row: n, cell: r, cellIndex: a } of s) {
                const c = parseInt(r.getAttribute('rowspan') || 1),
                  l = parseInt(r.getAttribute('colspan') || 1);
                if (r.index !== i && l > 1) {
                  if ((e.setAttribute('colspan', l + o, r), s.skipRow(n), c > 1))
                    for (let t = n + 1; t < n + c; t++) s.skipRow(t);
                } else {
          ...
          splitCellVertically(t, e = 2) {
            ...
            n.change((n) => {
              if (r > 1) {
                const { newCellsSpan: i, updatedSpan: s } = Fp(r, e);
                np('colspan', s, t, n);
                const a = {};
                i > 1 && (a.colspan = i),
                  o > 1 && (a.rowspan = o),
                  Bp(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a);
              }
              if (r < e) {
                const s = e - r,
                  a = [...new ap(i)],
                ...
                const d = {};
                o > 1 && (d.rowspan = o), Bp(s, n, n.createPositionAfter(t), d);
                const h = i.getAttribute('headingColumns') || 0;
                h > c && np('headingColumns', h + s, i, n);
              }
            });
          }
          splitCellHorizontally(t, e = 2) {
            ...
            n.change((n) => {
              if (s > 1) {
                const i = [...new ap(o, { startRow: r, endRow: r + s - 1, includeSpanned: !0 })],
                  { newCellsSpan: c, updatedSpan: l } = Fp(s, e);
                np('rowspan', l, t, n);
                ...
                for (const { column: t, row: e, cellIndex: s } of i) {
                  if (e >= r + l && t === d && (e + r + l) % c == 0) {
                    Bp(1, n, n.createPositionAt(o.getChild(e), s), h);
                  }
                }
              }
              if (s < e) {
                const i = e - s,
                  c = [...new ap(o, { startRow: 0, endRow: r })];
                ...
                const l = {};
                a > 1 && (l.colspan = a), zp(n, o, r + 1, i, 1, l);
                const d = o.getAttribute('headingRows') || 0;
                d > r && np('headingRows', d + i, o, n);
              }
            });
          }
          getColumns(t) {
        ...
        function zp(t, e, n, i, o, r = {}) {
          for (let s = 0; s < i; s++) {
            const i = t.createElement('tableRow');
            t.insert(i, e, n), Bp(o, t, t.createPositionAt(i, 'end'), r);
          }
        }
        function Bp(t, e, n, i = {}) {
          for (let o = 0; o < t; o++) ip(e, n, i);
        }
        function Fp(t, e) {
        ...
        function Up(t) {
          t.document.registerPostFixer((e) =>
            (function (t, e) {
              ...
              for (const e of n) {
                let n;
                'table' == e.name && 'insert' == e.type && (n = e.position.nodeAfter),
                  ('tableRow' != e.name && 'tableCell' != e.name) || (n = ep('table', e.position)),
                  Wp(e) && (n = ep('table', e.range.start)),
                  n && !o.has(n) && ((i = Hp(n, t) || i), (i = qp(n, t) || i), o.add(n));
              }
              return i;
            })(e, t),
          );
        ...
        function Hp(t, e) {
          ...
          const i = (function (t) {
            const e = parseInt(t.getAttribute('headingRows') || 0),
              n = t.childCount,
              i = [];
            for (const { row: o, rowspan: r, cell: s } of new ap(t)) {
              if (r < 2) continue;
              const t = o < e,
                a = t ? e : n;
              if (o + r > a) {
          ...
          if (i.length) {
            n = !0;
            for (const t of i) np('rowspan', t.rowspan, t.cell, e, 1);
          }
          return n;
        }
        function qp(t, e) {
          ...
          const i = (function (t) {
              const e = {};
              for (const { row: n } of new ap(t, { includeSpanned: !0 })) e[n] || (e[n] = 0), (e[n] += 1);
              return e;
            })(t),
            o = i[0];
          if (!Object.values(i).every((t) => t === o)) {
            ...
            for (const [r, s] of Object.entries(i)) {
              const i = o - s;
              if (i) {
                for (let n = 0; n < i; n++) ip(e, e.createPositionAt(t.getChild(r), 'end'));
                n = !0;
              }
            }
          }
        ...
        function Yp(t) {
          t.document.registerPostFixer((e) =>
            (function (t, e) {
              ...
              let i = !1;
              for (const e of n)
                'insert' == e.type && 'table' == e.name && (i = $p(e.position.nodeAfter, t) || i),
                  'insert' == e.type && 'tableRow' == e.name && (i = Gp(e.position.nodeAfter, t) || i),
                  'insert' == e.type && 'tableCell' == e.name && (i = Qp(e.position.nodeAfter, t) || i),
                  Kp(e) && (i = Qp(e.position.parent, t) || i);
              return i;
            })(e, t),
          );
        }
        function $p(t, e) {
          let n = !1;
          for (const i of t.getChildren()) n = Gp(i, e) || n;
          return n;
        }
        function Gp(t, e) {
          let n = !1;
          for (const i of t.getChildren()) n = Qp(i, e) || n;
          return n;
        }
        function Qp(t, e) {
          ...
          t.document.registerPostFixer(() =>
            (function (t) {
              ...
              for (const t of e.getChanges()) {
                ...
                e.is('tableCell') && Zp(e, t.type) && n.add(e);
              }
              if (n.size) {
        ...
        class Xp extends Kl {
          init() {
            ...
            n.register('table', {
              ...
              n.register('tableCell', { allowIn: 'tableRow', allowAttributes: ['colspan', 'rowspan'], isLimit: !0 }),
              n.extend('$block', { allowIn: 'tableCell' }),
              n.addChildCheck((t, e) => {
                if ('table' == e.name && Array.from(t.getNames()).includes('table')) return !1;
              }),
              i.for('upcast').add(op()),
              i.for('editingDowncast').add(hp({ asWidget: !0 })),
              i.for('dataDowncast').add(hp()),
              i.for('upcast').elementToElement({ model: 'tableRow', view: 'tr' }),
              i.for('editingDowncast').add(up({ asWidget: !0 })),
              i.for('dataDowncast').add(up()),
              ...
              i.for('upcast').add(rp('td')),
              i.for('upcast').add(rp('th')),
              i.for('editingDowncast').add(fp({ asWidget: !0 })),
              i.for('dataDowncast').add(fp()),
              i.attributeToAttribute({ model: 'colspan', view: 'colspan' }),
              i.attributeToAttribute({ model: 'rowspan', view: 'rowspan' }),
              i.for('editingDowncast').add(gp({ asWidget: !0 })),
              i.for('dataDowncast').add(gp()),
              i.for('editingDowncast').add(mp({ asWidget: !0 })),
              i.for('dataDowncast').add(mp()),
              t.commands.add('insertTable', new Pp(t)),
              t.commands.add('insertTableRowAbove', new Sp(t, { order: 'above' })),
              t.commands.add('insertTableRowBelow', new Sp(t, { order: 'below' })),
              t.commands.add('insertTableColumnLeft', new Mp(t, { order: 'left' })),
              t.commands.add('insertTableColumnRight', new Mp(t, { order: 'right' })),
              t.commands.add('removeTableRow', new Op(t)),
              t.commands.add('removeTableColumn', new Rp(t)),
              t.commands.add('splitTableCellVertically', new Ep(t, { direction: 'vertically' })),
              t.commands.add('splitTableCellHorizontally', new Ep(t, { direction: 'horizontally' })),
              t.commands.add('mergeTableCellRight', new Ip(t, { direction: 'right' })),
              t.commands.add('mergeTableCellLeft', new Ip(t, { direction: 'left' })),
              t.commands.add('mergeTableCellDown', new Ip(t, { direction: 'down' })),
              t.commands.add('mergeTableCellUp', new Ip(t, { direction: 'up' })),
              t.commands.add('setTableColumnHeader', new jp(t)),
              t.commands.add('setTableRowHeader', new Dp(t)),
              Up(e),
              Jp(e),
              Yp(e),
          ...
          _getTabHandler(t) {
            const e = this.editor;
            return (n, i) => {
              const o = ep('tableCell', e.model.document.selection.getFirstPosition());
              if (!o) return;
              i();
              const r = o.parent,
                s = r.parent,
          ...
          constructor(t) {
            ...
            (this.items = this.createCollection()),
              ...
              this.setTemplate({
                ...
                attributes: { class: ['ck'] },
                children: [
                  { tag: 'div', attributes: { class: ['ck-insert-table-dropdown__grid'] }, children: this.items },
                  {
                    tag: 'div',
          ...
          init() {
            ...
            t.ui.componentFactory.add('insertTable', (n) => {
              const i = t.commands.get('insertTable'),
                o = Sf(n);
              o.bind('isEnabled').to(i), o.buttonView.set({ icon: nb, label: e('s'), tooltip: !0 });
              const r = new tb(n);
              return (
              ...
              t.ui.componentFactory.add('tableColumn', (t) => {
                const n = [
                  { type: 'switchbutton', model: { commandName: 'setTableColumnHeader', label: e('t'), bindIsOn: !0 } },
                  { type: 'separator' },
                  { type: 'button', model: { commandName: 'insertTableColumnLeft', label: e('u') } },
                  { type: 'button', model: { commandName: 'insertTableColumnRight', label: e('v') } },
                  { type: 'button', model: { commandName: 'removeTableColumn', label: e('w') } },
                ];
                return this._prepareDropdown(e('x'), ib, n, t);
              }),
              t.ui.componentFactory.add('tableRow', (t) => {
                const n = [
                  { type: 'switchbutton', model: { commandName: 'setTableRowHeader', label: e('y'), bindIsOn: !0 } },
                  { type: 'separator' },
                  { type: 'button', model: { commandName: 'insertTableRowBelow', label: e('z') } },
                  { type: 'button', model: { commandName: 'insertTableRowAbove', label: e('aa') } },
                  { type: 'button', model: { commandName: 'removeTableRow', label: e('ab') } },
                ];
                return this._prepareDropdown(e('ac'), ob, n, t);
              }),
              t.ui.componentFactory.add('mergeTableCells', (t) => {
                const n = [
                  { type: 'button', model: { commandName: 'mergeTableCellUp', label: e('ad') } },
                  { type: 'button', model: { commandName: 'mergeTableCellRight', label: e('ae') } },
                  { type: 'button', model: { commandName: 'mergeTableCellDown', label: e('af') } },
                  { type: 'button', model: { commandName: 'mergeTableCellLeft', label: e('ag') } },
                  { type: 'separator' },
                  { type: 'button', model: { commandName: 'splitTableCellVertically', label: e('ah') } },
                  { type: 'button', model: { commandName: 'splitTableCellHorizontally', label: e('ai') } },
                ];
                return this._prepareDropdown(e('aj'), rb, n, t);
              });
          }
        ...
        function ab(t, e, n, i) {
          const o = (t.model = new kf(t.model)),
        ...
        (cb.builtinPlugins = [
          ...
          class extends Kl {
            ...
            _addListAutoformats() {
              const t = this.editor.commands;
              t.get('bulletedList') && new sh(this.editor, /^[*-]\s$/, 'bulletedList'),
                t.get('numberedList') && new sh(this.editor, /^1[.|)]\s$/, 'numberedList');
            }
            _addBasicStylesAutoformats() {
              const t = this.editor.commands;
              if (t.get('bold')) {
                const t = lh(this.editor, 'bold');
                new ah(this.editor, /(\*\*)([^*]+)(\*\*)$/g, t), new ah(this.editor, /(__)([^_]+)(__)$/g, t);
              }
              if (t.get('italic')) {
                const t = lh(this.editor, 'italic');
                new ah(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t),
                  new ah(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t);
              }
              if (t.get('code')) {
                const t = lh(this.editor, 'code');
                new ah(this.editor, /(`)([^`]+)(`)$/g, t);
              }
            }
          ...
          class extends Kl {
            ...
            afterInit() {
              ...
              i && n.register('tableContent', { ariaLabel: e('c'), items: i, getRelatedElement: dp }),
                o && n.register('table', { ariaLabel: e('c'), items: o, getRelatedElement: lp });
            }
          },
        ]),
          (cb.defaultConfig = {
