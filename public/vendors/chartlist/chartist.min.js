...
!(function (a, b) {
  ...
  return (
      ...
      (b.namespaces = {
        ...
        (b.extend = function (a) {
          ...
          for (a = a || {}, c = 1; c < arguments.length; c++) {
            ...
            for (var f in d)
              (e = d[f]),
                'object' != typeof e || null === e || e instanceof Array ? (a[f] = e) : (a[f] = b.extend(a[f], e));
          }
          return a;
        }),
        ...
        (b.serialMap = function (a, c) {
          ...
          return (
            b.times(e).forEach(function (b, e) {
        ...
        (b.createSvg = function (a, c, d, e) {
          ...
          return (
            ...
            (f = new b.Svg('svg').attr({ width: c, height: d }).addClass(e)),
            (f._node.style.width = c),
        ...
        (b.normalizeData = function (a, c, d) {
          var e,
            f = { raw: a, normalized: {} };
          return (
            (f.normalized.series = b.getDataArray({ series: a.series || [] }, c, d)),
            ...
            Array.prototype.push.apply(
              f.normalized.labels,
              b.times(Math.max(0, e - f.normalized.labels.length)).map(function () {
                return '';
              }),
            ),
            c && b.reverseData(f.normalized),
            f
          );
        }),
          ...
          function e(a) {
            ...
            if (!b.isDataHoleValue(a)) {
              if (d) {
                var c = {};
                return (
                  'string' == typeof d ? (c[d] = b.getNumberOrUndefined(a)) : (c.y = b.getNumberOrUndefined(a)),
                  (c.x = a.hasOwnProperty('x') ? b.getNumberOrUndefined(a.x) : c.x),
                  (c.y = a.hasOwnProperty('y') ? b.getNumberOrUndefined(a.y) : c.y),
                  c
                );
              }
        ...
        (b.getAvailableHeight = function (a, c) {
          return Math.max(
            (b.quantity(c.height).value || a.height()) - (c.chartPadding.top + c.chartPadding.bottom) - c.axisX.offset,
            0,
          );
        }),
        (b.getHighLow = function (a, c, d) {
          ...
          return (
            (g || h) && e(a),
            (c.referenceValue || 0 === c.referenceValue) &&
              ((f.high = Math.max(c.referenceValue, f.high)), (f.low = Math.min(c.referenceValue, f.low))),
            f.high <= f.low &&
              (0 === f.low
                ? (f.high = 1)
                : f.low < 0
        ...
        (b.getBounds = function (a, c, d, e) {
          ...
          var g,
            ...
            i,
            j = 0,
            k = { high: c.high, low: c.low };
          (k.valueRange = k.high - k.low),
            (k.oom = b.orderOfMagnitude(k.valueRange)),
    ...
    (function (a, b) {
      'use strict';
      (b.Interpolation = {}),
        (b.Interpolation.none = function (a) {
          var c = { fillHoles: !1 };
          return (
            (a = b.extend({}, c, a)),
            function (c, d) {
              for (var e = new b.Svg.Path(), f = !0, g = 0; g < c.length; g += 2) {
                var h = c[g],
                  i = c[g + 1],
                  j = d[g / 2];
                void 0 !== b.getMultiValue(j.value)
        ...
        (b.Interpolation.cardinal = function (a) {
          ...
          return function f(c, g) {
            ...
            if (h.length) {
              ...
              if (((c = h[0].pathCoordinates), (g = h[0].valueData), c.length <= 4))
                return b.Interpolation.none()(c, g);
              for (
                var j, k = new b.Svg.Path().move(c[0], c[1], !1, g[0]), l = 0, m = c.length;
                m - 2 * !j > l;
                l += 2
              ) {
                var n = [
                ...
                j
                  ? l
                    ? m - 4 === l
                      ? (n[3] = { x: +c[0], y: +c[1] })
                      : m - 2 === l && ((n[2] = { x: +c[0], y: +c[1] }), (n[3] = { x: +c[2], y: +c[3] }))
                    : (n[0] = { x: +c[m - 2], y: +c[m - 1] })
                  : m - 4 === l
                    ? (n[3] = n[2])
                    : l || (n[0] = { x: +c[l], y: +c[l + 1] }),
          ...
          return (
            ...
            function d(c, e) {
              ...
              if (f.length) {
                ...
                if (((c = f[0].pathCoordinates), (e = f[0].valueData), c.length <= 4))
                  return b.Interpolation.none()(c, e);
                var h,
                  i,
                  j = [],
                  k = [],
                ...
                for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++)
                  0 === n[h] || 0 === n[h - 1] || n[h - 1] > 0 != n[h] > 0
                    ? (m[h] = 0)
                    : ((m[h] =
                        (3 * (p[h - 1] + p[h])) / ((2 * p[h] + p[h - 1]) / n[h - 1] + (p[h] + 2 * p[h - 1]) / n[h])),
                      isFinite(m[h]) || (m[h] = 0));
                for (i = new b.Svg.Path().move(j[0], k[0], !1, e[0]), h = 0; h < l - 1; h++)
                  i.curve(
                    j[h] + p[h] / 3,
                    k[h] + (m[h] * p[h]) / 3,
                    j[h + 1] - p[h] / 3,
            ...
            function (c, d) {
              for (var e, f, g, h = new b.Svg.Path(), i = 0; i < c.length; i += 2) {
                ...
                void 0 !== l.value
                  ? (void 0 === g
                      ? h.move(j, k, !1, l)
                      : (a.postpone ? h.line(j, f, !1, g) : h.line(e, k, !1, l), h.line(j, k, !1, l)),
                    (e = j),
                    (f = k),
                    (g = l))
    ...
    (function (a, b) {
      ...
      function c(a, c, d) {
        return (
          ...
          c &&
            ((this.options = b.extend({}, d ? this.options : this.defaultOptions, c)),
            this.initializeTimeoutId ||
              (this.optionsProvider.removeMediaQueryListeners(),
              (this.optionsProvider = b.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)))),
      ...
      function d() {
        return (
          this.initializeTimeoutId
            ? i.clearTimeout(this.initializeTimeoutId)
            : (i.removeEventListener('resize', this.resizeListener), this.optionsProvider.removeMediaQueryListeners()),
          this
        );
      }
      function e(a, b) {
      ...
      function h(a, c, d, e, f) {
        (this.container = b.querySelector(a)),
          (this.data = c || {}),
          (this.data.labels = this.data.labels || []),
          (this.data.series = this.data.series || []),
          ...
          (this.eventEmitter = b.EventEmitter()),
          (this.supportsForeignObject = b.Svg.isSupported('Extensibility')),
          (this.supportsAnimations = b.Svg.isSupported('AnimationEventsAttribute')),
          (this.resizeListener = function () {
            this.update();
          }.bind(this)),
          this.container &&
            (this.container.__chartist__ && this.container.__chartist__.detach(), (this.container.__chartist__ = this)),
          (this.initializeTimeoutId = setTimeout(g.bind(this), 0));
      }
      var i = a.window;
    ...
    (function (a, b) {
      ...
      function c(a, c, d, e, f) {
        a instanceof Element
          ? (this._node = a)
          : ((this._node = y.createElementNS(b.namespaces.svg, a)),
            'svg' === a && this.attr({ 'xmlns:ct': b.namespaces.ct })),
          c && this.attr(c),
          d && this.addClass(d),
          e &&
            (f && e._node.firstChild
              ? e._node.insertBefore(this._node, e._node.firstChild)
              : e._node.appendChild(this._node));
      }
      function d(a, c) {
        return 'string' == typeof a
          ? c
            ? this._node.getAttributeNS(c, a)
            ...
            function (e) {
              function f(a, c) {
                var f,
                  ...
                  h,
                  i = {};
                a.easing && ((h = a.easing instanceof Array ? a.easing : b.Svg.Easing[a.easing]), delete a.easing),
                  (a.begin = b.ensureUnit(a.begin, 'ms')),
                  (a.dur = b.ensureUnit(a.dur, 'ms')),
                  h && ((a.calcMode = 'spline'), (a.keySplines = h.join(' ')), (a.keyTimes = '0;1')),
                  c &&
                    ((a.fill = 'freeze'),
                    (i[e] = a.from),
                    this.attr(i),
                    (g = b.quantity(a.begin || 0).value),
                    (a.begin = 'indefinite')),
                  (f = this.elem('animate', b.extend({ attributeName: e }, a))),
                  c &&
                    setTimeout(
                      function () {
                        try {
        ...
        Object.keys(b.Svg.prototype)
          ...
          .forEach(function (a) {
            c[a] = function () {
              ...
              return (
                c.svgElements.forEach(function (c) {
    ...
    (function (a, b) {
      ...
      function k(a, b, d, e, f, g, h, i, j) {
        return (
          c('A', { rx: +a, ry: +b, xAr: +d, lAf: +e, sf: +f, x: +g, y: +h }, this.pathElements, this.pos++, i, j), this
        );
      }
      function l(a) {
        var c = a
      ...
      function m() {
        ...
        return (
          this.pathElements.reduce(
            function (b, c) {
              var d = t[c.command.toLowerCase()].map(
                function (b) {
      ...
      function n(a, b) {
        return (
          d(this.pathElements, function (c, d) {
            c[d] *= 'x' === d[0] ? a : b;
          }),
          this
        );
      ...
      function p(a) {
        return (
          d(this.pathElements, function (b, c, d, e, f) {
            var g = a(b, c, d, e, f);
            (g || 0 === g) && (b[c] = g);
          }),
          this
      ...
      function q(a) {
        ...
        return (
          (c.pos = this.pos),
          (c.pathElements = this.pathElements.slice().map(function (a) {
            return b.extend({}, a);
          })),
          (c.options = b.extend({}, this.options)),
          c
        );
      }
      function r(a) {
        ...
        return (
          this.pathElements.forEach(function (d) {
            d.command === a.toUpperCase() && 0 !== c[c.length - 1].pathElements.length && c.push(new b.Svg.Path()),
              c[c.length - 1].pathElements.push(d);
          }),
          c
        );
      }
      ...
      (b.Svg.Path = b.Class.extend({
        ...
        (b.Svg.Path.elementDescriptions = t),
        (b.Svg.Path.join = s);
    })(this || global, a),
    (function (a, b) {
      'use strict';
      function c(a, b, c, d) {
        (this.units = a),
          (this.counterUnits = a === e.x ? e.y : e.x),
          (this.chartRect = b),
    ...
    (function (a, b) {
      ...
      function c(a, c, d, e) {
        ...
        (this.bounds = b.getBounds(d[a.rectEnd] - d[a.rectStart], f, e.scaleMinSpace || 20, e.onlyInteger)),
    ...
    (function (a, b) {
      ...
      function c(a, c, d, e) {
        ...
        (this.divisor = e.divisor || 1),
          ...
          b.FixedScaleAxis['super'].constructor.call(this, a, d, this.ticks, e),
          (this.stepLength = this.axisLength / this.divisor);
      }
      function d(a) {
        return (
          (this.axisLength * (+b.getMultiValue(a, this.units.pos) - this.range.min)) / (this.range.max - this.range.min)
        );
      }
      a.window, a.document;
        ...
        (d =
          void 0 === a.axisX.type
            ? new b.StepAxis(
                ...
                c.normalized.series,
                j,
                b.extend({}, a.axisX, { ticks: c.normalized.labels, stretch: a.fullWidth }),
              )
            : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, j, a.axisX)),
          (f =
            void 0 === a.axisY.type
              ? new b.AutoScaleAxis(
                  b.Axis.units.y,
              ...
              : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, j, a.axisY)),
          d.createGridAndLabels(g, i, this.supportsForeignObject, a, this.eventEmitter),
          f.createGridAndLabels(g, i, this.supportsForeignObject, a, this.eventEmitter),
          a.showGridBackground && b.createGridBackground(g, j, a.classNames.gridBackground, this.eventEmitter),
          c.raw.series.forEach(
            function (e, g) {
              var i = h.elem('g');
              i.attr({ 'ct:series-name': e.name, 'ct:meta': b.serialize(e.meta) }),
                i.addClass(
                  [a.classNames.series, e.className || a.classNames.series + '-' + b.alphaNumerate(g)].join(' '),
                );
              var k = [],
                l = [];
              c.normalized.series[g].forEach(
                function (a, h) {
                  var i = {
              ...
              var m = {
                ...
                n =
                  'function' == typeof m.lineSmooth
                    ? m.lineSmooth
                    : m.lineSmooth
                      ? b.Interpolation.monotoneCubic()
                      : b.Interpolation.none(),
                o = n(k, l);
              if (
                (m.showPoint &&
                  o.pathElements.forEach(
                    function (c) {
                      var h = i.elem('line', { x1: c.x, y1: c.y, x2: c.x + 0.01, y2: c.y }, a.classNames.point).attr({
    ...
    (function (a, b) {
      ...
      function c(a) {
        var c, d;
        a.distributeSeries
          ? ((c = b.normalizeData(this.data, a.reverseData, a.horizontalBars ? 'x' : 'y')),
            (c.normalized.series = c.normalized.series.map(function (a) {
              return [a];
            })))
          : (c = b.normalizeData(this.data, a.reverseData, a.horizontalBars ? 'x' : 'y')),
          (this.svg = b.createSvg(
            this.container,
            a.width,
            a.height,
        ...
        var j,
          ...
          m,
          n,
          o = b.createChartRect(this.svg, a, e.padding);
        (k = a.distributeSeries && a.stackBars ? c.normalized.labels.slice(0, 1) : c.normalized.labels),
          a.horizontalBars
            ? ((j = m =
                void 0 === a.axisX.type
                  ? new b.AutoScaleAxis(
                      ...
                      c.normalized.series,
                      o,
                      b.extend({}, a.axisX, { highLow: d, referenceValue: 0 }),
                    )
                  : a.axisX.type.call(
                      b,
                      b.Axis.units.x,
              ...
              (l = n =
                void 0 === a.axisY.type
                  ? new b.StepAxis(b.Axis.units.y, c.normalized.series, o, { ticks: k })
                  : a.axisY.type.call(b, b.Axis.units.y, c.normalized.series, o, a.axisY)))
            : ((l = m =
                void 0 === a.axisX.type
                  ? new b.StepAxis(b.Axis.units.x, c.normalized.series, o, { ticks: k })
                  : a.axisX.type.call(b, b.Axis.units.x, c.normalized.series, o, a.axisX)),
              (j = n =
                void 0 === a.axisY.type
                  ? new b.AutoScaleAxis(
                      b.Axis.units.y,
                      c.normalized.series,
                      o,
                      b.extend({}, a.axisY, { highLow: d, referenceValue: 0 }),
                    )
                  : a.axisY.type.call(
                      b,
                      b.Axis.units.y,
        ...
        var p = a.horizontalBars ? o.x1 + j.projectValue(0) : o.y1 - j.projectValue(0),
          q = [];
        l.createGridAndLabels(f, h, this.supportsForeignObject, a, this.eventEmitter),
          j.createGridAndLabels(f, h, this.supportsForeignObject, a, this.eventEmitter),
          a.showGridBackground && b.createGridBackground(f, o, a.classNames.gridBackground, this.eventEmitter),
          c.raw.series.forEach(
            function (d, e) {
              var f,
                h,
                i = e - (c.raw.series.length - 1) / 2;
              (f =
                a.distributeSeries && !a.stackBars
                  ? l.axisLength / c.normalized.series.length / 2
                  : a.distributeSeries && a.stackBars
                    ? l.axisLength / 2
                    : l.axisLength / c.normalized.series[e].length / 2),
                (h = g.elem('g')),
                h.attr({ 'ct:series-name': d.name, 'ct:meta': b.serialize(d.meta) }),
                h.addClass(
                  [a.classNames.series, d.className || a.classNames.series + '-' + b.alphaNumerate(e)].join(' '),
                ),
                c.normalized.series[e].forEach(
                  function (g, k) {
                    var r, s, t, u;
                    if (
                      ...
                      (s = h
                        ...
                        .attr({ 'ct:value': [g.x, g.y].filter(b.isNumeric).join(','), 'ct:meta': b.serialize(w) })),
    ...
    (function (a, b) {
      ...
      function d(a) {
        ...
        (this.svg = b.createSvg(
          ...
          (e = b.createChartRect(this.svg, a, f.padding)),
          (g = Math.min(e.width() / 2, e.height() / 2)),
          (i =
            a.total ||
        ...
        '%' === m.unit && (m.value *= g / 100),
          (g -= a.donut && !a.donutSolid ? m.value / 2 : 0),
          (h =
        ...
        j.raw.series.forEach(
          ...
          a.showLabel && (d = this.svg.elem('g', null, null)),
          j.raw.series.forEach(
            function (e, f) {
              if (0 !== j.normalized.series[f] || !a.ignoreEmptyValues) {
                k[f].attr({ 'ct:series-name': e.name }),
                  k[f].addClass(
                    [a.classNames.series, e.className || a.classNames.series + '-' + b.alphaNumerate(f)].join(' '),
                  );
                var p = i > 0 ? l + (j.normalized.series[f] / i) * 360 : 0,
                  q = Math.max(0, l - (0 === f || o ? 0 : 0.2));
                p - q >= 359.99 && (p = q + 359.99);
                var r,
                  s,
                  t,
                  u = b.polarToCartesian(n.x, n.y, g, q),
                  v = b.polarToCartesian(n.x, n.y, g, p),
                  w = new b.Svg.Path(!a.donut || a.donutSolid).move(v.x, v.y).arc(g, g, 0, p - l > 180, 0, u.x, u.y);
                a.donut
                  ? a.donutSolid &&
                    ((t = g - m.value),
                    (r = b.polarToCartesian(n.x, n.y, t, l - (0 === f || o ? 0 : 0.2))),
                    (s = b.polarToCartesian(n.x, n.y, t, p)),
                    w.line(r.x, r.y),
                ...
                if (
                  (y.attr({ 'ct:value': j.normalized.series[f], 'ct:meta': b.serialize(e.meta) }),
                  ...
                  var z;
                  z = 1 === j.raw.series.length ? { x: n.x, y: n.y } : b.polarToCartesian(n.x, n.y, h, l + (p - l) / 2);
                  var A;
                  A =
                    j.normalized.labels && !b.isFalseyButZero(j.normalized.labels[f])
                      ? j.normalized.labels[f]
                      : j.normalized.series[f];
                  var B = a.labelInterpolationFnc(A, f);
                  if (B || 0 === B) {
                    var C = d
                      .elem('text', { dx: z.x, dy: z.y, 'text-anchor': c(n, z, a.labelDirection) }, a.classNames.label)
                      .text('' + B);
                    this.eventEmitter.emit('draw', {
                      type: 'label',
                      index: f,
