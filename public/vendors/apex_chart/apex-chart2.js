...
!(function (t, e) {
        ...
        a(
          ...
          [
            ...
            },
            {
              key: 'randomString',
              value: function (t) {
                for (var e = '', i = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', a = 0; a < t; a++)
          ...
          },
          {
            ...
            value: function (t) {
              ...
              o.config.chart.animations.animateGradually.enabled &&
                ...
                o.config.chart.animations.dynamicAnimation.enabled && o.globals.dataChanged && (l = 0),
            ...
            value: function (t, e, i, a, s, n) {
              ...
              i || (i = t.attr('pathFrom')),
                ...
                t
                  ...
                  .afterAll(function () {
                    u.isNumber(e)
                      ? e === o.globals.series[o.globals.maxValsInArrayIndex].length - 2 &&
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (T.attr('index', a),
                  m && T.attr({ 'clip-path': 'url(#gridRectMask'.concat(A.globals.cuid, ')') }),
                ...
                return (
                  ...
                  A.globals.dataChanged && P && z && C.animatePathsGradually(r({}, X, { speed: p })),
                  T
                );
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, i, a, s) {
                ...
                if (
                  ...
                  'bubble' !== c.config.chart.type
                    ? n.attr({ gradientUnits: 'userSpaceOnUse', cx: b, cy: m, r: r })
              ...
              value: function (t, e) {
                ...
                if (
                  ('function' == typeof i.config.chart.events.dataPointMouseEnter &&
                    i.config.chart.events.dataPointMouseEnter(e, this.ctx, { seriesIndex: s, dataPointIndex: n, w: i }),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                'function' == typeof i.config.chart.events.dataPointMouseLeave &&
                  i.config.chart.events.dataPointMouseLeave(e, this.ctx, { seriesIndex: s, dataPointIndex: n, w: i }),
  ...
  var x = {
            ...
            value: function (t, e, i) {
              ...
              if (this.invertAxis) {
                ...
                (a =
                  ...
                  (t.y - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight)),
              ...
              if (null === t.y2) {
                ...
                if (this.invertAxis) {
                  ...
                  (s =
                    n.globals.gridHeight -
                    (t.y2 - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight)),
                    n.config.yaxis[t.yAxisIndex] &&
                      n.config.yaxis[t.yAxisIndex].reversed &&
                      (s =
              ...
              if (
                ...
                null === t.y && (h = a.globals.series[t.seriesIndex][o]),
                  (n =
                    ...
                    (h - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight) -
                ...
                if (null !== s) {
                  ...
                  s.setAttribute('x', parseFloat(s.getAttribute('x')) - n.height + 4),
                    'top' === t.label.position
                      ? s.setAttribute('y', parseFloat(s.getAttribute('y')) + n.width)
                      : s.setAttribute('y', parseFloat(s.getAttribute('y')) - n.width);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (e = e.replace(/(^|[^\\])fff+/g, '$1' + h(m, 3))),
                ...
                (m = Math.round(m / 10));
              var v = f < 12 ? 'AM' : 'PM';
              e = (e = (e = e.replace(/(^|[^\\])f/g, '$1' + m)).replace(/(^|[^\\])TT+/g, '$1' + v)).replace(
                /(^|[^\\])T/g,
                '$1' + v.charAt(0),
              );
              var y = v.toLowerCase();
                    ...
                    custom: function (t) {
                      ...
                      if (void 0 === s.config.tooltip.x.formatter)
                        if ('datetime' === s.config.xaxis.type) {
                          var c = new v(e);
                          (o = c.formatDate(new Date(n), s.config.tooltip.x.format, !0, !0)),
                            (l = c.formatDate(new Date(r), s.config.tooltip.x.format, !0, !0));
                        } else (o = n), (l = r);
              ...
              value: function (t, e) {
                ...
                return i.globals.series.map(function (a, s) {
                  for (var n = 0, r = 0; r < a.length; r++)
                    i.globals.seriesX[s][r] > t && i.globals.seriesX[s][r] < e && (n += a[r]);
                  return n;
                });
              },
            },
            ...
            value: function () {
              ...
              (this.chartType = e.chart.type),
                'histogram' === this.chartType &&
                  ((e.chart.type = 'bar'), (e = u.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, e))),
              ...
              if (e && 'object' === t(e)) {
                ...
                e.chart.brush && e.chart.brush.enabled && (r = a.brush(r)),
                  e.chart.stacked && '100%' === e.chart.stackType && a.stacked100(),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              'function' == typeof r && (r = r({ seriesIndex: this.seriesIndex, value: t.value, w: e }));
              ...
              return (
                ...
                -1 === r.indexOf('rgb')
                  ? (h = u.hexToRgba(r, l))
                  : r.indexOf('rgba') > -1 && (l = '0.' + u.getOpacityFromRGBA(r)),
                'pattern' === o && (a = this.handlePatternFill(a, r, l, h)),
                'gradient' === o && (s = this.handleGradientFill(s, r, l, this.seriesIndex)),
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                for (var h = 0; h < r.x.length; h++) {
                  ...
                  if (
                    (('line' !== s.config.chart.type && 'area' !== s.config.chart.type) ||
                      s.globals.comboCharts ||
                      s.config.tooltip.intersect ||
                      (d += ' no-pointer-events'),
                    Array.isArray(s.config.markers.size) ? s.globals.markers.size[e] > 0 : s.config.markers.size > 0)
                  ) {
                    ...
                    s.config.series[n].data[i] &&
                      (s.config.series[n].data[i].fillColor &&
                        (f.pointFillColor = s.config.series[n].data[i].fillColor),
                      s.config.series[n].data[i].strokeColor &&
                        (f.pointStrokeColor = s.config.series[n].data[i].strokeColor)),
                    ...
                    void 0 === s.globals.pointsArray[e] && (s.globals.pointsArray[e] = []),
            ...
            value: function (t, e) {
              ...
              null !== i &&
                ...
                r.discrete.map(function (t) {
                  t.seriesIndex === e &&
                    t.dataPointIndex === i &&
                    ((s.pointStrokeColor = t.strokeColor), (s.pointFillColor = t.fillColor), (n = t.size));
                });
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, n, r) {
              ...
              if (
                ...
                v.attr({ cx: t, cy: e, fill: m, stroke: b.pointStrokeColor, 'stroke-width': b.pWidth }),
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  null != (P = o.globals.previousPaths[s] && o.globals.previousPaths[s][r]) &&
                    ((k = P.x), (A = P.y), (S = void 0 !== P.r ? P.r : a));
                  for (var E = 0; E < o.globals.collapsedSeries.length; E++)
                    o.globals.collapsedSeries[E].index === s && ((z = 1), (a = 0));
                  0 === t && 0 === e && (a = 0),
                    h.animateCircle(v, { cx: k, cy: A, r: S }, { cx: t, cy: e, r: a }, z, o.globals.easing);
                } else v.attr({ r: a });
              return (
        ...
        a(t, [
          {
            ...
            value: function (t, e, i, a, s, n, r) {
              ...
              return (0 === s || n) && (l = !0), { x: t, y: e, textRects: h, drawnextLabel: l };
            },
          },
          {
            key: 'drawDataLabel',
            value: function (t, e, i) {
              ...
              for (var d = 0; d < t.x.length; d++)
                if (
                  ...
                  'bottom' === a && (l = l + 2 * s.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)),
                  !isNaN(o))
                ) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  (u && (f = this.dataLabelsCorrection(a, s, o, n, r, d, parseInt(c.style.fontSize))),
                  e.globals.zoomed || ((a = f.x), (s = f.y)),
                  f.textRects && (a + f.textRects.width < 10 || a > e.globals.gridWidth + 10) && (o = ''),
                  f.drawnextLabel)
                ) {
                  var x = i.drawText({
                    width: 100,
                  ...
                  if ((x.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }), c.dropShadow.enabled)) {
                    var b = c.dropShadow;
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              for (var r = 0, o = 0; r < t.length; r++, o++) {
                ...
                for (
                  var P = a.group({ class: 'apexcharts-datalabels' }), z = 0, E = i.globals.dataPoints;
                  z < i.globals.dataPoints;
                  z++, E--
                ) {
                  void 0 === this.series[r][z] || null === t[r][z] ? (this.isNullValue = !0) : (this.isNullValue = !1),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              A.attr('clip-path', 'url(#gridRectMask'.concat(y.globals.cuid, ')')),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var i = 0; i < t.length; i++)
                if (
                  (t[i].length > 0 && ((this.seriesLen = this.seriesLen + 1), (this.totalItems += t[i].length)),
            ...
            value: function () {
              ...
              return (
                this.isHorizontal
                  ...
                  : ((n =
                      (((a = l.globals.gridWidth / this.visibleItems) / this.seriesLen) *
                    ...
                    l.globals.isXNumeric &&
                      ...
                      (n = ((a / this.seriesLen) * parseInt(this.barOptions.columnWidth)) / 100) < 1 && (n = 1)),
                    (r =
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (s = u.move(r, m)),
                (n = u.move(r, m)),
                d.globals.previousPaths.length > 0 && (n = this.getPathFrom(x, f));
              var v = {
                  barHeight: i,
                  strokeWidth: a,
                  barYPosition: m,
                  x: (o =
                    void 0 === this.series[g][f] || null === this.series[g][f]
                      ...
                      : r +
                        ...
                        2 * (this.isReversed ? this.series[g][f] / this.invertedYRatio : 0)),
                  zeroW: r,
                },
                y = this.barEndingShape(d, v, this.series, g, f);
              if (
                ((s = s + u.line(y.newX, m) + y.path + u.line(r, m + i - a) + u.line(r, m)),
                (n = n + u.line(r, m) + y.ending_p_from + u.line(r, m + i - a) + u.line(r, m + i - a) + u.line(r, m)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (d.globals.isXNumeric) {
                var m = g;
                d.globals.seriesX[g].length || (m = d.globals.maxValsInArrayIndex),
                  (i = (d.globals.seriesX[m][f] - d.globals.minX) / this.xRatio - o / 2);
              }
              var v = i + o * this.visibleI;
              (n = u.move(v, l)),
                (r = u.move(v, l)),
                d.globals.previousPaths.length > 0 && (r = this.getPathFrom(x, f));
              var y = {
                  barWidth: o,
                  strokeWidth: h,
                  barXPosition: v,
                  y: (a =
                    void 0 === this.series[g][f] || null === this.series[g][f]
                      ...
                      : l -
                        ...
                        2 * (this.isReversed ? this.series[g][f] / this.yRatio[this.yaxisIndex] : 0)),
                  zeroH: l,
                },
                w = this.barEndingShape(d, y, this.series, g, f);
              if (
                ((n = n + u.line(v, w.newY) + w.path + u.line(v + o - h, l) + u.line(v - h / 2, l)),
                (r =
                  r +
                  u.line(v, l) +
                  w.ending_p_from +
          ...
          },
          {
            ...
            value: function (t) {
              ...
              d.globals.isXNumeric &&
                ...
                ((f = e + parseFloat(l * (h + 1))), (x = i + parseFloat(o * (h + 1)) - g));
              var b = e,
                m = i,
                v = {},
              ...
              return (
                d.config.dataLabels.enabled &&
                  (S = u.getTextRects(d.globals.yLabelFormatters[0](d.globals.maxY), parseFloat(y.style.fontSize))),
                (v = this.isHorizontal
                ...
                c.attr({ cy: v.bcy, cx: v.bcx, j: s, val: r[a][s], barHeight: o, barWidth: l }),
            ...
            value: function (t) {
              ...
              return (
                i.config.chart.stacked ||
                  (c < 0 ? (c = 0 + u) : c + h.height / 3 > i.globals.gridHeight && (c = i.globals.gridHeight - u)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !m) {
                ...
                var v = '';
                void 0 !== a && (v = x(a, { seriesIndex: s, dataPointIndex: n, w: d })),
                ...
                'vertical' === d.config.plotOptions.bar.dataLabels.orientation &&
                  ...
                  d.config.chart.stacked &&
                    ...
                    (this.isHorizontal
                      ? (((h = this.series[s][n] / this.yRatio[this.yaxisIndex]) > 0 && o.width / 1.6 > h) ||
                          (h < 0 && o.width / 1.6 < h)) &&
                        (v = '')
                      : ((l = this.series[s][n] / this.yRatio[this.yaxisIndex]), o.height / 1.6 > l && (v = '')));
                var k = r({}, c);
                this.isHorizontal &&
                  a < 0 &&
                  ('start' === c.textAnchor
            ...
            value: function (t, e, i, a, s) {
              ...
              if (this.isHorizontal) {
                ...
                if (void 0 !== i[a][s] || null !== i[a][s]) {
                  ...
                  switch (
                    ...
                    t.config.chart.stacked || ('rounded' === this.barOptions.endingShape && (o = e.x - h / 2)),
              ...
              if (void 0 !== i[a][s] || null !== i[a][s]) {
                ...
                switch (
                  ...
                  t.config.chart.stacked || ('rounded' === this.barOptions.endingShape && (d += g / 2)),
                  this.barOptions.endingShape)
                ) {
                  case 'flat':
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              for (
                var n = this.graphics.group({ class: 'apexcharts-bar-series apexcharts-plot-series' }),
                  r = 0,
                  o = 0,
                  l = 0,
                  h = 0;
                ...
                this.isHorizontal
                  ...
                  : ((o = i = l.globals.gridWidth / l.globals.dataPoints),
                    (o = l.globals.isXNumeric
                      ? ((i = l.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth)) / 100
            ...
            value: function (t) {
              ...
              if (f > 0) {
                ...
                this.prevXVal[f - 1][p] < 0
                  ? (y =
                      this.series[f][p] >= 0
                        ? this.prevX[f - 1][p] + m - 2 * (this.isReversed ? m : 0)
                        : this.prevX[f - 1][p])
                  : this.prevXVal[f - 1][p] >= 0 &&
                    (y =
                      this.series[f][p] >= 0
              ...
              l =
                null === this.series[f][p]
                  ...
                  : e +
                    ...
                    2 * (this.isReversed ? this.series[f][p] / this.invertedYRatio : 0);
              var w = { barHeight: a, strokeWidth: s, invertedYRatio: this.invertedYRatio, barYPosition: g, x: l },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a =
                ...
                2 * (this.isReversed ? this.series[u][g] / this.yRatio[this.yaxisIndex] : 0);
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              (t = n.getLogSeries(t)),
                ...
                this.initVariables(t);
              for (
                var r = a.group({ class: 'apexcharts-candlestick-series apexcharts-plot-series' }), o = 0, l = 0;
                o < t.length;
                o++, l++
              ) {
                var h,
                ...
                for (
                  ...
                  (d = T.pathTo),
                    ...
                    z > 0 && m.push(f + A / 2),
                    b.push(x);
                  var I = s.fillPath({ seriesNumber: v, color: M, value: t[o][z] }),
            ...
            value: function (t) {
              ...
              return (
                void 0 === this.series[d][u] || null === this.series[d][u]
                  ? (k = o)
                  : ((k = o - k / b), (A = o - A / b), (y = o - v.h / b), (w = o - v.l / b)),
                c.move(S, o),
                (n = c.move(S, k)),
                ...
                { pathTo: s, pathFrom: n, x: i, y: A, barXPosition: S, color: g ? f : x }
              );
            },
          },
          {
            ...
            value: function (t, e) {
              ...
              s.distributed || ((o = i.globals.minY), (l = i.globals.maxY)),
                void 0 !== s.colorScale.min &&
                  ((o = s.colorScale.min < i.globals.minY ? s.colorScale.min : i.globals.minY),
                  (l = s.colorScale.max > i.globals.maxY ? s.colorScale.max : i.globals.maxY));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (l.enabled) {
                ...
                c.plotDataLabelsText({ x: x, y: b, text: m, i: a, j: s, parent: u, dataLabelsConfig: l });
              }
              return u;
            },
          },
    ...
    Y = (function () {
      function t(i) {
        ...
        (this.lineColorArr = void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors),
          (this.defaultSize =
            a.globals.svgHeight < a.globals.svgWidth ? a.globals.svgHeight - 35 : a.globals.gridWidth),
          (this.centerY = this.defaultSize / 2),
          (this.centerX = a.globals.gridWidth / 2),
          (this.fullAngle = 360),
          (a.globals.radialSize = this.defaultSize / 2.05 - a.config.stroke.width - a.config.chart.dropShadow.blur),
          void 0 !== a.config.plotOptions.pie.size && (a.globals.radialSize = a.config.plotOptions.pie.size),
          (this.donutSize = (a.globals.radialSize * parseInt(a.config.plotOptions.pie.donut.size)) / 100),
          (this.sliceLabels = []),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              if (e.globals.dataChanged) {
                for (var c, d = 0, g = 0; g < e.globals.previousPaths.length; g++)
                  d += u.negToZero(e.globals.previousPaths[g]);
                for (var f = 0; f < e.globals.previousPaths.length; f++)
                  (c = (this.fullAngle * u.negToZero(e.globals.previousPaths[f])) / d), this.prevSectorAngleArr.push(c);
              }
              ...
              if ('donut' === e.config.chart.type) {
                ...
                w.attr({ cx: this.centerX, cy: this.centerY, fill: e.config.plotOptions.pie.donut.background }),
                  o.add(w);
              }
              ...
              if (
                ...
                a.attr({ 'data:innerTranslateX': v, 'data:innerTranslateY': y - 25 }),
                o.add(k),
                a.add(o),
            ...
            value: function (t, e) {
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                if (
                  ...
                  i.config.plotOptions.pie.expandOnClick && v.click(this.pieClicked.bind(this, d)),
                  i.config.dataLabels.enabled)
                ) {
                  var A = w.x,
                    S = w.y,
                  ...
                  if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                    ...
                    void 0 !== P && (L = P(i.globals.seriesPercent[d][0], { seriesIndex: d, w: i }));
                    ...
                    E.node.classList.add('apexcharts-pie-label'),
                      i.config.chart.animations.animate &&
                        ...
                        (E.node.style.animationDelay = i.config.chart.animations.speed / 940 + 's')),
              ...
              void 0 !== e.prevStartAngle &&
                ...
                e.i === i.config.series.length - 1 &&
                  (a + r > this.fullAngle
                    ...
                    : a + r < this.fullAngle && (e.endAngle = e.endAngle + (this.fullAngle - (a + r)))),
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, n) {
              ...
              l.globals.dataChanged &&
                ...
                ((r = o.getPiePath({ me: o, startAngle: u, angle: s, size: c })), t.attr({ d: r })),
                0 !== n.dur
                  ? t
                      ...
                      .during(function (l) {
                        (d = g + (a - g) * l),
                          n.animateStartingPos && ((d = s + (a - s) * l), (u = e - s + (i - (e - s)) * l)),
                          (r = o.getPiePath({ me: o, startAngle: u, angle: d, size: c })),
                          t.node.setAttribute('data:pathOrig', r),
                          t.attr({ d: r });
                      })
                  : ((r = o.getPiePath({ me: o, startAngle: u, angle: a, size: c })),
            ...
            value: function (t) {
              var e,
                ...
                s = i.globals.dom.Paper.select(
                  '.apexcharts-'.concat(i.config.chart.type.toLowerCase(), '-slice-').concat(t),
                ).members[0],
                n = s.attr('d');
              if ('true' !== s.attr('data:pieClicked')) {
                ...
                (e = this.getPiePath({ me: this, startAngle: o, angle: l, size: a })),
            ...
            value: function (t) {
              ...
              return 'donut' === n.config.chart.type
                ...
                : 'pie' === n.config.chart.type
                  ? ['M', c, d, 'A', s, s, 0, b, 1, g, f, 'L', e.centerX, e.centerY, 'L', c, d].join(' ')
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              a
                ? (s =
                    void 0 === t.name.color
                      ? n.globals.colors[parseInt(a.parentNode.getAttribute('rel')) - 1]
                      : t.name.color)
                : n.globals.series.length > 1 && t.total.show && (s = t.total.color);
                    ...
                    if (n.globals.selectedDataPoints[0].length > 0) {
                      var h = n.globals.selectedDataPoints[0],
                        c = n.globals.dom.baseEl.querySelector(
                          '.apexcharts-'.concat(n.config.chart.type.toLowerCase(), '-slice-').concat(h),
                        );
    ...
    F = (function () {
      function t(i) {
        ...
        (this.size = this.defaultSize / 2.1 - a.config.stroke.width - a.config.chart.dropShadow.blur - n.width / 1.75),
              ...
              if (
                ...
                t.forEach(function (t, n) {
                  ...
                  (e.dataRadiusOfPercent[n] = []),
                    ...
                    t.forEach(function (t, i) {
                      (e.dataRadiusOfPercent[n][i] = t / e.maxValue),
                        (e.dataRadius[n][i] = e.dataRadiusOfPercent[n][i] * e.size),
                  ...
                  t.forEach(function (t, i) {
                    ...
                    var r = e.graphics.group({ class: 'apexcharts-series-markers' });
        ...
        a(i, [
          {
            ...
            value: function (t) {
              ...
              e.config.plotOptions.radialBar.startAngle < 0 &&
                (d = Math.abs(e.config.plotOptions.radialBar.endAngle - e.config.plotOptions.radialBar.startAngle));
              var u = (360 - d) / 360;
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var o = 0; o < t.series.length; o++) {
                ...
                a.add(l), l.attr({ rel: o + 1 }), (t.size = t.size - r - this.margin);
            ...
            value: function (t) {
              ...
              for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                ...
                e.globals.dataChanged &&
                  ((k = this.startAngle), (P = Math.round((A * u.negToZero(e.globals.previousPaths[m])) / 100) + k)),
                ...
                if (
                  (p.setAttrs(M.node, { 'data:angle': z, 'data:value': t.series[m] }),
                  e.config.chart.dropShadow.enabled)
                ) {
                  var T = e.config.chart.dropShadow;
                  s.dropShadow(M, T, m);
                }
                this.addListeners(M, this.radialDataLabels), v.add(M), M.attr({ index: 0, j: m });
                var I = 0;
                !this.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
                  ...
                  this.animBeginArr.push(this.animDur)),
                  e.globals.dataChanged &&
                    ((I = ((L - w) / 360) * e.config.chart.animations.dynamicAnimation.speed),
                    (this.animDur = I / (1.2 * t.series.length) + this.animDur),
                    this.animBeginArr.push(this.animDur)),
                  this.animatePaths(M, {
                    centerX: t.centerX,
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              (this.rangeBarOptions = this.w.config.plotOptions.rangeBar),
                ...
                this.initVariables(t);
              for (
                var n = a.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }), r = 0, o = 0;
                r < t.length;
                r++, o++
              ) {
                var l,
                ...
                (b = A.y),
                  ...
                  (c = A.zeroH);
                for (
                  var S = a.group({ class: 'apexcharts-datalabels' }), L = 0, P = i.globals.dataPoints;
                  L < i.globals.dataPoints;
                  L++, P--
                ) {
                  (this.isNullValue = !1),
                    (void 0 !== this.series[r][L] && null !== t[r][L]) || (this.isNullValue = !0),
                    i.config.stroke.show &&
                      (y = this.isNullValue
                        ? 0
                        : Array.isArray(this.strokeWidth)
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                c.move(v, l),
                (r = c.move(v, b)),
                h.globals.previousPaths.length > 0 && (r = this.getPathFrom(f, u, !0)),
                (n = c.move(v, m) + c.line(v + o, m) + c.line(v + o, b) + c.line(v, b) + c.line(v, m - a / 2)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var b = Math.abs(f - g);
              return (
                (s = h.move(g, x) + h.line(f, x) + h.line(f, x + r) + h.line(g, x + r) + h.line(g, x)),
                (n = n + h.line(g, x) + h.line(g, x + r) + h.line(g, x + r) + h.line(g, x)),
                l.globals.isXNumeric || (i += a),
                { pathTo: s, pathFrom: n, barWidth: b, x: f, y: i, barYPosition: x }
              );
            },
          },
          {
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                return new v(this.ctx).formatDate(new Date(e), a.config.tooltip.x.format, !0, !0);
              return t(e, i);
            },
          },
          {
                ...
                void 0 !== t.config.xaxis.labels.formatter
                  ...
                  : (t.globals.xLabelFormatter = function (e) {
                      if (u.isNumber(e)) {
                        ...
                        if (t.globals.isBarHorizontal) if (t.globals.maxY - t.globals.minYArr < 4) return e.toFixed(1);
                        return e.toFixed(0);
                      }
                      return e;
                    }),
              ...
              return (
                e.length > 0
                  ? ((u = e[a].unit),
                    ...
                    (i = e[a].position),
                    (s = e[a].value))
                  : 'datetime' === r.config.xaxis.type && void 0 === h && (s = ''),
                void 0 === s && (s = ''),
                (0 === (s = s.toString()).indexOf('NaN') ||
                  0 === s.toLowerCase().indexOf('invalid') ||
                  s.toLowerCase().indexOf('infinity') >= 0 ||
                  (n.indexOf(s) >= 0 && !r.config.xaxis.labels.showDuplicates)) &&
                  (s = ''),
                { x: i, text: s, isBold: c }
              );
            },
        ...
        a(t, [
              ...
              if ((e.config.yaxis[t] && e.config.yaxis[t].reversed && d.reverse(), e.config.yaxis[t].labels.show))
                for (var u = o; u >= 0; u--) {
                  ...
                  0 !== e.config.yaxis[t].labels.rotate &&
                    x.node.setAttribute(
                      'transform',
                      'rotate('.concat(e.config.yaxis[t].labels.rotate, ' ').concat(b.x, ' ').concat(b.y, ')'),
                    ),
                    (h += l);
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              c.length > 0 && ((this.xaxisLabels = c.slice()), (n = (h = c.slice()).length)),
            ...
            value: function (t, e) {
              ...
              if (null !== o) {
                ...
                e
                  ? o.setAttribute(
                      'transform',
                      'rotate('.concat(i.config.yaxis[t].title.rotate, ' ').concat(h.x, ' ').concat(h.y, ')'),
                    )
                  : o.setAttribute(
                      'transform',
                      'rotate(-'.concat(i.config.yaxis[t].title.rotate, ' ').concat(h.x, ' ').concat(h.y, ')'),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              return void 0 === s.config.yaxis[t].title.text || t < 0
                ? { xPos: r, padd: 0 }
                : (a
                    ? ((r = e.width + s.config.yaxis[t].title.offsetX + i.width / 2 + o / 2),
                      0 === (n += 1) && (r -= o / 2))
                    : ((r = -1 * e.width + s.config.yaxis[t].title.offsetX + o / 2 + i.width / 2),
                      s.globals.isBarHorizontal &&
                        ((o = 25), (r = -1 * e.width - s.config.yaxis[t].title.offsetX - o))),
                  { xPos: r, padd: o });
            },
          },
          {
              ...
              if (
                ('pie' === e.config.chart.type || 'donut' === e.config.chart.type
                  ...
                  : 'radialBar' === e.config.chart.type &&
                    ((s += e.config.plotOptions.radialBar.offsetY), (n += e.config.plotOptions.radialBar.offsetX)),
          ...
          },
          {
            ...
            value: function (t) {
              var e = this,
                i = this.w;
              if (
                ('category' === i.config.xaxis.type && i.globals.isBarHorizontal) ||
                ...
                i.config.yaxis.forEach(function (s, n) {
                  ...
                  (!s.show ||
                    ...
                    (((a && i.globals.isMultipleYAxis && -1 !== i.globals.collapsedSeriesIndices.indexOf(n)) ||
                      (i.globals.isBarHorizontal && s.opposite)) &&
                      ((r = t), i.config.grid.padding.left < r.width && (e.xPadLeft = r.width / 2 + 1)),
                    ((!i.globals.isBarHorizontal && s.opposite && -1 !== i.globals.collapsedSeriesIndices.indexOf(n)) ||
                      ...
                      (function (t) {
                        e.timescaleLabels
                          ...
                          : 'datetime' === i.config.xaxis.type
                            ? i.config.grid.padding.right < t.width && (i.globals.skipLastTimelinelabel = !0)
                            : 'datetime' !== i.config.xaxis.type &&
            ...
            value: function () {
              ...
              void 0 !== t.config.title.text
                ...
                t.config.legend.show &&
                  ...
                  (t.config.series.length > 1 || !t.globals.axisCharts || t.config.legend.showForSingleSeries) &&
                  (i += 10);
            ...
            value: function () {
              ...
              (this.timescaleLabels = e.globals.timelineLabels.slice()),
                e.globals.isBarHorizontal &&
                  ...
                  (this.timescaleLabels = e.globals.invertedTimelineLabels.slice());
              ...
              return (
                1.05 * (t = new p(this.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length >
                  e.globals.gridWidth &&
            ...
            value: function () {
              ...
              if (e.globals.timelineLabels.length > 0) {
                ...
                (t = { width: h.width, height: h.height }).width * i.length >
                  e.globals.svgWidth - s - this.yAxisWidth && 0 !== e.config.xaxis.labels.rotate
                  ? e.globals.isBarHorizontal ||
                ...
                e.config.yaxis.map(function (s, n) {
                  if (s.show && s.labels.show && e.globals.yAxisScale[n].result.length) {
                    var r = e.globals.yLabelFormatters[n],
                      o = r(e.globals.yAxisScale[n].niceMax, { seriesIndex: n, dataPointIndex: -1, w: e });
                    if (
                      ((void 0 !== o && 0 !== o.length) || (o = e.globals.yAxisScale[n].niceMax),
                      e.globals.isBarHorizontal)
                    )
                      (a = 0),
                        (o = r(
              ...
              function e(e, i, a) {
                for (
                  var s = e[i].childNodes,
                    n = { type: a, paths: [], realIndex: e[i].getAttribute('data:realIndex') },
                    r = 0;
                  r < s.length;
                  r++
                )
                ...
                for (var m = 0; m < b.length; m++) {
                  for (
                    var v = t.globals.dom.baseEl.querySelectorAll(
                        ".apexcharts-scatter-series .apexcharts-series[data\\:realIndex='".concat(m, "'] circle"),
                      ),
                      y = [],
                      w = 0;
                    w < v.length;
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                'left' === e.align
                  ? ((a = 10), (n = 'start'))
                  : 'right' === e.align && ((a = t.globals.svgWidth - 10), (n = 'end')),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                var n = t.globals.legendFormatter, r = t.config.legend.inverseOrder, o = r ? i.length - 1 : 0;
                r ? o >= 0 : o <= i.length - 1;
                r ? o-- : o++
              ) {
                ...
                if (t.globals.ancillaryCollapsedSeriesIndices.length > 0)
                  for (var u = 0; u < t.globals.ancillaryCollapsedSeriesIndices.length; u++)
                    t.globals.ancillaryCollapsedSeriesIndices[u] === o && (c = !0);
                ...
                (A.background = a[o]),
                  ...
                  (A.width = Array.isArray(m) ? parseFloat(m[o]) + 'px' : parseFloat(m) + 'px'),
                ...
                t.config.legend.showForNullSeries ||
                  ...
                  t.config.legend.onItemClick.toggleDataSeries || S.classList.add('no-click');
              }
            ...
            value: function () {
              ...
              'bottom' === t.config.legend.position
                ...
                : 'top' === t.config.legend.position &&
                  (n = a.height + s.height + t.config.title.margin + t.config.subtitle.margin - 15),
          ...
          },
          {
            ...
            value: function (t) {
              if (
                ...
                'function' == typeof s &&
                  t.target.classList.contains('apexcharts-legend-marker') &&
                  (s(this.ctx, e, this.w), this.ctx.fireEvent('legendMarkerClick', [this.ctx, e, this.w])),
              ...
              if (i.globals.axisCharts || 'radialBar' === i.config.chart.type) {
                ...
                if (
                  ...
                  i.globals.axisCharts
                    ...
                    : ((a = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']"))),
                  ...
                  if (i.globals.axisCharts) {
                    ...
                    i.globals.collapsedSeries.push({ index: s, data: i.config.series[s] }),
                      i.globals.collapsedSeriesIndices.push(s),
                      (i.config.series[s] = 0);
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                if (
                  'line' === o &&
                  ('gradient' === a.config.fill.type || 'gradient' === a.config.fill.type[v]) &&
                ...
                N.attr({ 'data:longestSeries': B, rel: v + 1, 'data:realIndex': A }), (this.appendPathFrom = !0);
                var V = T,
                  G = void 0,
                  _ = V,
                  j = E,
                ...
                for (
                  var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints, J = 0;
                  J < $;
                  J++
                ) {
                  if (a.globals.isXNumeric) {
                    var Q = a.globals.seriesX[A][J + 1];
                    void 0 === a.globals.seriesX[A][J + 1] && (Q = a.globals.seriesX[A][$ - 1]),
                      (T = (Q - a.globals.minX) / g);
                  } else T += k;
                  var K = u.isNumber(a.globals.minYArr[A]) ? a.globals.minYArr[A] : a.globals.minY;
                  a.config.chart.stacked
                    ? ((U =
                        v > 0 && a.globals.collapsedSeries.length < a.config.series.length - 1 ? b[v - 1][J + 1] : E),
                      (I =
                        void 0 === t[v][J + 1] || null === t[v][J + 1]
                          ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0)
                          : U -
                            t[v][J + 1] / c[this.yaxisIndex] +
                            2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)))
                    : (I =
                        void 0 === t[v][J + 1] || null === t[v][J + 1]
                          ? E - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0)
                          : E -
                            t[v][J + 1] / c[this.yaxisIndex] +
                            2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)),
                    P.push(T),
                  ...
                  (O = tt.areaPaths),
                    ...
                    (Y = tt.areaPath),
                    (X = tt.linePath),
                    this.appendPathFrom && ((F += s.line(T, E)), (R += s.line(T, E)));
                  ...
                  if (this.pointsChart)
                    this.scatter.draw(N, J, { realIndex: A, pointsPos: et, zRatio: d, elParent: H });
                  else {
                ...
                b.push(S),
                  ...
                  this.pointsChart || a.globals.delayedElements.push({ el: H.node, index: A });
                var rt = {
                  i: v,
                  realIndex: A,
                  animationDelay: v,
                ...
                if ('area' === o)
                  for (var ot = n.fillPath({ seriesNumber: A }), lt = 0; lt < O.length; lt++) {
                ...
                if (a.config.stroke.show && !this.pointsChart) {
                  var ct = null;
                  ct = 'line' === o ? n.fillPath({ seriesNumber: A, i: v }) : a.globals.stroke.colors[A];
            ...
            value: function (t) {
              ...
              if (
                (Array.isArray(x.config.stroke.curve) &&
                  (m = Array.isArray(f) ? x.config.stroke.curve[f[i]] : x.config.stroke.curve[i]),
                'smooth' === m)
              ) {
                var v = 0.35 * (s - r);
                x.globals.hasNullValues
                  ? (null !== e[i][a] &&
                      (null !== e[i][a + 1]
                        ? ((c = b.move(r, o) + b.curve(r + v, o, s - v, n, s + 1, n)),
                          (d =
                            b.move(r + 1, o) +
                    ...
                    u.push(c),
                    g.push(d))
                  : ((c += b.curve(r + v, o, s - v, n, s, n)), (d += b.curve(r + v, o, s - v, n, s, n))),
                  (r = s),
                  (o = n),
                  a === e[i].length - 2 &&
                ...
                null === e[i][a + 1] && ((c += b.move(s, n)), (d = d + b.line(s - l, h) + b.move(s, n))),
                  null === e[i][a] && ((c += b.move(s, n)), (d += b.move(s, h))),
                  'stepline' === m
                    ? ((c = c + b.line(s, null, 'H') + b.line(null, n, 'V')),
                      (d = d + b.line(s, null, 'H') + b.line(null, n, 'V')))
                    : 'straight' === m && ((c += b.line(s, n)), (d += b.line(s, n))),
                  a === e[i].length - 2 && ((d = d + b.line(s, h) + b.move(s, n) + 'z'), u.push(c), g.push(d));
            ...
            value: function (t) {
              ...
              if (0 === r) {
                ...
                c.globals.isXNumeric && (f = (c.globals.seriesX[i][0] - c.globals.minX) / h + c.config.markers.offsetX),
                  d.push(f),
                  g.push(u.isNumber(e[n][0]) ? o + c.config.markers.offsetY : null),
                  d.push(a + c.config.markers.offsetX),
                  g.push(u.isNumber(e[n][r + 1]) ? s + c.config.markers.offsetY : null);
              } else
                d.push(a + c.config.markers.offsetX),
                  g.push(u.isNumber(e[n][r + 1]) ? s + c.config.markers.offsetY : null);
              return { x: d, y: g };
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = t.pathFromLine, i = t.pathFromArea, a = t.realIndex, s = this.w, n = 0;
                ...
                ('line' === r.type || 'area' === r.type) &&
                  ...
                  ('line' === r.type
                    ...
                    : 'area' === r.type &&
                      ...
                      s.config.stroke.show && (e = s.globals.previousPaths[n].paths[1].d)));
              }
            ...
            value: function (t) {
              ...
              if (void 0 !== i[e][0])
                n = l.config.chart.stacked
                  ? (o = e > 0 ? r[e - 1][0] : s) - i[e][0] / a + 2 * (this.isReversed ? i[e][0] / a : 0)
    ...
    _ = (function () {
      function t(i) {
        ...
        (this.xaxisLabels = a.globals.labels.slice()),
          a.globals.timelineLabels.length > 0 && (this.xaxisLabels = a.globals.timelineLabels.slice()),
          (this.drawnLabels = []),
          ...
          this.xaxisBorderWidth.indexOf('%') > -1
            ? (this.xaxisBorderWidth = (a.globals.gridWidth * parseInt(this.xaxisBorderWidth)) / 100)
            ...
            value: function () {
              ...
              if (e.config.xaxis.labels.show)
                for (var h = 0; h <= l - 1; h++) {
                  ...
                  h === l - 1 && e.globals.skipLastTimelinelabel && (d.text = ''),
                    s.add(g),
              ...
              if (e.config.xaxis.axisBorder.show) {
                ...
                var v = i.drawLine(
                  e.globals.padHorizontal + m + e.config.xaxis.axisBorder.offsetX,
                  this.offY,
              ...
              if (d.show)
                for (var u = 0; u <= l.length - 1; u++) {
                  ...
                  if ((o.add(f), 0 !== a.config.yaxis[t].labels.rotate)) {
                    ...
                    f.node.setAttribute(
                      'transform',
                      'rotate('.concat(a.config.yaxis[t].labels.rotate, ' ').concat(x.x, ' ').concat(x.y, ')'),
                    );
                  }
                  i += e;
                }
            ...
            value: function () {
              ...
              if (s.length > 0) {
                var u = s[s.length - 1].getBBox(),
                  g = s[0].getBBox();
                u.x < -20 && s[s.length - 1].parentNode.removeChild(s[s.length - 1]),
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              var a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                ...
                n = this.w,
                r =
                  (void 0 === this.w.config.yaxis[a].max && void 0 === this.w.config.yaxis[a].min) ||
                      ...
                      t.forEach(function (i, l) {
                        t[l].key === e &&
                          (void 0 !== s.yaxis[e].min &&
                            (r = 'function' == typeof s.yaxis[e].min ? s.yaxis[e].min(n.minY) : s.yaxis[e].min),
                          void 0 !== s.yaxis[e].max &&
                            (o = 'function' == typeof s.yaxis[e].max ? s.yaxis[e].max(n.maxY) : s.yaxis[e].max),
                    ...
                    n
                      ? ((f = g[o]),
                        ...
                        g.forEach(function (t, e) {
                          s[e] <= i.xaxis.max &&
                            s[e] >= i.xaxis.min &&
                            (t > c && null !== t && (c = t), r[e] < h && null !== r[e] && (h = r[e]));
                        }))
                      : ((h = c = f),
                        r.forEach(function (t, e) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              'candlestick' === this.w.config.chart.type
                ...
                : s.isRangeData && ((l = s.seriesRangeStart), (h = s.seriesRangeEnd));
              for (var c = t; c < a; c++) {
                ...
                for (var d = 0; d < s.series[c].length; d++) {
                  ...
                  null !== g && u.isNumber(g)
                    ? ((n = Math.max(n, h[c][d])),
                      ...
                      u.isFloat(g) &&
                        ((g = u.noExponents(g)),
                        (s.yValueDecimal = Math.max(s.yValueDecimal, g.toString().split('.')[1].length))),
            ...
            value: function () {
              ...
              if (
                (e.noLabelsProvided &&
                  ...
                  (e.minX = 1),
                  (e.initialminX = 1)),
                (e.comboChartsHasBars || 'candlestick' === i.chart.type || ('bar' === i.chart.type && e.isXNumeric)) &&
              ...
              return (
                e.isXNumeric &&
                  e.seriesX.forEach(function (t, i) {
                    1 === t.length &&
                      t.push(e.seriesX[e.maxValsInArrayIndex][e.seriesX[e.maxValsInArrayIndex].length - 1]);
                    var a = t.slice();
                    a.sort(function (t, e) {
                      return t - e;
                    }),
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              this.determineInterval(n),
                ...
                n < 0.005 ? (a.globals.disableZoomIn = !0) : n > 5e4 && (a.globals.disableZoomOut = !0);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e ? (i.globals.invertedTimelineLabels = s.slice()) : (i.globals.timelineLabels = s.slice()),
            ...
            value: function (t) {
              ...
              if (e.minDate > 1 && e.minMonth > 0) {
                ...
                (o = (l.determineDaysOfYear(e.minYear) - h + 1) * s),
                  (r = e.minYear + 1),
                  this.timeScaleArray.push({ position: o, value: r, unit: 'year', year: r, month: u.monthMod(i + 1) });
              } else
                1 === e.minDate &&
                  0 === e.minMonth &&
                  this.timeScaleArray.push({ position: o, value: r, unit: 'year', year: a, month: u.monthMod(i + 1) });
          ...
          },
          {
            ...
            value: function (t) {
              ...
              } else this.timeScaleArray.push({ position: l, value: o, unit: c, year: s, month: u.monthMod(a) });
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.firstVal,
                ...
                g = h,
                f = d(g, i, a);
              this.timeScaleArray.push({ position: l, value: c, unit: o, year: a, month: u.monthMod(f), day: g });
              for (var p = l, x = 0; x < n; x++) {
                (o = 'day'), (f = d((g += 1), f, a + Math.floor(f / 12) + 0));
                var b = a + Math.floor(f / 12) + 0;
                p = 24 * s + p;
                var m = 1 === g ? u.monthMod(f) : g;
                this.timeScaleArray.push({ position: p, value: m, unit: o, year: b, month: u.monthMod(f), day: m });
              }
            },
          },
          {
        ...
        a(t, [
          {
            ...
            value: function () {
              var t = this.w.globals,
                ...
                i = e.chart.type;
              (t.axisCharts =
                ['line', 'area', 'bar', 'rangeBar', 'candlestick', 'radar', 'scatter', 'bubble', 'heatmap'].indexOf(i) >
                -1),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ('%' === a
                  ? u.isNumber(i[0]) &&
                    (0 === i[0].width && (i = u.getDimensions(this.el.parentNode)),
          ...
          },
          {
            ...
            value: function () {
              ...
              e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute('height', h),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var r = 0; r < t[e].data.length; r++)
                void 0 !== t[e].data[r][2] && (this.threeDSeries.push(t[e].data[r][2]), (a.isDataXYZ = !0));
            },
          },
          {
            key: 'handleFormatXY',
              ...
              for (var r = 0; r < t[e].data.length; r++)
                void 0 !== t[e].data[r].y &&
                  (Array.isArray(t[e].data[r].y)
                    ? this.twoDSeries.push(u.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1]))
            ...
            value: function (t, e) {
              ...
              return (
                this.isFormat2DArray()
                  ...
                  : this.isFormatXY() && (a = this.handleRangeDataFormat('xy', t, e)),
              ...
              if ('array' === t) {
                ...
                if (5 === e[i].data[0].length)
                  for (var l = 0; l < e[i].data.length; l++)
                    a.push(e[i].data[l][1]), s.push(e[i].data[l][2]), n.push(e[i].data[l][3]), r.push(e[i].data[l][4]);
                else
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx,
                  i = this.w.config,
                  a = this.w.globals,
                  s = new v(e),
                  n = 0;
                ...
                if (
                  ...
                  if ('datetime' === i.xaxis.type) {
                    a.isXNumeric = !0;
                    for (
                      var r = i.labels.length > 0 ? i.labels.slice() : i.xaxis.categories.slice(), o = 0;
                      o < r.length;
                      o++
                    )
              ...
              if (e.globals.axisCharts) {
                ...
                if (
                  ...
                  isFinite(e.globals.minX) && isFinite(e.globals.maxX) && !e.globals.isBarHorizontal
                    ? ((i = a.calculateTimeScaleTicks(e.globals.minX, e.globals.maxX)),
                      a.recalcDimensionsBasedOnFormat(i, !1))
                    : e.globals.isBarHorizontal &&
                      ((i = a.calculateTimeScaleTicks(e.globals.minY, e.globals.maxY)),
                ...
                i.forEach(function (e) {
                  ...
                  (e.config.chart.events.selection = function (t, a) {
                    i.forEach(function (t) {
                      ...
                      i._updateOptions({ xaxis: { min: a.xaxis.min, max: a.xaxis.max }, yaxis: s }, !1, !1, !1, !1);
                    });
                  });
              }
            },
    ...
    lt = (function () {
      function t(i) {
        ...
        (this.anim = new f(this.ctx)),
          (this.xaxisLabels = a.globals.labels.slice()),
          (this.animX = a.config.grid.xaxis.lines.animate && a.config.chart.animations.enabled),
          (this.animY = a.config.grid.yaxis.lines.animate && a.config.chart.animations.enabled),
          a.globals.timelineLabels.length > 0 && (this.xaxisLabels = a.globals.timelineLabels.slice());
      }
      return (
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                ...
                (void 0 !== t.globals.yAxisScale[l] && (o = t.globals.yAxisScale[l].result.length - 1), !(o > 2));
                l++
              );
              if (t.globals.isBarHorizontal) {
                if (((r = o), t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show))
                  for (
                    var h, c = t.globals.padHorizontal, d = t.globals.gridHeight, u = 0;
                    u < r + 1 && ((h = c = c + t.globals.gridWidth / r + 0.3), u !== r - 1);
                    u++
                  ) {
                    if (t.config.grid.xaxis.lines.show) {
                      ...
                      g.node.classList.add('apexcharts-gridline'),
                        n.add(g),
                        this.animX && this.animateLine(g, { x1: 0, x2: 0 }, { x1: c, x2: h });
                    }
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (var f = 0, x = 0, b = t.globals.gridWidth, m = 0; m < t.globals.dataPoints + 1; m++) {
                    ...
                    s.add(v),
                      ...
                      this.animY && this.animateLine(v, { y1: f + 20, y2: x + 20 }, { y1: f, y2: x }),
                  ...
                  if (t.globals.timelineLabels.length > 0)
                    for (var A = 0; A < r; A++) {
                      if (
                        ...
                        t.config.grid.xaxis.lines.show && w > 0 && w < t.globals.gridWidth)
                      ) {
                        var S = e.drawLine(w, 0, y, k, t.config.grid.borderColor, i);
                        S.node.classList.add('apexcharts-gridline'),
                          n.add(S),
                          this.animX && this.animateLine(S, { x1: 0, x2: 0 }, { x1: w, x2: y });
                      }
                    ...
                    for (var L = r, P = 0; P < L; P++) {
                      ...
                      if (t.config.grid.xaxis.lines.show) {
                        ...
                        E.node.classList.add('apexcharts-gridline'),
                          n.add(E),
                          this.animX && this.animateLine(E, { x1: 0, x2: 0 }, { x1: w, x2: y });
                      }
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (var M = 0, T = 0, I = t.globals.gridWidth, X = 0; X < o + 1; X++) {
                    ...
                    s.add(Y),
                      ...
                      this.animY && this.animateLine(Y, { y1: M + 20, y2: T + 20 }, { y1: M, y2: T }),
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  ...
                  var h = void 0;
                  'dark' === r ? ((h = e.shadeColor(-1 * o, s)), (o += n)) : ((h = e.shadeColor(o, s)), (o += n)),
                    i.push(h);
                }
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                (null === i &&
                  (i =
                    ('bar' === a.config.chart.type && a.config.plotOptions.bar.distributed) ||
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var a = i.allTooltipSeriesGroups, s = 0; s < a.length; s++)
                'enable' === t
                  ? (a[s].classList.add('active'), (a[s].style.display = e.config.tooltip.items.display))
                  : (a[s].classList.remove('active'), (a[s].style.display = 'none'));
            },
          },
        ]),
        t
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              this.printLabels({ i: n, j: o, values: h, ttItems: a, shared: i });
              var c = this.ttCtx.getElTooltip();
              (this.ttCtx.tooltipRect.ttWidth = c.getBoundingClientRect().width),
                (this.ttCtx.tooltipRect.ttHeight = c.getBoundingClientRect().height);
            },
          },
          {
            key: 'printLabels',
              ...
              for (var g = 0, f = o.globals.series.length - 1; g < o.globals.series.length; g++, f--) {
                ...
                if (((d = this.getSeriesName({ fn: p.yLbTitleFormatter, index: i, seriesIndex: i, j: a })), r)) {
                  ...
                  (p = this.getFormatters(x)),
                    ...
                    ((this.ttCtx.hasBars() && o.config.chart.stacked && 0 === o.globals.series[x][a]) ||
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (f = a[i].children),
                ...
                h.blxaxisTooltip && (h.xaxisTooltipText.innerHTML = '' !== u ? u : d);
              ...
              null !== g) &&
                ...
                (a[i].querySelector('.apexcharts-tooltip-text-z-value').innerHTML = void 0 !== g ? g : ''));
              r &&
                f[0] &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a.globals.isXNumeric && 'datetime' === a.config.xaxis.type
                ? (n = new O(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, c, c))
                : a.globals.isBarHorizontal || (n = a.globals.xLabelFormatter(c, l));
              return (
                ...
                a.globals.seriesZ.length > 0 && a.globals.seriesZ[0].length > 0 && (r = h(a.globals.seriesZ[e][i], a)),
                {
                  ...
                  xVal: n,
                  xAxisTTVal:
                    'function' == typeof a.config.xaxis.tooltip.formatter ? a.globals.xaxisTooltipFormatter(c, l) : n,
                  zVal: r,
                }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              a && r[e] && (r = s.config.tooltip.custom[e]),
                (n.innerHTML = r({ ctx: this.ctx, series: s.globals.series, seriesIndex: e, dataPointIndex: i, w: s }));
            },
          },
        ]),
        t
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.ttCtx;
              null !== e.ycrosshairs &&
                (p.setAttrs(e.ycrosshairs, { y1: t, y2: t }), p.setAttrs(e.ycrosshairsHidden, { y1: t, y2: t }));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                l > a.globals.gridWidth - r.ttWidth - 10 && (l = a.globals.gridWidth - r.ttWidth),
                l < -20 && (l = -20),
              ...
              (l = d.x),
                (h = d.y),
                isNaN(l) || ((l += a.globals.translateX), (n.style.left = l + 'px'), (n.style.top = h + 'px'));
            },
          },
          {
            key: 'positionChecks',
            value: function (t, e, i) {
              var a = this.w;
              return (
                t.ttHeight + i > a.globals.gridHeight && (i = a.globals.gridHeight - t.ttHeight + a.globals.translateY),
                i < 0 && (i = 0),
                { x: e, y: i }
              );
            },
              ...
              if (i.globals.markers.size[t] > 0)
                for (
                  ...
                  parseInt(s[n].getAttribute('rel')) === e &&
                    (a.marker.resetPointsSize(), a.marker.enlargeCurrentPoint(e, s[n]));
            ...
            value: function (t, e) {
              ...
              if (
                ...
                !s.config.series[e].type ||
                  ('column' !== s.config.series[e].type && 'candlestick' !== s.config.series[e].type))
              ) {
                ...
                l && (l.setAttribute('r', o), l.setAttribute('cx', i), l.setAttribute('cy', a)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                null !==
                (l = null !== h ? h : a.globals.dom.baseEl.querySelectorAll('.apexcharts-series-markers circle'))
              )
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              void 0 === a && (a = i.globals.markers.size[n] + i.config.markers.hover.sizeOffset),
                s.setAttribute('r', a);
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (a.target.classList.contains('apexcharts-marker')) {
                ...
                if (
                  ...
                  (e = parseInt(s.paths.parentNode.parentNode.parentNode.getAttribute('rel')) - 1),
                  l.intersect)
                ) {
              ...
              if (
                ...
                !x ||
                  ...
                  r.tooltipRect.ttHeight + c > n.globals.gridHeight
                    ? ((c = n.globals.gridHeight - r.tooltipRect.ttHeight + n.globals.translateY),
                      (o.style.top = c + 'px'))
                ...
                (s = parseInt(u.getAttribute('j'))),
                  ...
                  a.config.tooltip.followCursor
                    ? a.globals.isBarHorizontal
                      ? ((o = v - f.left + 15),
                        (l = m - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2))
                      : ((o = a.globals.isXNumeric ? b - x / 2 : b - n.dataPointsDividedWidth + x / 2),
                        (l = e.clientY - f.top - n.tooltipRect.ttHeight / 2 - 15))
                    : a.globals.isBarHorizontal
                      ? ((o = b) < n.xyRatios.baseLineInvertedY && (o = b - n.tooltipRect.ttWidth),
                        (l = m - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2))
                      : ((o = a.globals.isXNumeric ? b - x / 2 : b - n.dataPointsDividedWidth + x / 2), (l = m));
              }
            ...
            value: function () {
              ...
              if (this.showOnIntersect) {
                ...
                g.length > 0 && this.addPathsEventListeners(g, h),
                  this.hasBars() && !this.tConfig.shared && this.addBarsEventListeners(h);
              }
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                this.tConfig.fixed.position.toLowerCase().indexOf('right') > -1 &&
                  (n = n + t.globals.svgWidth - a + 10),
                this.tConfig.fixed.position.toLowerCase().indexOf('bottom') > -1 &&
                  (r = r + t.globals.svgHeight - s - 10),
                (e.style.left = n + 'px'),
                (e.style.top = r + 'px'),
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  ...
                  'mousemove' === s.type || 'touchmove' === s.type || 'mouseup' === s.type)
                ) {
                  if (
                    ...
                    this.hasBars && this.intersect.handleBarTooltip({ e: s, opt: n }),
                      this.hasMarkers && this.intersect.handleMarkerTooltip({ e: s, opt: n, x: i, y: a });
            ...
            value: function (t, e, i, a, s) {
              ...
              if (r.config.legend.tooltipHoverFormatter) {
                ...
                for (var u = 0; u < d.length; u++) {
                  var g = d[u],
                    ...
                    b = c(x, { seriesIndex: n ? f : i, dataPointIndex: a, w: r });
              ...
              if (n) {
                ...
                o.tooltipLabels.drawSeriesTexts({ shared: !1, ttItems: s, i: i, j: a }),
                  this.hasBars() && o.tooltipPosition.moveStickyTooltipOverBars(a),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.config.chart.group || (n.yaxis = r),
                ...
                this.ctx._updateOptions(n, !1, this.w.config.chart.animations.dynamicAnimation.enabled),
        ...
        a(i, [
            ...
            value: function (t, e) {
              ...
              if (
                (e.shiftKey
                  ...
                  : this.shiftWasPressed && (s.enableZooming(), (this.shiftWasPressed = !1)),
                !(
                  ...
                  ((('mousemove' === e.type && 1 === e.which) || 'touchmove' === e.type) &&
                    ...
                    i.globals.panEnabled
                      ? ((i.globals.selection = null),
                        a.w.globals.mousedown && a.panDragging({ context: a, zoomtype: n, xyRatios: t }))
                      : ((a.w.globals.mousedown && i.globals.zoomEnabled) ||
                          (a.w.globals.mousedown && i.globals.selectionEnabled)) &&
                        (a.selection = a.selectionDrawing({ context: a, zoomtype: n }))),
            ...
            value: function (t) {
              ...
              if (
                (a.config.yaxis.forEach(function (t, e) {
                  d.push(Math.floor(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.startY)),
                    g.push(Math.floor(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.endY));
                }),
                ...
                if (a.globals.zoomEnabled) {
                  ...
                  a.config.chart.group || (m.yaxis = f),
                    s.ctx._updateOptions(m, !1, s.w.config.chart.animations.dynamicAnimation.enabled),
                    'function' == typeof a.config.chart.events.zoomed && r.zoomCallback(p, f),
                    (a.globals.zoomed = !0);
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              var r = { min: e, max: i };
              a.config.chart.zoom.autoScaleYaxis && (n = new j(this.ctx).autoScaleY(this.ctx, n, { xaxis: r }));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ('left' === i.align
                  ? ((a = 10), (n = 'start'))
                  : 'right' === i.align && ((a = e.globals.svgWidth - 10), (n = 'end')),
                (a += i.offsetX),
  ...
  (nt = 'undefined' != typeof window ? window : void 0),
    (rt = function (e, i) {
        ...
        a.extend(a.PointArray, {
          ...
          size: function (t, e) {
            ...
            for (i = this.value.length - 1; i >= 0; i--)
              a.width && (this.value[i][0] = ((this.value[i][0] - a.x) * t) / a.width + a.x),
                a.height && (this.value[i][1] = ((this.value[i][1] - a.y) * e) / a.height + a.y);
            return this;
          },
          bbox: function () {
            return (
      ...
      (a.PathArray = function (t, e) {
        ...
        a.extend(a.PathArray, {
                    ...
                    : 'V' == a
                      ...
                      : 'C' == a || 'S' == a || 'Q' == a
                        ? ((this.value[s][1] += t),
                          ...
                          (this.value[s][3] += t),
                          (this.value[s][4] += e),
                          'C' == a && ((this.value[s][5] += t), (this.value[s][6] += e)))
                  ...
                  : 'V' == a
                    ...
                    : 'C' == a || 'S' == a || 'Q' == a
                      ? ((this.value[i][1] = ((this.value[i][1] - s.x) * t) / s.width + s.x),
                        ...
                        'C' == a &&
                          ((this.value[i][5] = ((this.value[i][5] - s.x) * t) / s.width + s.x),
                          (this.value[i][6] = ((this.value[i][6] - s.y) * e) / s.height + s.y)))
                      : 'A' == a &&
          ...
          equalCommands: function (t) {
            var e, i, s;
            for (
              t = new a.PathArray(t), s = this.value.length === t.value.length, e = 0, i = this.value.length;
              s && e < i;
              e++
            )
          ...
          morph: function (t) {
            return (
              (t = new a.PathArray(t)), this.equalCommands(t) ? (this.destination = t) : (this.destination = null), this
            );
          },
          at: function (t) {
            if (!this.destination) return this;
          ...
          parse: function (t) {
            ...
            do {
              a.regex.isPathLetter.test(t[l]) ? ((e = t[l]), ++l) : 'M' == e ? (e = 'L') : 'm' == e && (e = 'l'),
                n.push(s[e].call(null, t.slice(l, (l += i[e.toUpperCase()])).map(parseFloat), r, o));
            } while (c > l);
            return n;
          },
          bbox: function () {
        ...
        (a.FX = a.invent({
          ...
          extend: {
            animate: function (e, i, s) {
              ...
              var n = new a.Situation({ duration: e || 1e3, delay: s || 0, ease: a.easing[i || '-'] || i });
              return this.queue(n), this;
            },
            delay: function (t) {
              var e = new a.Situation({ duration: t, delay: 0, ease: a.easing['-'] });
              return this.queue(e);
            },
            target: function (t) {
            ...
            initAnimations: function () {
              ...
              for (t in s.animations)
                for (
                  i = this.target()[t](),
                    Array.isArray(i) || (i = [i]),
                    Array.isArray(s.animations[t]) || (s.animations[t] = [s.animations[t]]),
                    e = i.length;
                  e--;

                )
                  s.animations[t][e] instanceof a.Number && (i[e] = new a.Number(i[e])),
            ...
            step: function (t) {
              ...
              for (var n in this.situation.once)
                n > this.lastPos &&
                  n <= s &&
                  (this.situation.once[n].call(this.target(), this.pos, s), delete this.situation.once[n]);
              return (
                this.active &&
              ...
              if (r.transforms.length) {
                for (i = r.initialTransformation, t = 0, e = r.transforms.length; t < e; t++) {
                  ...
                  o instanceof a.Matrix
                    ? (i = o.relative
                        ? i.multiply(new a.Matrix().morph(o).at(r.ease(this.pos)))
        ...
        a.extend(a.FX, {
          ...
          x: function (t, e) {
            if (this.target() instanceof a.G) return this.transform({ x: t }, e), this;
            var i = new a.Number(t);
            return (i.relative = e), this.add('x', i);
          },
          y: function (t, e) {
            if (this.target() instanceof a.G) return this.transform({ y: t }, e), this;
            var i = new a.Number(t);
          ...
          size: function (t, e) {
            ...
            this.target() instanceof a.Text
              ...
              : ((t && e) || (i = this.target().bbox()),
                ...
                this.add('width', new a.Number(t)).add('height', new a.Number(e)));
            return this;
          },
          width: function (t) {
        ...
        (a.RBox = a.invent({
          create: function (t) {
            a.Box.apply(this, [].slice.call(arguments)),
              t instanceof a.Element && a.Box.call(this, t.node.getBoundingClientRect());
          },
          inherit: a.Box,
          parent: a.Element,
          extend: {
        ...
        (a.Matrix = a.invent({
          ...
          extend: {
            ...
            scale: function (t, e, i, s) {
              return (
                1 == arguments.length ? (e = t) : 3 == arguments.length && ((s = i), (i = e), (e = t)),
            ...
            rotate: function (t, e, i) {
              return (
                (t = a.utils.radians(t)),
                this.around(e, i, new a.Matrix(Math.cos(t), Math.sin(t), -Math.sin(t), Math.cos(t), 0, 0))
              );
            },
            flip: function (t, e) {
              return 'x' == t
            ...
            skew: function (t, e, i, s) {
              return (
                ...
                (t = a.utils.radians(t)),
                (e = a.utils.radians(e)),
                this.around(i, s, new a.Matrix(1, Math.tan(e), Math.tan(t), 1, 0, 0))
              );
            },
        ...
        a.extend(a.Element, {
          transform: function (e, i) {
            ...
            if (((s = new a.Matrix(this)), (i = !!i || !!e.relative), null != e.a))
              s = i ? s.multiply(new a.Matrix(e)) : new a.Matrix(e);
            else if (null != e.rotation)
              x(e, this),
                (s = i ? s.rotate(e.rotation, e.cx, e.cy) : s.rotate(e.rotation - s.extract().rotation, e.cx, e.cy));
              ...
              e.flip
                ...
                : (null == e.x && null == e.y) ||
                  (i ? (s = s.translate(e.x, e.y)) : (null != e.x && (s.e = e.x), null != e.y && (s.f = e.y)));
        ...
        a.extend(a.FX, {
          transform: function (e, i) {
            var s,
              ...
              r = this.target();
            return 'object' !== t(e)
              ? ((s = new a.Matrix(r).extract()), 'string' == typeof e ? s[e] : s)
              : ((i = !!i || !!e.relative),
                null != e.a
                  ? (s = new a.Matrix(e))
                  : null != e.rotation
                        ...
                        : e.flip
                          ? ('x' == e.flip || 'y' == e.flip
                              ...
                              : null == e.offset
                                ...
                                : (e.flip = e.offset),
                            (s = new a.Matrix().flip(e.flip, e.offset)))
                          : (null == e.x && null == e.y) || (s = new a.Translate(e.x, e.y)),
                s ? ((s.relative = i), this.last().transforms.push(s), this._callStart()) : this);
          },
        }),
        a.extend(a.Element, {
        ...
        (a.Transformation = a.invent({
          ...
          extend: {
            ...
            at: function (t) {
              ...
              return (
                (n = new a.Matrix().morph(a.Matrix.prototype[this.method].apply(n, e)).at(t)),
          ...
          extend: {
            ...
            at: function (t) {
              var e = new a.Matrix().rotate(
                new a.Number().morph(this.rotation - (this._undo ? this._undo.rotation : 0)).at(t),
                this.cx,
                this.cy,
              );
          ...
          extend: {
            ...
            each: function (t, e) {
              ...
              for (i = 0, s = n.length; i < s; i++)
                n[i] instanceof a.Element && t.apply(n[i], [i, n]), e && n[i] instanceof a.Container && n[i].each(t, e);
              return this;
            },
          ...
          create: function (e) {
            ...
            if (e instanceof a.Element) {
              for (
                ...
                (c *= n.value),
                  (n = new a.Number(l instanceof a.Doc ? l.parent().offsetWidth : l.parent().width())),
                  (l = l.parent());
              for (; '%' == r.unit; )
                (d *= r.value),
                  (r = new a.Number(h instanceof a.Doc ? h.parent().offsetHeight : h.parent().height())),
                  (h = h.parent());
              (this.x = 0),
                (this.y = 0),
                (this.width = n * c),
        ...
        (a.off = function (t, e, i) {
          ...
          if (-1 != s)
            if (i) {
              ...
              a.listeners[s][n] &&
                a.listeners[s][n][r || '*'] &&
                (t.removeEventListener(n, a.listeners[s][n][r || '*'][i], !1), delete a.listeners[s][n][r || '*'][i]);
            } else if (r && n) {
              if (a.listeners[s][n] && a.listeners[s][n][r]) {
                for (i in a.listeners[s][n][r]) a.off(t, [n, r].join('.'), i);
                delete a.listeners[s][n][r];
              }
            } else if (r) for (e in a.listeners[s]) for (o in a.listeners[s][e]) r === o && a.off(t, [e, r].join('.'));
            else if (n) {
              if (a.listeners[s][n]) {
        ...
        a.extend(a.Element, {
          maskWith: function (t) {
            return (
              (this.masker = t instanceof a.Mask ? t : this.parent().mask().add(t)),
        ...
        a.extend(a.Element, {
          clipWith: function (t) {
            return (
              (this.clipper = t instanceof a.ClipPath ? t : this.parent().clip().add(t)),
        ...
        (a.TextPath = a.invent({
          ...
          construct: {
            morphArray: a.PathArray,
            path: function (t) {
              for (var e = new a.TextPath(), i = this.doc().defs().path(t); this.node.hasChildNodes(); )
        ...
        a.extend(a.Line, a.Polyline, a.Polygon, a.Path, {
          marker: function (t, e, i, s) {
            ...
            return (
              'all' != t && n.push(t),
              (n = n.join('-')),
              (t = arguments[1] instanceof a.Marker ? arguments[1] : this.doc().marker(e, i, s)),
              this.attr(n, t)
            );
          },
        });
        ...
        a.extend(a.Element, {
          data: function (e, i, a) {
            if ('object' === t(e)) for (i in e) this.data(i, e[i]);
              ...
              this.attr(
                'data-' + e,
                null === i ? null : !0 === a || 'string' == typeof i || 'number' == typeof i ? i : JSON.stringify(i),
              );
            return this;
          },
        }),
      ...
      return (
        (function (t) {
          for (var i = 0, a = ['moz', 'webkit'], s = 0; s < a.length && !e.requestAnimationFrame; ++s)
            (t.requestAnimationFrame = t[a[s] + 'RequestAnimationFrame']),
              (t.cancelAnimationFrame = t[a[s] + 'CancelAnimationFrame'] || t[a[s] + 'CancelRequestAnimationFrame']);
          ...
          case 'A':
            t = (e = (function (t, e) {
              var i,
                ...
                R = new SVG.Point(X, Y),
                D = [];
              if (0 === z || 0 === E || (F.x === R.x && F.y === R.y)) return [['C', F.x, F.y, R.x, R.y, R.x, R.y]];
              (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(new SVG.Matrix().rotate(M))),
                (a = (i.x * i.x) / (z * z) + (i.y * i.y) / (E * E)) > 1 && ((a = Math.sqrt(a)), (z *= a), (E *= a));
              (s = new SVG.Matrix()
                .rotate(M)
                .scale(1 / z, 1 / E)
                .rotate(-M)),
          ...
          if ('function' == typeof n) {
            ...
            'object' == typeof n &&
              (null != n.minX && a < n.minX
                ...
                : null != n.maxX && a > n.maxX - e.width && (r = (a = n.maxX - e.width) - this.startPoints.box.x),
              null != n.minY && s < n.minY
                ? (o = (s = n.minY) - this.startPoints.box.y)
                : null != n.maxY && s > n.maxY - e.height && (o = (s = n.maxY - e.height) - this.startPoints.box.y),
              null != n.snapToGrid &&
                ((a -= a % n.snapToGrid), (s -= s % n.snapToGrid), (r -= r % n.snapToGrid), (o -= o % n.snapToGrid)),
          ...
          (t.prototype.checkAspectRatio = function (t, e) {
            ...
            return (
              r < a
                ...
                : r > a && ((i[0] = this.parameters.box.width - n * a), e && (i[0] = -i[0])),
              i
            );
          }),
          SVG.extend(SVG.Element, {
        ...
        (function (t) {
          if ('Element' in t) {
            var e = t.Element.prototype,
              ...
              o = function (t) {
                for (
                  var e = a.call(t.getAttribute('class') || ''), i = e ? e.split(/\s+/) : [], s = 0, n = i.length;
                  s < n;
                  s++
                )
                  this.push(i[s]);
        ...
        (window.removeResizeListener = function (t, i) {
          t &&
            ...
            t.__resizeListeners__.length ||
              (t.removeEventListener('scroll', e), (t.__resizeTriggers__ = !t.removeChild(t.__resizeTriggers__))));
        });
    })(),
    (window.Apex = {}),
    (function () {
          ...
          [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                var a = this.w.globals;
                if (
                  ((a.noData = !1), (a.animationEnded = !1), this.responsive.checkResponsiveConfig(e), null === this.el)
                )
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  n.globals.collapsedSeriesIndices.length > 0 && this.clearPreviousPaths(),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                s && (r = this.getSyncedCharts()),
                  this.w.globals.isExecCalled && ((r = [this]), (this.w.globals.isExecCalled = !1)),
                  r.forEach(function (s) {
                    var r = s.w;
                    return (
                      (r.globals.shouldAnimate = a),
                      i || ((r.globals.resized = !0), (r.globals.dataChanged = !0), a && s.series.getPreviousPaths()),
                      e &&
                        'object' === t(e) &&
                        ((s.config = new k(e)),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  a &&
                    ((s.globals.initialConfig.series = JSON.parse(JSON.stringify(s.config.series))),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                for (var a = i.w.config.series.slice(), s = 0; s < a.length; s++)
                  if (void 0 !== t[s]) for (var n = 0; n < t[s].data.length; n++) a[s].data.push(t[s].data[n]);
                return (
                  (i.w.config.series = a),
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  e = this.w;
                (e.config.xaxis.min = this.opts.xaxis.min || (Apex.xaxis && Apex.xaxis.min)),
                  (e.config.xaxis.max = this.opts.xaxis.max || (Apex.xaxis && Apex.xaxis.max)),
                  e.config.yaxis.map(function (i, a) {
                    e.globals.zoomed &&
                      void 0 !== t.opts.yaxis[a] &&
                      ((i.min = t.opts.yaxis[a].min), (i.max = t.opts.yaxis[a].max));
                  });
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                i.globals.axisCharts
                  ...
                  : ((a = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "']"))
                      .members[0]),
                    ('pie' === i.config.chart.type || 'donut' === i.config.chart.type) &&
