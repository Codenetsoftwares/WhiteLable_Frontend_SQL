...
!(function (t, e) {
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                t.unfilter(!0),
                g.isIE() && 'radialBar' === h.config.chart.type
                  ? t
                  : ((n = Array.isArray(n) ? n[i] : n),
                    t.filter(function (t) {
                      var e = null;
                      (e =
                        g.isSafari() || g.isFirefox() || g.isIE()
                          ? t.flood(n, o).composite(t.sourceAlpha, 'in').offset(s, a).gaussianBlur(r)
                          : t.flood(n, o).composite(t.sourceAlpha, 'in').offset(s, a).gaussianBlur(r).merge(t.source)),
                        t.blend(t.source, e);
                    }),
        ...
        a(t, [
            ...
            value: function (t) {
              ...
              h.config.chart.animations.animateGradually.enabled &&
                ...
                this.morphSVG(
                  ...
                  i,
                  a,
                  'line' !== h.config.chart.type || h.globals.comboCharts ? s : 'stroke',
                  r,
                  n,
                  o,
                  l * c,
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, n, o) {
              ...
              (!s || s.indexOf('undefined') > -1 || s.indexOf('NaN') > -1) && (s = c()),
                (r.indexOf('undefined') > -1 || r.indexOf('NaN') > -1) && (r = c()),
                ...
                t
                  ...
                  .afterAll(function () {
                    g.isNumber(i)
                      ? i === h.globals.series[h.globals.maxValsInArrayIndex].length - 2 &&
                        h.globals.shouldAnimate &&
                        l.animationCompleted(t)
                      : 'none' !== a &&
                        h.globals.shouldAnimate &&
                        ((!h.globals.comboCharts && e === h.globals.series.length - 1) || h.globals.comboCharts) &&
                        l.animationCompleted(t),
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (M.attr('index', a),
                  m && M.attr({ 'clip-path': 'url(#gridRectMask'.concat(A.globals.cuid, ')') }),
                  ...
                  (!A.config.chart.dropShadow.enabledOnSeries ||
                    (A.config.chart.dropShadow.enabledOnSeries &&
                      -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a)))
                ) {
                  var X = A.config.chart.dropShadow;
                  S.dropShadow(M, X, a);
                }
                y &&
                  (M.node.addEventListener('mouseenter', this.pathMouseEnter.bind(this, M)),
                  M.node.addEventListener('mouseleave', this.pathMouseLeave.bind(this, M)),
                  M.node.addEventListener('mousedown', this.pathMouseDown.bind(this, M))),
                  M.attr({ pathTo: r, pathFrom: s });
                var E = { el: M, j: i, realIndex: a, pathFrom: s, pathTo: r, fill: c, strokeWidth: l, delay: d };
                return (
                  !L || A.globals.resized || A.globals.dataChanged
                    ? (!A.globals.resized && A.globals.dataChanged) || C.showDelayedElements()
                    : C.animatePathsGradually(n({}, E, { speed: g })),
                  A.globals.dataChanged && P && T && C.animatePathsGradually(n({}, E, { speed: p })),
                  M
                );
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, i, a, s) {
                var r,
                  ...
                  c = this.w;
                e.length < 9 && 0 === e.indexOf('#') && (e = g.hexToRgba(e, a)),
                  i.length < 9 && 0 === i.indexOf('#') && (i = g.hexToRgba(i, s));
                var d = 0,
                  u = 1,
                  f = 1,
                  p = null;
                ...
                if (
                  ...
                  'bubble' !== c.config.chart.type
                    ? r.attr({ gradientUnits: 'userSpaceOnUse', cx: b, cy: m, r: n })
              ...
              value: function (t, e) {
                ...
                if (
                  ('function' == typeof i.config.chart.events.dataPointMouseEnter &&
                    i.config.chart.events.dataPointMouseEnter(e, this.ctx, { seriesIndex: s, dataPointIndex: r, w: i }),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                'function' == typeof i.config.chart.events.dataPointMouseLeave &&
                  i.config.chart.events.dataPointMouseLeave(e, this.ctx, { seriesIndex: s, dataPointIndex: r, w: i }),
                  ...
                  ('none' !== i.config.states.active.filter.type && 'true' === t.node.getAttribute('selected')) ||
                    ('none' !== i.config.states.hover.filter.type && a.getDefaultFilter(t, s));
              },
            },
            {
              key: 'pathMouseDown',
            ...
            },
            {
              ...
              value: function (t, e, i) {
                if (
                  ...
                  ((t.textContent = e), e.length > 0 && t.getComputedTextLength() >= i / 0.8)
                ) {
                  for (var a = e.length - 3; a > 0; a -= 3)
                    if (t.getSubStringLength(0, a) <= i / 0.8) return void (t.textContent = e.substring(0, a) + '...');
                  t.textContent = '.';
                }
              },
            },
              ...
              if ('vertical' === t.label.orientation) {
                var a = null !== e ? e : 0,
                  s = i.globals.dom.baseEl.querySelector(
                    ".apexcharts-xaxis-annotations .apexcharts-xaxis-annotation-label[rel='".concat(a, "']"),
                  );
                if (null !== s) {
                  var r = s.getBoundingClientRect();
                  s.setAttribute('x', parseFloat(s.getAttribute('x')) - r.height + 4),
                    'top' === t.label.position
                      ? s.setAttribute('y', parseFloat(s.getAttribute('y')) + r.width)
                      : s.setAttribute('y', parseFloat(s.getAttribute('y')) - r.width);
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              var l = t.label.text;
              ('category' !== a.config.xaxis.type && !a.config.xaxis.convertedCatToNumeric) ||
                this.invertAxis ||
              ...
              if (g.isNumber(o)) {
                if (null === t.x2 || void 0 === t.x2) {
                  ...
                  if (
                    (this.annoCtx.inversedReversedAxis && (d = (r - t.x2) / (n / a.globals.gridWidth)),
                    ('category' !== a.config.xaxis.type && !a.config.xaxis.convertedCatToNumeric) ||
                      this.invertAxis ||
                      a.globals.dataFormatXNumeric ||
                  ...
                  f.node.classList.add('apexcharts-annotation-rect'),
                    f.attr('clip-path', 'url(#gridRectMask'.concat(a.globals.cuid, ')')),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  o.push(-s.minY / r[0]),
                    s.minY !== Number.MIN_VALUE && 0 !== Math.abs(s.minY) && ((l = -s.minY / t), (h = s.minX / e));
                return {
                  yRatio: r,
                  invertedYRatio: t,
                  zRatio: n,
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  (Math.log(i.globals.maxYArr[e]) - Math.log(i.globals.minYArr[e]))
                );
              },
            },
            {
            ...
            value: function (t, e) {
              ...
              if (this.annoCtx.invertAxis) {
                ...
                if (s.config.yaxis[e.yAxisIndex].logarithmic)
                  o = (a = new m(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex];
                else
                  o = (a - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight);
                (i = s.globals.gridHeight - o),
                  s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (i = o);
              }
              return i;
            },
          },
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if ('string' == typeof t.x) {
                ...
                a.config.xaxis.convertedCatToNumeric && (h = a.globals.categoryLabels.indexOf(t.x)),
              ...
              a.config.yaxis[t.yAxisIndex].logarithmic
                ? (o = (l = new m(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex])
                : (o = (l - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight));
              if (
                ((r = a.globals.gridHeight - o - parseFloat(t.label.style.fontSize) - t.marker.size),
                (n = a.globals.gridHeight - o),
                a.config.yaxis[t.yAxisIndex] &&
                  a.config.yaxis[t.yAxisIndex].reversed &&
                  ((r = o + parseFloat(t.label.style.fontSize) + t.marker.size), (n = o)),
                g.isNumber(s))
              ) {
                var c = {
                    pSize: t.marker.size,
  ...
  var w,
    ...
    C = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.helpers = new x(this)),
          (this.xAxisAnnotations = new b(this)),
          (this.yAxisAnnotations = new v(this)),
          (this.pointsAnnotations = new y(this)),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = {
                ...
                a = this.w;
              String(i.width).indexOf('%') > -1 &&
                (i.width = (parseInt(i.width, 10) * parseInt(a.globals.svgWidth, 10)) / 100);
              var s = null;
              s =
                'circle' === i.type
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              p && p.appendChild(f.node),
                t.draggable &&
                  (this.helpers.makeAnnotationDraggable(f, 'images', e),
                  f.node.classList.add('apexcharts-resizable-element'));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.params,
                ...
                d = Object.assign(
                  {},
                  'xaxis' === s ? c.xAxisAnnotation : 'yaxis' === s ? c.yAxisAnnotation : c.pointAnnotation,
                ),
                u = g.extend(d, e);
              switch (s) {
                case 'xaxis':
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              h.appendChild(c),
                ...
                p.setAttrs(c, { x: 0, y: 0, preserveAspectRatio: 'none', width: o + 'px', height: l + 'px' }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              'function' == typeof n &&
                (n = n({ seriesIndex: this.seriesIndex, dataPointIndex: t.dataPointIndex, value: t.value, w: e }));
              ...
              if (
                (t.color && (n = t.color),
                -1 === n.indexOf('rgb')
                  ? n.length < 9 && (h = g.hexToRgba(n, l))
                  : n.indexOf('rgba') > -1 && (l = g.getOpacityFromRGBA(n)),
                t.opacity && (l = t.opacity),
                'pattern' === o && (a = this.handlePatternFill(a, n, l, h)),
                'gradient' === o && (s = this.handleGradientFill(n, l, this.seriesIndex)),
                'image' === o)
              ) {
                ...
                t.globals.comboCharts
                  ...
                  : 'line' === e.chart.type
                    ...
                    : t.globals.fill.colors instanceof Array
                      ...
                      : a.push(t.globals.fill.colors),
                void 0 !== i.fillColors &&
                  ((a = []), i.fillColors instanceof Array ? (a = i.fillColors.slice()) : a.push(i.fillColors)),
                a
              );
            },
          },
              ...
              s.fill.pattern.style instanceof Array
                ? (t =
                    void 0 !== s.fill.pattern.style[r.seriesNumber]
                      ...
                      : a)
                : (t = n.drawPattern(s.fill.pattern.style, s.fill.pattern.width, s.fill.pattern.height, l, o, i));
              return t;
            },
          },
          {
            ...
            value: function (t, e, i) {
              ...
              h.indexOf('rgba') > -1 && (c = g.getOpacityFromRGBA(h));
              var d =
              ...
              if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length)
                ...
                var u = s.fill.gradient.gradientToColors[r.seriesNumber];
                (a = u), u.indexOf('rgba') > -1 && (d = g.getOpacityFromRGBA(u));
              }
              ...
              return (
                h.indexOf('rgb') > -1 && (h = g.rgb2hex(h)),
                a.indexOf('rgb') > -1 && (a = g.rgb2hex(a)),
                n.drawGradient(l, h, a, c, d, r.size, s.fill.gradient.stops, s.fill.gradient.colorStops, i)
              );
            },
          },
        ]),
            ...
            value: function (t, e, i, a) {
              ...
              if (
                ((n.globals.markers.size[e] > 0 || r) &&
                  (h = c.group({ class: r ? '' : 'apexcharts-series-markers' })).attr(
                    'clip-path',
                ...
                for (var d = 0; d < l.x.length; d++) {
                  ...
                  ('line' !== n.config.chart.type && 'area' !== n.config.chart.type) ||
                    ...
                    (x += ' no-pointer-events');
                  var b = Array.isArray(n.config.markers.size)
                  ...
                  if (b || r) {
                    ...
                    n.config.series[o].data[i] &&
                      (n.config.series[o].data[i].fillColor &&
                        (m.pointFillColor = n.config.series[o].data[i].fillColor),
                      n.config.series[o].data[i].strokeColor &&
                        (m.pointStrokeColor = n.config.series[o].data[i].strokeColor)),
                      a && (m.pSize = a),
                      (s = c.drawMarker(l.x[d], l.y[d], m)).attr('rel', f),
                      s.attr('j', f),
                      s.attr('index', e),
              ...
              return (
                null !== i &&
                  ...
                  n.discrete.map(function (t) {
                    t.seriesIndex === e &&
                      t.dataPointIndex === i &&
                      ((s.pointStrokeColor = t.strokeColor), (s.pointFillColor = t.fillColor), (r = t.size));
                  }),
                {
                  pSize: r,
                  pRadius: n.radius,
              ...
              if ((h.attr('clip-path', 'url(#gridRectMarkerMask'.concat(a.globals.cuid, ')')), n.x instanceof Array))
                for (var c = 0; c < n.x.length; c++) {
                  ...
                  if (o !== 1 / 0) {
                    ...
                    x.minBubbleRadius && f < x.minBubbleRadius && (f = x.minBubbleRadius),
                      x.maxBubbleRadius && f > x.maxBubbleRadius && (f = x.maxBubbleRadius);
                  }
            ...
            value: function (t, e, i, a, s, r, n) {
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  null != (C = o.globals.previousPaths[s] && o.globals.previousPaths[s][n]) &&
                  ...
                  0 === t && 0 === e && (a = 0),
                    h.animateCircle(v, { cx: k, cy: A, r: S }, { cx: t, cy: e, r: a }, T, o.globals.easing);
                } else v.attr({ r: a });
              return (
        ...
        a(t, [
          {
            ...
            value: function (t, e, i, a, s, r, n) {
              ...
              void 0 === o.globals.dataLabelsRects[a] && (o.globals.dataLabelsRects[a] = []),
                o.globals.dataLabelsRects[a].push({ x: t, y: e, width: c, height: d });
              var g = o.globals.dataLabelsRects[a].length - 2,
                u =
                  void 0 !== o.globals.lastDrawnDataLabelsIndexes[a]
                    ? o.globals.lastDrawnDataLabelsIndexes[a][o.globals.lastDrawnDataLabelsIndexes[a].length - 1]
                    : 0;
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                f && (x = this.dataLabelsCorrection(a, s, o, r, n, g, parseInt(c.style.fontSize, 10))),
                  e.globals.zoomed || ((a = x.x), (s = x.y)),
                  x.textRects && (a + x.textRects.width < -20 || a > e.globals.gridWidth + 20) && (o = '');
                var b = e.globals.dataLabels.style.colors[r];
                ((('bar' === e.config.chart.type || 'rangeBar' === e.config.chart.type) &&
                  e.config.plotOptions.bar.distributed) ||
                  e.config.dataLabels.distributed) &&
                  (b = e.globals.dataLabels.style.colors[n]),
                  d && (b = d);
                var m = c.offsetX,
                  v = c.offsetY;
                if (
                  (('bar' !== e.config.chart.type && 'rangeBar' !== e.config.chart.type) || ((m = 0), (v = 0)),
                  x.drawnextLabel)
                ) {
                  var y = i.drawText({
                    width: 100,
                  ...
                  if ((y.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }), c.dropShadow.enabled)) {
                    var w = c.dropShadow;
          ...
          },
          {
            ...
            value: function () {
              for (
                var t = this.w,
                  e = t.globals.dom.baseEl.getElementsByClassName('apexcharts-datalabels'),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              f.globals.isXNumeric &&
                ...
                ((m = e + parseFloat(c * (g + 1))), (v = i + parseFloat(h * (g + 1)) - b));
              var y = e,
                w = i,
                k = {},
              ...
              if (f.config.dataLabels.enabled) {
                ...
                P = x.getTextRects(f.globals.yLabelFormatters[0](T), parseFloat(A.style.fontSize));
              }
              var z = {
                x: e,
                y: i,
              ...
              return (
                ...
                u.attr({ cy: k.bcy, cx: k.bcx, j: n, val: l[r][n], barHeight: h, barWidth: c }),
            ...
            value: function (t) {
              ...
              return (
                i.config.chart.stacked ||
                  (c < 0 ? (c = 0 + g) : c + h.height / 3 > i.globals.gridHeight && (c = i.globals.gridHeight - g)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var p = r - (this.barCtx.isTimelineBar ? 0 : f) + n / 2 + l.height / 2 + u - 3,
                ...
                b = i;
              switch (
                (this.barCtx.isReversed && ((b = i + o - (x ? 2 * o : 0)), (i = e.globals.gridWidth - o)), d.position)
              ) {
                case 'center':
                  h = x ? b + o / 2 - g : b - o / 2 + g;
                  break;
              ...
              return (
                e.config.chart.stacked ||
                  (h < 0
                    ? (h = h + l.width + c)
                    : h + l.width / 2 > e.globals.gridWidth && (h = e.globals.gridWidth - l.width - c)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !m) {
                ...
                var v = '';
                void 0 !== a && (v = x(a, { seriesIndex: s, dataPointIndex: r, w: d })),
                ...
                if (
                  ...
                  this.barCtx.isTimelineBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels)
                )
                  h < f.getTextRects(v, parseFloat(c.style.fontSize)).width && (v = '');
                d.config.chart.stacked &&
                  this.barCtx.barOptions.dataLabels.hideOverflowingLabels &&
                  (this.barCtx.isHorizontal
                    ? (((h = Math.abs(d.globals.series[s][r]) / this.barCtx.invertedYRatio[this.barCtx.yaxisIndex]) >
                        0 &&
                        o.width / 1.6 > h) ||
                        (h < 0 && o.width / 1.6 < h)) &&
                      (v = '')
                    : ((l = Math.abs(d.globals.series[s][r]) / this.barCtx.yRatio[this.barCtx.yaxisIndex]),
                      o.height / 1.6 > l && (v = '')));
                var k = n({}, c);
                this.barCtx.isHorizontal &&
                  a < 0 &&
      ...
      return (
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                ...
                a = this.w,
                s = g.clone(a.globals.initialSeries);
                  ...
                  ? i.globals.axisCharts
                    ? ((r = i.globals.dom.baseEl.querySelector(
                      ...
                      (n = i.globals.dom.baseEl.querySelector(
                        ".apexcharts-datalabels[data\\:realIndex='".concat(s, "']"),
                      )))
                    : (r = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(s + 1, "']")))
                  : (r = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(s + 1, "'] path")));
                for (var o = 0; o < a.length; o++) a[o].classList.add(this.legendInactiveClass);
                null !== r &&
                  (i.globals.axisCharts || r.parentNode.classList.remove(this.legendInactiveClass),
              ...
              if (e.config.series.length > 1)
                for (
                  var a = e.config.series.map(function (i, a) {
                      var s = !1;
                      return (
                        t && (s = 'bar' === e.config.series[a].type || 'column' === e.config.series[a].type),
              ...
              function e(e, i, a) {
                for (
                  var s = e[i].childNodes,
                    r = { type: a, paths: [], realIndex: e[i].getAttribute('data:realIndex') },
                    n = 0;
                  n < s.length;
                  n++
                )
              ...
              ['line', 'area', 'bar', 'candlestick', 'radar'].forEach(function (i) {
                for (
                  var a,
                    s =
                      ((a = i),
                      t.globals.dom.baseEl.querySelectorAll('.apexcharts-'.concat(a, '-series .apexcharts-series'))),
                    r = 0;
                  r < s.length;
                  r++
                )
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                'left' === e.align
                  ? ((a = 10), (r = 'start'))
                  : 'right' === e.align && ((a = t.globals.svgWidth - 10), (r = 'end')),
          ...
          },
          {
            ...
            value: function (t) {
              for (var e = this.w, i = 0; i < t.length; i++)
                if (0 === t[i].length) for (var a = 0; a < t[e.globals.maxValsInArrayIndex].length; a++) t[i].push(0);
              return t;
            },
          },
          {
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              if ((this.barCtx.isTimelineBar && (h = l.globals.labels.length), this.barCtx.isHorizontal))
                (s = (i = l.globals.gridHeight / h) / this.barCtx.seriesLen),
                  l.globals.isXNumeric &&
                    (s = (i = l.globals.gridHeight / this.barCtx.totalItems) / this.barCtx.seriesLen),
                ...
                if (
                  ...
                  l.config.xaxis.convertedCatToNumeric && (a = l.globals.gridWidth / l.globals.dataPoints),
                  (r = ((a / this.barCtx.seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100),
                  l.globals.isXNumeric)
                ) {
                  var c = this.barCtx.xRatio;
                  l.config.xaxis.convertedCatToNumeric && (c = this.barCtx.initialXRatio),
                    l.globals.minXDiff &&
                      0.5 !== l.globals.minXDiff &&
                      l.globals.minXDiff / c > 0 &&
                      (a = l.globals.minXDiff / c),
                    (r = ((a / this.barCtx.seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100) < 1 &&
                      (r = 1);
                }
                (n =
                  ...
                  (t = l.globals.padHorizontal + (a - r * this.barCtx.seriesLen) / 2);
              }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var u = { barWidth: e, strokeWidth: n, yRatio: a, barXPosition: i, y1: s, y2: r },
              ...
              return (
                d.globals.previousPaths.length > 0 && (v = this.barCtx.getPreviousPath(l, c, !1)),
                {
                  pathTo: (m =
                    ...
                    'z'),
                  pathFrom: (v =
                    v + g.line(x, s) + g.line(b - n, s) + g.line(b - n, s) + g.line(b - n, s) + g.line(x, s)),
                }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              var g = { barHeight: i, strokeWidth: r, barYPosition: e, x2: s, x1: a },
                ...
                f = d.move(u.x1, e),
                x = d.move(u.x1, e);
              c.globals.previousPaths.length > 0 && (x = this.barCtx.getPreviousPath(o, h, !1));
              var b = e,
                m = e + i;
              return {
                pathTo: (f =
                  ...
                  'z'),
                pathFrom: (x =
                  x + d.line(a, b) + d.line(a, m - r) + d.line(a, m - r) + d.line(a, m - r) + d.line(a, b)),
              };
            },
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              if ((n || (n = 0), this.barCtx.isHorizontal)) {
                ...
                if (void 0 !== i[a][s] || null !== i[a][s]) {
                  ...
                  switch (
                    ...
                    'rounded' === this.barCtx.barOptions.endingShape && (h = e.x2 - g / 2),
                    'rounded' === this.barCtx.barOptions.startingShape && (c = e.x1 + g / 2),
              ...
              if (void 0 !== i[a][s] || null !== i[a][s]) {
                ...
                switch (
                  (m && (v = -e.barWidth / 2 - n),
                  v > Math.abs(x - b) && (v = Math.abs(x - b)),
                  'rounded' === this.barCtx.barOptions.endingShape && (x += v / 2),
                  'rounded' === this.barCtx.barOptions.startingShape && (b -= v / 2),
                  this.barCtx.barOptions.endingShape)
                ) {
                  case 'flat':
    ...
    E = (function () {
      function t(i, a) {
        ...
        (this.barOptions = s.config.plotOptions.bar),
          ...
          (this.isNullValue = !1),
          (this.isTimelineBar = 'datetime' === s.config.xaxis.type && s.globals.seriesRangeBarTimeline.length),
          (this.xyRatios = a),
          null !== this.xyRatios &&
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                var h,
                  ...
                  w = a.group({
                    ...
                    rel: o + 1,
                    seriesName: g.escapeString(i.globals.seriesNames[y]),
                    'data:realIndex': y,
                  });
                this.ctx.series.addCollapsedClassToSeries(w, y), t[o].length > 0 && (this.visibleI = this.visibleI + 1);
                var k = 0,
                  A = 0;
                ...
                for (
                  var C = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': y }), L = 0;
                  L < i.globals.dataPoints;
                  L++
                ) {
                  var P = this.barHelpers.getStrokeWidth(o, L, y),
                    T = null,
                    z = { indexes: { i: o, j: L, realIndex: y, bc: l }, x: f, y: x, strokeWidth: P, elSeries: w };
                  this.isHorizontal
                    ? ((T = this.drawBarPaths(n({}, z, { barHeight: k, zeroW: u, yDivision: c }))),
                      (A = this.series[o][L] / this.invertedYRatio))
                    : ((T = this.drawColumnPaths(n({}, z, { xDivision: h, barWidth: A, zeroH: d }))),
                      (k = this.series[o][L] / this.yRatio[this.yaxisIndex])),
                    (x = T.y),
                    (f = T.x),
                    L > 0 && v.push(f + A / 2),
                    b.push(x);
                  var I = this.barHelpers.getPathFillColor(t, o, L, y);
                  this.renderSeries({
                    realIndex: y,
                    pathFill: I,
                    j: L,
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.realIndex,
                ...
                A = this.w,
                S = new p(this.ctx);
              a || (a = this.barOptions.distributed ? A.globals.stroke.colors[s] : A.globals.stroke.colors[e]),
              ...
              L.attr('clip-path', 'url(#gridRectMask'.concat(A.globals.cuid, ')')),
                void 0 !== g && void 0 !== f && (L.attr('data-range-y1', g), L.attr('data-range-y2', f)),
                new u(this.ctx).setSelectionFilter(L, e, s),
                h.add(L);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              r =
                void 0 === this.series[c][d] || null === this.series[c][d]
                  ...
                  : s +
                    ...
                    2 * (this.isReversed ? this.series[c][d] / this.invertedYRatio : 0);
              ...
              return (
                ...
                { pathTo: f.pathTo, pathFrom: f.pathFrom, x: r, y: n, barYPosition: u }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (h.globals.isXNumeric) {
                var u = c;
                h.globals.seriesX[c].length || (u = h.globals.maxValsInArrayIndex),
                  (i = (h.globals.seriesX[u][d] - h.globals.minX) / this.xRatio - (r * this.seriesLen) / 2);
              }
              ...
              a =
                void 0 === this.series[c][d] || null === this.series[c][d]
                  ...
                  : n -
                    ...
                    2 * (this.isReversed ? this.series[c][d] / this.yRatio[this.yaxisIndex] : 0);
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = (e = (e = e.replace(/(^|[^\\])MMMM+/g, '$1' + s[0])).replace(
                /(^|[^\\])MMM/g,
                '$1' + r[0],
              )).replace(/(^|[^\\])MM/g, '$1' + l(c))).replace(/(^|[^\\])M/g, '$1' + c);
              var g = a ? t.getUTCDate() : t.getDate();
              e = (e = (e = (e = e.replace(/(^|[^\\])dddd+/g, '$1' + n[0])).replace(
                /(^|[^\\])ddd/g,
                '$1' + o[0],
              ...
              (e = e.replace(/(^|[^\\])fff+/g, '$1' + l(b, 3))),
                ...
                (b = Math.round(b / 10));
              var m = u < 12 ? 'AM' : 'PM';
              e = (e = (e = e.replace(/(^|[^\\])f/g, '$1' + b)).replace(/(^|[^\\])TT+/g, '$1' + m)).replace(
                /(^|[^\\])T/g,
                '$1' + m.charAt(0),
              );
              var v = m.toLowerCase();
              ...
              return (e = (e = (e = (e = (e = e.replace(new RegExp(n[0], 'g'), n[A])).replace(
                new RegExp(o[0], 'g'),
                o[A],
              )).replace(new RegExp(s[0], 'g'), s[c])).replace(new RegExp(r[0], 'g'), r[c])).replace(/\\(.)/g, '$1'));
            },
          },
          {
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              (this.rangeBarOptions = this.w.config.plotOptions.rangeBar),
                ...
                this.barHelpers.initVariables(t);
              for (
                var s = a.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }), r = 0;
                r < t.length;
                r++
              ) {
                var o,
                ...
                for (
                  var y = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': f }), w = 0;
                  ...
                  if (((u = v.yDivision), (b = v.barHeight), this.isHorizontal)) {
                    ...
                    b = (C = this.drawRangeColumnPaths(
                      n({ indexes: { i: r, j: w, realIndex: f }, zeroH: l, barWidth: m, xDivision: o }, P),
                    )).barHeight;
                  (d = C.y), (c = C.x);
            ...
            value: function (t) {
              ...
              return (
                ...
                u > -1 &&
                  ...
                  (h = l.globals.seriesRangeBarTimeline[e][u].overlaps).indexOf(c) > -1 &&
                  (a =
                    (r = o.barHeight / h.length) * this.visibleI +
                    (n * (100 - parseInt(this.barOptions.barHeight, 10))) / 100 / 2 +
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { pathTo: x.pathTo, pathFrom: x.pathFrom, barHeight: p, x: i, y: u, barXPosition: f }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                h.globals.isXNumeric || (i += r), { pathTo: u.pathTo, pathFrom: u.pathFrom, barWidth: g, x: d, y: i }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              'function' == typeof g && (c = g(c, u)),
                s &&
                  ...
                  ((o = s),
                  (l = r),
                  n.config.series[i].data[a].x && (h = n.config.series[i].data[a].x + ':'),
              ...
              return { start: o, end: l, startVal: f, endVal: p, ylabel: h, color: x, seriesName: c };
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              return {
                ...
                fill: {
                  opacity: 1,
                  gradient: { shade: 'light', shadeIntensity: 0.35, stops: [80, 100], opacityFrom: 1, opacityTo: 1 },
                },
                tooltip: { theme: 'dark', fillSeriesColor: !0 },
                legend: { position: 'right' },
              };
        ...
        a(i, [
            ...
            value: function (e) {
              ...
              (this.chartType = a.chart.type),
                'histogram' === this.chartType &&
                  ((a.chart.type = 'bar'), (a = g.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, a))),
              ...
              if (a && 'object' === t(a)) {
                ...
                (l =
                  ...
                  (((a = this.checkForCatToNumericXAxis(this.chartType, l, a)).chart.sparkline &&
            ...
            value: function (t, e) {
              ...
              (void 0 === t.yaxis || !t.yaxis || (Array.isArray(t.yaxis) && 0 === t.yaxis.length)) && (t.yaxis = {}),
                t.yaxis.constructor !== Array &&
                  ...
                  (t.yaxis = g.extend(t.yaxis, window.Apex.yaxis)),
                t.yaxis.constructor !== Array
                  ? (t.yaxis = [g.extend(i.yAxis, t.yaxis)])
              ...
              return (
                ...
                a &&
                  ...
                  (t.yaxis = s.map(function (e, a) {
                    ...
                    var r = g.extend(i.yAxis, t.yaxis[0]);
                    return (r.show = !1), r;
                  })),
                a &&
                  s.length > 1 &&
          ...
          },
          {
            ...
            value: function (t) {
              var e = new S();
              return (
                (t.annotations.yaxis = g.extendArray(
          ...
          },
          {
            ...
            value: function (t) {
              var e = new S();
              return (
                (t.annotations.xaxis = g.extendArray(
          ...
          },
          {
            ...
            value: function (t) {
              var e = new S();
              return (
                (t.annotations.points = g.extendArray(
            ...
            value: function (t) {
              ...
              return (
                ...
                'candlestick' === e.chart.type &&
                  e.yaxis[0].reversed &&
                  (console.warn('Reversed y-axis in candlestick chart is not supported.'), (e.yaxis[0].reversed = !1)),
                e.chart.group &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (e.initialConfig = g.extend({}, t)),
                (e.initialSeries = g.clone(t.series)),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var s = 0; s < t[e].data.length; s++)
                if (
                  (void 0 !== t[e].data[s][1] &&
                    (Array.isArray(t[e].data[s][1]) && 4 === t[e].data[s][1].length
                      ? this.twoDSeries.push(g.parseNumber(t[e].data[s][1][3]))
                      : 5 === t[e].data[s].length
                        ? this.twoDSeries.push(g.parseNumber(t[e].data[s][4]))
                        : this.twoDSeries.push(g.parseNumber(t[e].data[s][1])),
              ...
              for (var n = 0; n < t[e].data.length; n++)
                void 0 !== t[e].data[n].y &&
                  (Array.isArray(t[e].data[n].y)
                    ? this.twoDSeries.push(g.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1]))
                    : this.twoDSeries.push(g.parseNumber(t[e].data[n].y)));
                ...
                if (l || c)
                  if (l || i.xaxis.convertedCatToNumeric) {
                    ...
                    'datetime' !== i.xaxis.type || d
                      ? ((this.fallbackToCategory = !0), this.twoDSeriesX.push(t[r].data[o].x))
                      : this.twoDSeriesX.push(s.parseDate(t[r].data[o].x));
                  } else
                    'datetime' === i.xaxis.type
                      ? this.twoDSeriesX.push(s.parseDate(t[r].data[o].x.toString()))
                      : ((a.dataFormatXNumeric = !0),
                        (a.isXNumeric = !0),
                  ...
                  h
                    ? ((this.fallbackToCategory = !0), this.twoDSeriesX.push(t[r].data[o].x))
                    : ((a.isXNumeric = !0), (a.dataFormatXNumeric = !0), this.twoDSeriesX.push(t[r].data[o].x));
              }
                        ...
                        for (var a = 0; a < t.y.length; a++)
                          if (i !== a) {
                            ...
                            s <= t.y[a].y2 &&
                              ...
                              t.overlaps.indexOf(t.y[a].rangeName) < 0 && t.overlaps.push(t.y[a].rangeName));
                          }
                      });
                    });
                }),
            ...
            value: function (t, e) {
              ...
              return (
                this.isFormat2DArray()
                  ...
                  : this.isFormatXY() && (a = this.handleCandleStickDataFormat('xy', t, e)),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if ('array' === t) {
                if (
                  (!Array.isArray(e[i].data[0][1]) && 5 !== e[i].data[0].length) ||
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                if (((this.twoDSeries = []), (this.twoDSeriesX = []), (this.threeDSeries = []), void 0 === t[l].data))
                ...
                if (
                  ...
                  this.isFormat2DArray()
                    ...
                    ('candlestick' !== a.chart.type && 'candlestick' !== t[l].type) || this.handleCandleStickData(t, l),
                    s.series.push(this.twoDSeries),
                    s.labels.push(this.twoDSeriesX),
                    s.seriesX.push(this.twoDSeriesX),
                    l !== this.activeSeriesIndex || this.fallbackToCategory || (s.isXNumeric = !0);
                else {
                  'datetime' === a.xaxis.type
                    ? ((s.isXNumeric = !0), o(), s.seriesX.push(this.twoDSeriesX))
                    : 'numeric' === a.xaxis.type &&
                      ((s.isXNumeric = !0), n.length > 0 && ((this.twoDSeriesX = n), s.seriesX.push(this.twoDSeriesX))),
                    s.labels.push(this.twoDSeriesX);
            ...
            value: function (t) {
              ...
              if (e.xaxis.categories.length > 0) i.labels = e.xaxis.categories;
                ...
                if (
                  ...
                  new R(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]), this._generateExternalLabels(t);
                ...
                g.isNumber(t) &&
                  (t =
                    0 !== a.globals.yValueDecimal
                      ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal)
            ...
            value: function () {
              ...
              return (
                ...
                Array.isArray(e.config.tooltip.y)
                  ...
                  : void 0 !== e.config.tooltip.y.formatter && (e.globals.ttVal = e.config.tooltip.y),
            ...
            value: function (t, e, i, a) {
              ...
              return (
                (b = n.globals.rotateXLabels
                  ...
                  : x.getTextRects(l, parseInt(r, 10))),
                !Array.isArray(l) &&
                  (0 === l.indexOf('NaN') ||
                    0 === l.toLowerCase().indexOf('invalid') ||
                    l.toLowerCase().indexOf('infinity') >= 0 ||
                    (s.indexOf(l) >= 0 && !n.config.xaxis.labels.showDuplicates)) &&
                  (l = ''),
          ...
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              if (
                ...
                var n = s[s.length - 1];
                e.x <
                  n.textRect.width / (r.globals.rotateXLabels ? Math.abs(r.config.xaxis.labels.rotate) / 12 : 1.01) +
                    n.x && (e.text = '');
              }
              return e;
            },
            ...
            value: function () {
              ...
              return new Promise(function (e) {
                ...
                if (window.canvg && g.isIE11()) {
                  var o = window.canvg.Canvg.fromString(r, n, { ignoreClear: !0, ignoreDimensions: !0 });
                  o.start();
                  var l = a.msToBlob();
                  o.stop(), e({ blob: l });
                } else {
          ...
          },
          {
            ...
            value: function (t) {
                  ...
                  if (o.globals.axisCharts) {
                    ...
                    'datetime' === o.config.xaxis.type &&
                      (o.config.xaxis.categories.length
                        ...
                        : o.config.labels.length && (i = o.config.labels[t]));
              ...
              l.push('category'),
                ...
                o.globals.axisCharts || (l.push('value'), h.push(l.join(s))),
                i.map(function (t, e) {
                          ...
                          for (var a = 0; a < t.data.length; a++) {
                            ...
                            if (
                              (r ||
                                (d.isFormatXY()
                                  ? (r = i[e].data[a].x)
                                  : d.isFormat2DArray() && (r = i[e].data[a] ? i[e].data[a][0] : '')),
                              0 === e)
                            ) {
                              l.push(r);
                              for (var n = 0; n < o.globals.series.length; n++) l.push(o.globals.series[n][a]);
                            }
                            ('candlestick' === o.config.chart.type || (t.type && 'candlestick' === t.type)) &&
                              (l.pop(),
                              l.push(o.globals.seriesCandleO[e][a]),
                              l.push(o.globals.seriesCandleH[e][a]),
                              l.push(o.globals.seriesCandleL[e][a]),
                              l.push(o.globals.seriesCandleC[e][a])),
                              'rangeBar' === o.config.chart.type &&
                                (l.pop(),
                                l.push(o.globals.seriesRangeStart[e][a]),
                                l.push(o.globals.seriesRangeEnd[e][a])),
                              l.length && h.push(l.join(s));
                          }
                      })(t, e)
                    : ((l = []).push(o.globals.labels[e]), l.push(o.globals.series[e]), h.push(l.join(s)));
                }),
                (c += h.join(n)),
                this.triggerDownload(encodeURI(c), '.csv');
            },
          },
          {
            key: 'triggerDownload',
    ...
    G = (function () {
      function t(i) {
        ...
        (this.axesUtils = new B(i)),
          ...
          'top' === a.config.xaxis.position ? (this.offY = 0) : (this.offY = a.globals.gridHeight + 1),
          (this.offY = this.offY + a.config.xaxis.axisBorder.offsetY),
          (this.isCategoryBarHorizontal = 'bar' === a.config.chart.type && a.config.plotOptions.bar.horizontal),
          ...
          this.isCategoryBarHorizontal && (this.xaxisBorderWidth = a.config.yaxis[0].axisBorder.width.toString()),
          this.xaxisBorderWidth.indexOf('%') > -1
            ? (this.xaxisBorderWidth = (a.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10)) / 100)
        ...
        a(t, [
            ...
            value: function () {
              ...
              if (i.config.xaxis.labels.show)
                for (
                  var d = function (s) {
                      ...
                      (c = e.axesUtils.checkForOverflowingLabels(s, c, h, e.drawnLabels, e.drawnLabelsRects)).text &&
                        i.globals.xaxisLabelsCount++;
                      var g = a.drawText({
                        x: c.x,
                        y:
                          e.offY +
                          ...
                          ('top' === i.config.xaxis.position
                            ? i.globals.xAxisHeight + i.config.xaxis.axisTicks.height - 2
                            : 0),
                        text: c.text,
                        textAnchor: 'middle',
                      ...
                      (u.textContent = c.text),
                        ...
                        '' !== c.text && (e.drawnLabels.push(c.text), e.drawnLabelsRects.push(c)),
                        (n += t);
                    },
                    g = 0;
                  g <= h - 1;
              ...
              if (i.config.xaxis.axisBorder.show) {
                var x = i.globals.barPadForNumericAxis,
                  b = a.drawLine(
                    i.globals.padHorizontal + i.config.xaxis.axisBorder.offsetX - x,
                    this.offY,
                    this.xaxisBorderWidth + x,
                    this.offY,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (k.show) {
                var A = s.drawLine(
                  a.globals.padHorizontal + k.offsetX + w,
                  1 + k.offsetY,
                  a.globals.padHorizontal + k.offsetX + w,
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (!(t < 0 || t - 2 > i.globals.gridWidth)) {
                ...
                if (
                  ('top' === i.config.xaxis.position && (r = s - i.config.xaxis.axisTicks.height),
                  i.config.xaxis.axisTicks.show)
                ) {
                  var n = new p(this.ctx).drawLine(
            ...
            value: function () {
                  ...
                  t.config.xaxis.labels.trim &&
                    Array.prototype.forEach.call(l, function (i) {
                      e.placeTextWithEllipsis(
                        i,
                        i.textContent,
                        t.config.xaxis.labels.maxHeight - ('bottom' === t.config.legend.position ? 20 : 10),
                      );
                    });
                }
              else
              ...
              if (s.length > 0) {
                var h = s[s.length - 1].getBBox(),
                  c = s[0].getBBox();
                h.x < -20 && s[s.length - 1].parentNode.removeChild(s[s.length - 1]),
                ...
                for (var d = 0; d < r.length; d++)
                  e.placeTextWithEllipsis(
                    r[d],
                    r[d].textContent,
                    t.config.yaxis[0].labels.maxWidth - 2 * parseFloat(t.config.yaxis[0].title.style.fontSize) - 20,
                  );
              }
            },
          },
    ...
    _ = (function () {
      function t(i) {
        ...
        (this.xaxisLabels = a.globals.labels.slice()),
          (this.axesUtils = new B(i)),
          (this.isTimelineBar = 'datetime' === a.config.xaxis.type && a.globals.seriesRangeBarTimeline.length),
          ...
          },
          {
            ...
            value: function () {
              ...
              ('bar' === r || 'rangeBar' === r || t.globals.comboBarCount > 0) &&
                ...
                e.barPadForNumericAxis > n && ((n = e.barPadForNumericAxis), (o = e.barPadForNumericAxis))),
                ...
                new m(this).getLargestMarkerSize();
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (0 === e && l.globals.skipFirstTimelinelabel) ||
                ...
                (l.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i, y1: a, x2: s, y2: r, parent: o }),
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.x1,
                ...
                c = new p(this).drawLine(e - (o ? h : 0), i, a + (o ? h : 0), s, n.config.grid.borderColor, l);
            ...
            value: function (t) {
              ...
              if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
                ...
                s.globals.timescaleLabels.length
                  ? (function (t) {
                      for (var a = t.xC, s = t.x1, r = t.y1, n = t.x2, o = t.y2, l = 0; l < a; l++)
                        (s = e.xaxisLabels[l].position),
                          ...
                          e._drawGridLines({ i: l, x1: s, y1: r, x2: n, y2: o, xCount: i, parent: e.elgridLinesV });
                  ...
                  : (s.globals.isXNumeric && (i = s.globals.xAxisScale.result.length),
                    ...
                    (function (t) {
                      for (
                        var a = t.xC, r = t.x1, n = t.y1, o = t.x2, l = t.y2, h = 0;
                        h < a + (s.globals.isXNumeric ? 0 : 1);
                        h++
                      )
                        0 === h && 1 === a && 1 === s.globals.dataPoints && (o = r = s.globals.gridWidth / 2),
                          e._drawGridLines({ i: h, x1: r, y1: n, x2: o, y2: l, xCount: i, parent: e.elgridLinesV }),
              ...
              if (s.config.grid.yaxis.lines.show) {
                ...
                for (var d = 0; d < c + (this.isTimelineBar ? 1 : 0); d++)
                  this._drawGridLine({ x1: 0, y1: o, x2: h, y2: l, parent: this.elgridLinesH }),
              ...
              if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                for (var a, s = i.globals.padHorizontal, r = i.globals.gridHeight, n = 0; n < e + 1; n++) {
                  i.config.grid.xaxis.lines.show &&
                    this._drawGridLine({ x1: s, y1: 0, x2: a, y2: r, parent: this.elgridLinesV }),
                    new G(this.ctx).drawXaxisTicks(s, this.elg),
                    (a = s = s + i.globals.gridWidth / e + 0.3);
                }
              if (i.config.grid.yaxis.lines.show)
                for (var o = 0, l = 0, h = i.globals.gridWidth, c = 0; c < i.globals.dataPoints + 1; c++)
                  this._drawGridLine({ x1: 0, y1: o, x2: h, y2: l, parent: this.elgridLinesH }),
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.elg = e.group({ class: 'apexcharts-grid' })),
                ...
                t.config.grid.show || (this.elgridLinesV.hide(), this.elgridLinesH.hide());
              for (
                var i, a = t.globals.yAxisScale.length ? t.globals.yAxisScale[0].result.length - 1 : 5, s = 0;
                s < t.globals.series.length &&
                (void 0 !== t.globals.yAxisScale[s] && (a = t.globals.yAxisScale[s].result.length - 1), !(a > 2));
                s++
              );
              return (
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (void 0 !== i.config.grid.row.colors && i.config.grid.row.colors.length > 0)
                for (var a = 0, s = i.globals.gridHeight / e, r = i.globals.gridWidth, n = 0, o = 0; n < e; n++, o++)
                  o >= i.config.grid.row.colors.length && (o = 0),
                    this._drawGridBandRect({ c: o, x1: 0, y1: a, x2: r, y2: s, type: 'row' }),
              ...
              if (void 0 !== i.config.grid.column.colors && i.config.grid.column.colors.length > 0)
                for (
                  ...
                  u >= i.config.grid.column.colors.length && (u = 0),
                    this._drawGridBandRect({ c: u, x1: h, y1: 0, x2: c, y2: d, type: 'column' }),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w,
                ...
                r = Math.abs(e - t);
              return (
                e !== -Number.MAX_VALUE && g.isNumber(e)
                  ? (a.xAxisScale = this.niceScale(t, e, s.tickAmount ? s.tickAmount : r < 5 && r > 1 ? r + 1 : 5, 0))
            ...
            value: function () {
              ...
              i.yaxis.forEach(function (e, n) {
                ...
                i.series.forEach(function (t, i) {
                  t.name === e.seriesName &&
                    ((o = i),
                    n !== i ? r.push({ index: i, similarIndex: n, alreadyExists: !0 }) : r.push({ index: i }));
                });
                var l = a[o],
                  h = s[o];
                      ...
                      t.forEach(function (i, l) {
                        t[l].key === e &&
                          (void 0 !== s.yaxis[e].min &&
                            (n = 'function' == typeof s.yaxis[e].min ? s.yaxis[e].min(r.minY) : s.yaxis[e].min),
                          void 0 !== s.yaxis[e].max &&
                            (o = 'function' == typeof s.yaxis[e].max ? s.yaxis[e].max(r.maxY) : s.yaxis[e].max),
                    ...
                    r
                      ? ((f = u[o]),
                        ...
                        u.forEach(function (t, e) {
                          s[e] <= i.xaxis.max &&
                            s[e] >= i.xaxis.min &&
                            (t > c && null !== t && (c = t), n[e] < h && null !== n[e] && (h = n[e]));
                        }))
                      : ((h = c = f),
                        n.forEach(function (t, e) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              'candlestick' === s.chart.type
                ...
                : r.isRangeData && ((h = r.seriesRangeStart), (c = r.seriesRangeEnd));
              for (var d = t; d < a; d++) {
                  ...
                  null !== f && g.isNumber(f)
                    ? ((n = Math.max(n, c[d][u])),
                      ...
                      'candlestick' === this.w.config.chart.type &&
                        ((n = Math.max(n, r.seriesCandleO[d][u])),
                        (n = Math.max(n, r.seriesCandleH[d][u])),
                        (n = Math.max(n, r.seriesCandleL[d][u])),
                        (i = n = Math.max(n, r.seriesCandleC[d][u]))),
                      g.isFloat(f) &&
                        ((f = g.noExponents(f)),
                        (r.yValueDecimal = Math.max(r.yValueDecimal, f.toString().split('.')[1].length))),
                      o > h[d][u] && h[d][u] < 0 && (o = h[d][u]))
                    : (r.hasNullValues = !0);
                }
              }
              return (
              ...
              if (
                (e.yaxis.forEach(function (e, i) {
                  void 0 !== e.max &&
                    ('number' == typeof e.max
                      ? (t.maxYArr[i] = e.max)
                      : 'function' == typeof e.max && (t.maxYArr[i] = e.max(t.maxY)),
                    (t.maxY = t.maxYArr[i])),
                    void 0 !== e.min &&
                      ('number' == typeof e.min
                        ? (t.minYArr[i] = e.min)
                        : 'function' == typeof e.min && (t.minYArr[i] = e.min(t.minY)),
                      (t.minY = t.minYArr[i]));
                }),
                t.isBarHorizontal)
              ) {
                ...
                if (
                  (void 0 === e.xaxis.tickAmount
                    ? ((a = Math.round(t.svgWidth / 150)),
                      'numeric' === e.xaxis.type && t.dataPoints < 30 && (a = t.dataPoints - 1),
                      a > t.dataPoints && 0 !== t.dataPoints && (a = t.dataPoints - 1))
                    : 'dataPoints' === e.xaxis.tickAmount
                      ? (t.series.length > 1 && (a = t.series[t.maxValsInArrayIndex].length - 1),
                  ...
                  (t.xAxisScale = this.scales.linearScale(1, a, a)),
                    t.noLabelsProvided &&
                      t.labels.length > 0 &&
                      ((t.xAxisScale = this.scales.linearScale(1, t.labels.length, a - 1)),
              ...
              if (t.minX === t.maxX) {
                ...
                if ('datetime' === e.xaxis.type) {
                  ...
                  ('numeric' === e.xaxis.type || ('category' === e.xaxis.type && !t.noLabelsProvided)) &&
                    ((t.minX = t.minX - 2), (t.initialMinX = t.minX), (t.maxX = t.maxX + 2), (t.initialMaxX = t.maxX));
              }
            },
          },
          {
    ...
    q = (function () {
      function t(i) {
        ...
        (this.xaxisFontSize = a.config.xaxis.labels.style.fontSize),
          ...
          (this.isCategoryBarHorizontal = 'bar' === a.config.chart.type && a.config.plotOptions.bar.horizontal),
          (this.xAxisoffX = 0),
          'bottom' === a.config.xaxis.position && (this.xAxisoffX = a.globals.gridHeight),
          (this.drawnLabels = []),
          (this.axesUtils = new B(i));
      }
      return (
        a(t, [
          {
            ...
            value: function (t) {
                ...
                for (
                  var x = function (o) {
                      ...
                      if ((o === h && (f = b), l.add(b), 0 !== e.config.yaxis[t].labels.rotate)) {
                        ...
                        b.node.setAttribute(
                          'transform',
                          'rotate('.concat(e.config.yaxis[t].labels.rotate, ' ').concat(m.x, ' ').concat(v.y, ')'),
                        );
                      }
                      d += c;
                    },
              ...
              return (
                e.config.yaxis[t].axisTicks.show &&
                  this.axesUtils.drawYAxisTicks(k, h, w, e.config.yaxis[t].axisTicks, t, c, o),
                o
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              c.length > 0 && ((this.xaxisLabels = c.slice()), (r = (h = c.slice()).length)),
                ...
                for (var g = d ? 0 : r; d ? g < d : g >= 0; d ? g++ : g--) {
                  ...
                  if (c.length) {
                    ...
                    (f = x.x),
                      ...
                      g === h.length - 1 && e.globals.skipLastTimelinelabel && (u = '');
                  }
                  var b = i.drawText({
                    x: f,
                    y:
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              return void 0 === s.config.yaxis[t].title.text || t < 0
                ? { xPos: n, padd: 0 }
                : (a
                    ? ((n = e.width + s.config.yaxis[t].title.offsetX + i.width / 2 + o / 2),
                      0 === (r += 1) && (n -= o / 2))
                    : ((n = -1 * e.width + s.config.yaxis[t].title.offsetX + o / 2 + i.width / 2),
                      s.globals.isBarHorizontal &&
                        ((o = 25), (n = -1 * e.width - s.config.yaxis[t].title.offsetX - o))),
                  { xPos: n, padd: o });
            },
          },
          {
                  ...
                  o.opposite
                    ? i.globals.isBarHorizontal
                      ...
                      : ((s = i.globals.gridWidth + i.globals.translateX + n),
                        h || (n = n + c + 20),
                        (i.globals.translateYAxisX[l] = s - o.labels.offsetX + 20))
                  ...
                  'left' === a.labels.align
                    ...
                    : 'center' === a.labels.align
                      ? (r.forEach(function (t, e) {
                        ...
                        s.setAttribute('transform', 'translate('.concat((n.width / 2) * (a.opposite ? 1 : -1), ', 0)')))
                ...
                a.addEventListener(
                  ...
                  function (t) {
                    ...
                    'mousemove' === t.type || 'touchmove' === t.type
                      ? 'function' == typeof e.config.chart.events.mouseMove && e.config.chart.events.mouseMove(t, i, a)
                      : (('mouseup' === t.type && 1 === t.which) || 'touchend' === t.type) &&
                        ('function' == typeof e.config.chart.events.click && e.config.chart.events.click(t, i, a),
            ...
            value: function (t) {
              ...
              if ('mousedown' === t.type) {
                ...
                Array.prototype.forEach.call(s, function (e) {
                  t.target.classList.contains('apexcharts-resizable-element') ||
                    t.target.classList.contains('svg_select_points') ||
                    e.selectize(!1);
                });
              }
            ...
            value: function () {
              ...
              if (t.config.xaxis.crosshairs.show) {
                ...
                1 === t.config.xaxis.crosshairs.width && (w = e.drawLine()),
                  ...
                  d && (w = i.dropShadow(w, { left: f, top: x, blur: b, color: m, opacity: v })),
              ...
              if (0 !== a.responsive.length) {
                ...
                var r = new D({}),
                  n = function () {
                    ...
                    if (n > a) {
                      var o = m.extendArrayProps(r, i.globals.initialConfig, i);
                      (t = g.extend(o, t)), (t = g.extend(i.config, t)), e.overrideResponsiveOptions(t);
                    } else
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = m.extendArrayProps(r, s[l].options, i)),
                          (t = g.extend(i.config, t)),
                          e.overrideResponsiveOptions(t));
                  };
                if (t) {
                  var o = m.extendArrayProps(r, t, i);
      ...
      function t(i) {
        ...
        (this.isColorFn = !1),
          (this.isBarDistributed =
            ...
            ('bar' === a.config.chart.type || 'rangeBar' === a.config.chart.type));
      }
      return (
        a(t, [
          {
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  ...
                  var c = void 0;
                  'dark' === o ? ((c = i.shadeColor(-1 * l, r)), (l += n)) : ((c = i.shadeColor(l, r)), (l += n)),
                    a.push(c);
                }
              ...
              ['fill', 'stroke'].forEach(function (i) {
                ...
                void 0 === e.config.plotOptions.radar.polygons.fill.colors
                  ? (e.globals.radarPolygons.fill.colors = ['dark' === e.config.theme.mode ? '#424242' : '#fff'])
            ...
            value: function (t, e) {
              ...
              if (
                (null === i &&
                  (i =
                    this.isBarDistributed ||
                    ('heatmap' === a.config.chart.type && a.config.plotOptions.heatmap.colorScale.inverse)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ('left' === i.align
                  ? ((a = 10), (r = 'start'))
                  : 'right' === i.align && ((a = e.globals.svgWidth - 10), (r = 'end')),
                (a += i.offsetX),
        ...
        a(t, [
            ...
            value: function () {
              ...
              if (
                ...
                var h = new p(this.dCtx.ctx),
                  ...
                  d = c;
                if (
                  (r !== n && (d = h.getTextRects(n, e.config.xaxis.labels.style.fontSize)),
                  ((t = {
                  ...
                  if (!e.globals.isBarHorizontal) {
                    ...
                    (c = u(r)),
                      r !== n && (d = u(n)),
                      (t.height = (c.height > d.height ? c.height : d.height) / 1.5),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (void 0 !== t.config.xaxis.title.text) {
                var a = new p(this.dCtx.ctx).getTextRects(
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                1.05 *
                  (t = new p(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width *
                  i.length >
                  e.globals.gridWidth &&
                  0 !== e.config.xaxis.labels.rotate &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o = i.config.yaxis[0].opposite && i.globals.isBarHorizontal,
                l = function (t, o) {
                  (function (t) {
                    ...
                    ('datetime' !== r &&
                      e.dCtx.gridPad.left < n / 2 - e.dCtx.yAxisWidthLeft &&
                      !a.rotateXLabels &&
                      !s.xaxis.labels.trim &&
                    ...
                    (function (t) {
                      if (e.dCtx.timescaleLabels && e.dCtx.timescaleLabels.length) {
                        ...
                        'datetime' === r
                          ? e.dCtx.gridPad.right < n && !a.rotateXLabels && (a.skipLastTimelinelabel = !0)
                          : 'datetime' !== r &&
                            e.dCtx.gridPad.right < n / 2 - e.dCtx.yAxisWidthRight &&
                            !a.rotateXLabels &&
              ...
              s.yaxis.forEach(function (t, i) {
                o
                  ? (e.dCtx.gridPad.left < n && (e.dCtx.xPadLeft = n / 2 + 1), (e.dCtx.xPadRight = n / 2 + 1))
                  : l(0, i);
              });
            },
          },
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    ...
                    if (((void 0 !== c && 0 !== c.length) || (c = h), e.globals.isBarHorizontal)) {
                      a = 0;
                      var u = e.globals.labels.slice();
                      (c = l((c = g.getLargestStringFromArr(u)), { seriesIndex: n, dataPointIndex: -1, w: e })),
                        (d = t.dCtx.dimHelpers.getLargestStringFromMultiArr(c, u));
                    }
                    var f = new p(t.dCtx.ctx),
                      x = f.getTextRects(c, r.labels.style.fontSize),
                      b = x;
                    c !== d && (b = f.getTextRects(d, r.labels.style.fontSize)),
                      i.push({
              ...
              return (
                e.config.yaxis.map(function (e, a) {
                  if (e.show && void 0 !== e.title.text) {
                    var s = new p(t.dCtx.ctx).getTextRects(
                      e.title.text,
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                ('bar' === i || 'rangeBar' === i || e.globals.comboBarCount > 0) &&
                  e.globals.isXNumeric &&
                  !e.globals.isBarHorizontal &&
                  s > 0)
              ) {
                ...
                o <= 3 && (o = e.globals.dataPoints),
                  (r = o / t),
                  e.globals.minXDiff && e.globals.minXDiff / r > 0 && (n = e.globals.minXDiff / r),
                  n > t / 2 && (n /= 2),
                  (a = ((n / s) * parseInt(e.config.plotOptions.bar.columnWidth, 10)) / 100) < 1 && (a = 1),
                  (a = a / (s > 1 ? 1 : 1.5) + 5),
          ...
          },
          {
            ...
            value: function () {
              ...
              (i.gridHeight = i.gridHeight - r.height - n.height - a),
                (i.translateY = i.translateY + r.height + n.height + a);
            },
          },
          {
                ...
                -1 !== i.globals.ignoreYAxisIndexes.indexOf(r) ||
                  ...
                  (s.opposite &&
                    (i.globals.translateX =
                      i.globals.translateX -
                      (e[r].width + t[r].width) -
                      parseInt(i.config.yaxis[r].labels.style.fontSize, 10) / 1.2 -
                      12));
              });
            },
          },
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              (this.lgRect = this.dimHelpers.getLegendsRect()),
                t.axisCharts ? this.setDimensionsForAxisCharts() : this.setDimensionsForNonAxisCharts(),
                this.dimGrid.gridPadFortitleSubtitle(),
                (t.gridHeight = t.gridHeight - this.gridPad.top - this.gridPad.bottom),
                (t.gridWidth = t.gridWidth - this.gridPad.left - this.gridPad.right - this.xPadRight - this.xPadLeft);
              var e = this.dimGrid.gridPadForColumnsInNumericAxis(t.gridWidth);
              (t.gridWidth = t.gridWidth - 2 * e),
                (t.translateX = t.translateX + this.gridPad.left + this.xPadLeft + (e > 0 ? e + 4 : 0)),
          ...
          },
          {
            ...
            value: function () {
              ...
              var h = 10;
              ('radar' === e.config.chart.type || this.isSparkline) && ((o = 0), (l = i.goldenPadding)),
                this.isSparkline && ((this.lgRect = { height: 0, width: 0 }), (l = 0), (o = 0), (h = 0)),
                this.dimXAxis.additionalPaddingXLabels(r);
              var c = function () {
                (i.translateX = o),
                  (i.gridHeight =
                    i.svgHeight - t.lgRect.height - l - (t.isSparkline ? 0 : e.globals.rotateXLabels ? 10 : 15)),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w;
              (this.xAxisHeight =
                (t.height + e.height) * (i.globals.isMultiLineX ? 1.2 : i.globals.LINE_HEIGHT_RATIO) +
              ...
              if (a.globals.axisCharts || 'radialBar' === a.config.chart.type) {
                ...
                if (
                  ...
                  a.globals.axisCharts
                    ...
                    : ((s = a.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']"))),
                ...
                if ('pie' === o || 'polarArea' === o || 'donut' === o) {
                  ...
                  new p(this.lgCtx.ctx).pathMouseDown(n.members[0], null),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0;
                n ? o >= 0 : o <= i.length - 1;
                n ? o-- : o++
              ) {
                ...
                if (t.globals.ancillaryCollapsedSeriesIndices.length > 0)
                  for (var g = 0; g < t.globals.ancillaryCollapsedSeriesIndices.length; g++)
                ...
                (A.background = a[o]),
                  ...
                  (A.height = Array.isArray(b) ? parseFloat(b[o]) + 'px' : parseFloat(b) + 'px'),
                  (A.width = Array.isArray(v) ? parseFloat(v[o]) + 'px' : parseFloat(v) + 'px'),
                  (A.left = Array.isArray(f) ? f[o] : f),
                  (A.top = Array.isArray(x) ? x[o] : x),
                  (A.borderWidth = Array.isArray(y) ? y[o] : y),
                  (A.borderColor = Array.isArray(w) ? w[o] : w),
                  (A.borderRadius = Array.isArray(k) ? parseFloat(k[o]) + 'px' : parseFloat(k) + 'px'),
                  t.config.legend.markers.customHTML &&
                    (Array.isArray(t.config.legend.markers.customHTML)
                      ? t.config.legend.markers.customHTML[o] && (u.innerHTML = t.config.legend.markers.customHTML[o]())
                      : (u.innerHTML = t.config.legend.markers.customHTML())),
                  p.setAttrs(u, { rel: o + 1, 'data:collapsed': h || c }),
                ...
                L || (L = t.config.chart.foreColor),
                  (C.style.color = L),
                  (C.style.fontSize = parseFloat(t.config.legend.fontSize) + 'px'),
                  (C.style.fontWeight = t.config.legend.fontWeight),
                ...
                if (!t.config.legend.showForZeroSeries)
                  0 === P.getSeriesTotalByIndex(o) &&
                    ...
                    -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) &&
                ...
                t.config.legend.showForNullSeries ||
                  ...
                  (h || c) && S.classList.add('apexcharts-inactive-legend'),
              ...
              (a.style.position = 'absolute'),
                ...
                'bottom' === i.config.legend.position
                  ...
                  : 'right' === i.config.legend.position &&
                    ((a.style.left = 'auto'), (a.style.right = 25 + i.config.legend.offsetX + 'px'));
            ...
            value: function () {
              ...
              'bottom' === t.config.legend.position
                ...
                : 'top' === t.config.legend.position &&
                  (r = a.height + s.height + t.config.title.margin + t.config.subtitle.margin - 10),
          ...
          },
          {
            ...
            value: function (t) {
              if (
                ...
                'function' == typeof s &&
                  t.target.classList.contains('apexcharts-legend-marker') &&
                  (s(this.ctx, e, this.w), this.ctx.events.fireEvent('legendMarkerClick', [this.ctx, e, this.w])),
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              for (var h = 0; h < r.length; h++)
                p.setAttrs(r[h].el, { class: r[h].class, title: r[h].title }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (void 0 !== t || void 0 !== e) {
                if (
                  !(i.config.xaxis.convertedCatToNumeric && (t < 1 && ((t = 1), (e = i.globals.dataPoints)), e - t < 2))
                ) {
                  var a = { min: t, max: e },
                  ...
                  if (i.config.chart.zoom.autoScaleYaxis) n = new j(this.ctx).autoScaleY(this.ctx, n, { xaxis: a });
            ...
            value: function (t) {
              this.ctx.getSyncedCharts().forEach(function (t) {
                ...
                (e.globals.lastXAxis.min = void 0),
                  ...
                  (e.globals.zoomed = !1);
                var i = t.ctx.series.emptyCollapsedSeries(g.clone(e.globals.initialSeries));
        ...
        a(i, [
              ...
              (this.xyRatios = i),
                ...
                'x' === a.config.chart.selection.type
                  ? (this.slDraggableRect = this.selectionRect
                      .draggable({ minX: 0, minY: 0, maxX: a.globals.gridWidth, maxY: a.globals.gridHeight })
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                (e.shiftKey
                  ? ((this.shiftWasPressed = !0), s.enableZoomPanFromToolbar('pan'))
                  : this.shiftWasPressed && (s.enableZoomPanFromToolbar('zoom'), (this.shiftWasPressed = !1)),
                !(
                ...
                if (
                  ...
                  (a.startX = a.clientX - n.left),
                    (a.startY = a.clientY - n.top),
                    (a.dragged = !1),
                ...
                if (
                  ((('mousemove' === e.type && 1 === e.which) || 'touchmove' === e.type) &&
                    ...
                    i.globals.panEnabled
                      ? ((i.globals.selection = null),
                        a.w.globals.mousedown && a.panDragging({ context: a, zoomtype: r, xyRatios: t }))
                      : ((a.w.globals.mousedown && i.globals.zoomEnabled) ||
                          (a.w.globals.mousedown && i.globals.selectionEnabled)) &&
                        (a.selection = a.selectionDrawing({ context: a, zoomtype: r }))),
                  ...
                  a.w.globals.mousedown &&
                    ...
                    i.globals.panEnabled && i.config.xaxis.convertedCatToNumeric && a.delayedPanScrolled()),
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.context,
                ...
                g = {};
              return (
                Math.abs(l + n) > a.globals.gridWidth
                  ? (l = a.globals.gridWidth - n)
                  : s.clientX - r.left < 0 && (l = n),
                n > s.clientX - r.left && (c = -(l = Math.abs(l))),
                o > s.clientY - r.top && (d = -(h = Math.abs(h))),
                (g =
                  'x' === i
            ...
            value: function (t) {
              ...
              if (
                (a.config.yaxis.forEach(function (t, e) {
                  d.push(a.globals.yAxisScale[e].niceMax - r.yRatio[e] * s.startY),
                    u.push(a.globals.yAxisScale[e].niceMax - r.yRatio[e] * s.endY);
                }),
                s.dragged && (s.dragX > 10 || s.dragY > 10) && h !== c)
              )
                if (a.globals.zoomEnabled) {
                  var f = g.clone(a.globals.initialConfig.yaxis),
                    p = g.clone(a.globals.initialConfig.xaxis);
                  if (
                    ((a.globals.zoomed = !0),
                    a.globals.zoomed ||
                      ((a.globals.lastXAxis = g.clone(a.config.xaxis)),
                      (a.globals.lastYAxis = g.clone(a.config.yaxis))),
                  ...
                  a.config.chart.group || (m.yaxis = f),
                    s.ctx.updateHelpers._updateOptions(m, !1, s.w.config.chart.animations.dynamicAnimation.enabled),
                    'function' == typeof a.config.chart.events.zoomed && n.zoomCallback(p, f);
                } else if (a.globals.selectionEnabled) {
                  var v,
                    y = null;
                  (v = { min: h, max: c }),
                    ('xy' !== i && 'y' !== i) ||
                      (y = g.clone(a.config.yaxis)).forEach(function (t, e) {
                        (y[e].min = u[e]), (y[e].max = d[e]);
                      }),
                    (a.globals.selection = s.selection),
                    'function' == typeof a.config.chart.events.selection &&
                      a.config.chart.events.selection(s.ctx, { xaxis: v, yaxis: y });
                }
            },
          },
          {
                ...
                Math.abs(s) > Math.abs(r) && s > 0
                  ...
                  : Math.abs(s) > Math.abs(r) && s < 0
                    ...
                    : Math.abs(r) > Math.abs(s) && r > 0
                      ...
                      : Math.abs(r) > Math.abs(s) && r < 0 && (this.moveDirection = 'down');
              }
          ...
          },
          {
            ...
            value: function () {
              ...
              'left' === this.moveDirection
                ...
                : 'right' === this.moveDirection && ((e = t.globals.minX - a), (i = t.globals.maxX - a)),
                (e = Math.floor(e)),
                (i = Math.floor(i)),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var r = { min: t, max: e };
              i.config.chart.zoom.autoScaleYaxis && (s = new j(this.ctx).autoScaleY(this.ctx, s, { xaxis: r }));
            ...
            value: function (t, e, i) {
              ...
              this.ctx.updateHelpers._updateOptions(t, !1, !1),
                'function' == typeof a.config.chart.events.scrolled &&
                  a.config.chart.events.scrolled(this.ctx, { xaxis: { min: e, max: i } });
            },
          },
        ]),
        i
            ...
            value: function (t) {
              ...
              return (
                ...
                r.globals.isXNumeric &&
                  ((p = (x = this.closestInMultiArray(c, d, b, f)).index),
                  (u = x.j),
                  null !== p && ((b = r.globals.seriesXvalues[p]), (u = (x = this.closestInArray(c, b)).index))),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var a = i.allTooltipSeriesGroups, s = 0; s < a.length; s++)
                'enable' === t
                  ? (a[s].classList.add('apexcharts-active'), (a[s].style.display = e.config.tooltip.items.display))
                  : (a[s].classList.remove('apexcharts-active'), (a[s].style.display = 'none'));
            },
          },
        ]),
        t
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              (this.ttCtx.tooltipRect.ttWidth = g.getBoundingClientRect().width),
                (this.ttCtx.tooltipRect.ttHeight = g.getBoundingClientRect().height);
            },
          },
          {
            key: 'printLabels',
              ...
              for (
                var f = function (t, r) {
                    ...
                    if (l.globals.axisCharts) {
                      ...
                      o
                        ? ((f = i.getFormatters(p)),
                          (g = i.getSeriesName({ fn: f.yLbTitleFormatter, index: p, seriesIndex: a, j: s })),
                          (u = l.globals.colors[p]),
                          (e = x(p)))
                        : (e = x(a));
                    }
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.i,
                ...
                f = null;
              (f = a[i].children),
                l.config.tooltip.fillSeriesColor && ((a[i].style.backgroundColor = o), (f[0].style.display = 'none')),
                h.showTooltipTitle &&
                  (null === h.tooltipTitle &&
                    (h.tooltipTitle = l.globals.dom.baseEl.querySelector('.apexcharts-tooltip-title')),
                  (h.tooltipTitle.innerHTML = d)),
                h.blxaxisTooltip && (h.xaxisTooltipText.innerHTML = '' !== g ? g : d);
              var p = a[i].querySelector('.apexcharts-tooltip-text-label');
              p && (p.innerHTML = r ? r + ': ' : '');
              var x = a[i].querySelector('.apexcharts-tooltip-text-value');
              (x && (x.innerHTML = void 0 !== c ? c : ''),
              f[0] &&
              ...
              null !== u) &&
                ((a[i].querySelector('.apexcharts-tooltip-text-z-label').innerHTML = l.config.tooltip.z.title),
                (a[i].querySelector('.apexcharts-tooltip-text-z-value').innerHTML = void 0 !== u ? u : ''));
              n &&
                f[0] &&
            ...
            value: function (t) {
              ...
              null === i
                ...
                : a.globals.isXNumeric
                  ? ((r = s[e][i]), 0 === s[e].length && (r = s[this.tooltipUtil.getFirstActiveXArray(s)][i]))
                  : (r = void 0 !== a.globals.labels[i] ? a.globals.labels[i] : '');
              var d = r;
              a.globals.isXNumeric && 'datetime' === a.config.xaxis.type
                ? (r = new W(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d))
                : a.globals.isBarHorizontal || (r = a.globals.xLabelFormatter(d, h));
              return (
                void 0 !== a.config.tooltip.x.formatter && (r = a.globals.ttKeyFormatter(d, h)),
                a.globals.seriesZ.length > 0 && a.globals.seriesZ[0].length > 0 && (o = c(a.globals.seriesZ[e][i], a)),
                (n = 'function' == typeof a.config.xaxis.tooltip.formatter ? a.globals.xaxisTooltipFormatter(d, h) : r),
                {
      ...
      return (
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.ttCtx;
              null !== e.ycrosshairs && p.setAttrs(e.ycrosshairs, { y1: t, y2: t }),
                null !== e.ycrosshairsHidden && p.setAttrs(e.ycrosshairsHidden, { y1: t, y2: t });
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (null !== i.xaxisTooltip) {
                ...
                if (((t -= i.xaxisTooltip.getBoundingClientRect().width / 2), !isNaN(t))) {
                  ...
                  var s;
                  (s = new p(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML)),
              ...
              e.config.yaxis[t].opposite && (n -= 26),
                ...
                -1 === e.globals.ignoreYAxisIndexes.indexOf(t)
                  ? (i.yaxisTTEls[t].classList.add('apexcharts-active'),
                    ...
                    (i.yaxisTTEls[t].style.left = n + e.config.yaxis[t].tooltip.offsetX + 'px'))
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                l > a.globals.gridWidth - n.ttWidth - 10 && (l = a.globals.gridWidth - n.ttWidth),
                l < -20 && (l = -20),
              ...
              if (i.globals.markers.size[t] > 0)
                for (
                  ...
                  parseInt(s[r].getAttribute('rel'), 10) === e &&
                    (a.marker.resetPointsSize(), a.marker.enlargeCurrentPoint(e, s[r]));
            ...
            value: function (t, e) {
              ...
              if (!l || ('column' !== l && 'candlestick' !== l)) {
                ...
                h &&
                  ...
                  a > 0 &&
                  (h.setAttribute('r', o), h.setAttribute('cx', i), h.setAttribute('cy', a)),
                  ...
                  if ((a.globals.comboCharts && void 0 === c && l.splice(h, 0, null), c && c.length)) {
                    ...
                    l[h].setAttribute('cx', s),
                      null !== d && !isNaN(d) && d < a.globals.gridHeight && d > 0
                        ? (l[h] && l[h].setAttribute('r', o), l[h] && l[h].setAttribute('cy', d))
          ...
          },
          {
            ...
            value: function (t) {
              ...
              i.globals.isXNumeric
                ? (o -= s % 2 != 0 ? l / 2 : 0)
                : ((o = a.xAxisTicksPositions[t - 1] + a.dataPointsDividedWidth / 2),
                  isNaN(o) && (o = a.xAxisTicksPositions[t] - a.dataPointsDividedWidth / 2));
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                if (
                  (void 0 === r && (r = e.globals.markers.size[l] + e.config.markers.hover.sizeOffset),
                  a === parseInt(o, 10))
                ) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (e.target.classList.contains('apexcharts-heatmap-rect')) {
                ...
                if (
                  (r.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: o, j: l, shared: !1 }),
                  (n.globals.capturedSeriesIndex = o),
                  (n.globals.capturedDataPointIndex = l),
                  (a = h + r.tooltipRect.ttWidth / 2 + d),
                  (s = c + r.tooltipRect.ttHeight / 2 - g / 2),
                  r.tooltipPosition.moveXCrosshairs(h + d / 2),
                  a > n.globals.gridWidth / 2 && (a = h - r.tooltipRect.ttWidth / 2 + d),
            ...
            value: function (t) {
              ...
              if (a.target.classList.contains('apexcharts-marker')) {
                ...
                if (
                  ...
                  (e = parseInt(s.paths.parentNode.parentNode.parentNode.getAttribute('rel'), 10) - 1),
                  l.intersect)
                ) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                (r.globals.capturedDataPointIndex = u),
                (r.globals.isBarHorizontal && n.tooltipUtil.hasBars()) || !r.config.tooltip.shared
                  ? ((h = d.x),
                    (c = d.y),
                    (i = Array.isArray(r.config.stroke.width) ? r.config.stroke.width[e] : r.config.stroke.width),
                    (l = h))
                  : r.globals.comboCharts || r.config.tooltip.shared || (l /= 2),
                isNaN(c) ? (c = r.globals.svgHeight - n.tooltipRect.ttHeight) : c < 0 && (c = 0),
                h + n.tooltipRect.ttWidth > r.globals.gridWidth ? (h -= n.tooltipRect.ttWidth) : h < 0 && (h = 0),
              ...
              if (
                ...
                !n.fixedTooltip && (!r.config.tooltip.shared || (r.globals.isBarHorizontal && n.tooltipUtil.hasBars())))
              ) {
                ...
                !p ||
                  ...
                  n.tooltipRect.ttHeight + c > r.globals.gridHeight
                    ? ((c = r.globals.gridHeight - n.tooltipRect.ttHeight + r.globals.translateY),
                      (o.style.top = c + 'px'))
                    : (o.style.top = c + r.globals.translateY - n.tooltipRect.ttHeight / 2 + 'px');
              }
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                a.globals.comboCharts && (n = parseInt(g.parentNode.getAttribute('data:realIndex'), 10)),
                  ...
                  a.config.tooltip.followCursor
                    ? a.globals.isBarHorizontal
                      ? ((o = v - f.left + 15),
                        (l = m - r.dataPointsDividedHeight + p / 2 - r.tooltipRect.ttHeight / 2))
                      : ((o = a.globals.isXNumeric ? b - x / 2 : b - r.dataPointsDividedWidth + x / 2),
                        (l = e.clientY - f.top - r.tooltipRect.ttHeight / 2 - 15))
                    : a.globals.isBarHorizontal
                      ? ((o = b) < r.xyRatios.baseLineInvertedY && (o = b - r.tooltipRect.ttWidth),
                        (l = m - r.dataPointsDividedHeight + p / 2 - r.tooltipRect.ttHeight / 2))
                      : ((o = a.globals.isXNumeric ? b - x / 2 : b - r.dataPointsDividedWidth + x / 2), (l = m));
              }
                ...
                var t = this.w,
                  ...
                  i = function (i) {
                    ...
                    var s = 'apexcharts-yaxistooltip apexcharts-yaxistooltip-'.concat(
                      i,
                      a ? ' apexcharts-yaxistooltip-right' : ' apexcharts-yaxistooltip-left',
                    );
                    ...
                    null ===
                      ...
                      e.yaxisTooltip.setAttribute('class', s + ' apexcharts-theme-' + t.config.tooltip.theme),
        ...
        a(t, [
            ...
            value: function (t) {
              for (var e = this.w, i = [], a = this.getElTooltip(), s = 0; s < t; s++) {
                ...
                o.classList.add('apexcharts-tooltip-text'),
                  (o.style.fontFamily = this.tConfig.style.fontFamily || e.config.chart.fontFamily),
            ...
            value: function () {
              ...
              if (
                ...
                (s
                  ...
                  : a
                    ...
                    : 'heatmap' === e &&
                      (o = t.globals.dom.baseEl.querySelectorAll('.apexcharts-series .apexcharts-heatmap')),
                o && o.length)
              )
              ...
              if (this.showOnIntersect) {
                ...
                u.length > 0 && this.addPathsEventListeners(u, c),
                  this.tooltipUtil.hasBars() && !this.tConfig.shared && this.addDatapointEventsListeners(c);
              }
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                o.indexOf('bottom') > -1 && (n = n + t.globals.svgHeight - s - 10),
                (e.style.left = r + 'px'),
                (e.style.top = n + 'px'),
            ...
            value: function (t, e) {
              ...
              s.config.chart.group && (a = this.ctx.getGroupedCharts()),
                (s.globals.axisCharts &&
                  ((s.globals.minX === -1 / 0 && s.globals.maxX === 1 / 0) || 0 === s.globals.dataPoints)) ||
                  (a.length
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (i.e = s),
              !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared) ||
              ...
              i.fixedTooltip && i.drawFixedTooltipRect(),
                r.globals.axisCharts
                  ? i.axisChartsTooltips({ e: s, opt: a, tooltipRect: i.tooltipRect })
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  (r.globals.isBarHorizontal && this.tooltipUtil.hasBars() && (g = !1),
                  'mousemove' === a.type || 'touchmove' === a.type || 'mouseup' === a.type)
                ) {
                  ...
                  if (
                    (null !== this.ycrosshairs && u.length && this.ycrosshairs.classList.add('apexcharts-active'),
                    ...
                    this.tooltipUtil.hasBars() && this.intersect.handleBarTooltip({ e: a, opt: s }),
                      this.tooltipUtil.hasMarkers() && this.intersect.handleMarkerTooltip({ e: a, opt: s, x: e, y: i });
            ...
            value: function (t) {
              ...
              if ('mousemove' === e.type || 'touchmove' === e.type) {
                n.classList.add('apexcharts-active'),
                  this.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: parseInt(r, 10) - 1, shared: !1 });
            ...
            value: function (t, e, i, a) {
              ...
              r.hoverX < 0 || r.hoverX > s.globals.gridWidth
                ...
                : null !== o
                  ...
                  : this.tooltipUtil.isXoverlap(n) && this.create(t, this, 0, n, a.ttItems);
            },
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              null === s.globals.series[e][a]
                ...
                : void 0 !== s.globals.series[e][a]
                  ? this.tConfig.shared && this.tooltipUtil.isXoverlap(a) && this.tooltipUtil.isInitialSeriesSameLen()
                    ? this.create(t, this, e, a, i.ttItems)
                    : this.create(t, this, e, a, i.ttItems, !1)
                  : this.tooltipUtil.isXoverlap(a) && this.create(t, this, 0, a, i.ttItems);
            },
          },
          {
            ...
            value: function () {
              for (
                var t = this.w, e = new p(this.ctx), i = t.globals.dom.Paper.select('.apexcharts-bar-area'), a = 0;
                a < i.length;
                a++
              )
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                this.blxaxisTooltip && this.xaxisTooltip.classList.remove('apexcharts-active'),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              'function' == typeof a.config.chart.events.markerClick &&
                a.config.chart.events.markerClick(t, this.ctx, { seriesIndex: e, dataPointIndex: i, w: a }),
            ...
            value: function (t, e, i, a, s) {
              ...
              if (n.config.legend.tooltipHoverFormatter) {
                ...
                for (var g = 0; g < d.length; g++) {
                  ...
                  if (r) u.innerHTML = n.globals.collapsedSeriesIndices.indexOf(f) < 0 ? b : x;
                  else if (((u.innerHTML = f === i ? b : x), i === f)) break;
                }
              }
              if (r) {
                if (
                  ...
                  this.tooltipUtil.hasBars() &&
                    ((this.barSeriesHeight = this.tooltipUtil.getBarsHeight(h)), this.barSeriesHeight > 0))
                ) {
                ...
                o.tooltipLabels.drawSeriesTexts({ shared: !1, ttItems: s, i: i, j: a }),
                  this.tooltipUtil.hasBars() && o.tooltipPosition.moveStickyTooltipOverBars(a),
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              var i = this,
                a = this.w;
              (this.graphics = new p(this.ctx)), (this.bar = new E(this.ctx, this.xyRatios));
              var s = new m(this.ctx, a);
              (t = s.getLogSeries(t)),
                (this.yRatio = s.getLogYRatios(this.yRatio)),
                this.barHelpers.initVariables(t),
                '100%' === a.config.chart.stackType && (t = a.globals.seriesPercent.slice()),
                (this.series = t),
                (this.totalItems = 0),
                (this.prevY = []),
                (this.prevX = []),
                ...
                var o = this.graphics.group({ class: 'apexcharts-bar-series apexcharts-plot-series' }),
                  ...
                  c = function (s, r) {
                    ...
                    i.yRatio.length > 1 && (i.yaxisIndex = b),
                      (i.isReversed = a.config.yaxis[i.yaxisIndex] && a.config.yaxis[i.yaxisIndex].reversed);
                    ...
                    var v = i.graphics.group({ class: 'apexcharts-datalabels', 'data:realIndex': b }),
                      y = 0,
                      w = 0,
                    ...
                    for (var A = 0; A < a.globals.dataPoints; A++) {
                      var S = i.barHelpers.getStrokeWidth(s, A, b),
                        ...
                        L = null;
                      i.isHorizontal
                        ? ((L = i.drawStackedBarPaths(n({}, C, { zeroW: f, barHeight: y, yDivision: d }))),
                          (w = i.series[s][A] / i.invertedYRatio))
                        : ((L = i.drawStackedColumnPaths(n({}, C, { xDivision: c, barWidth: w, zeroH: u }))),
            ...
            value: function (t) {
              ...
              if (g > 0) {
                ...
                this.prevXVal[g - 1][u] < 0
                  ? (b =
                      this.series[g][u] >= 0
                        ? this.prevX[g - 1][u] + p - 2 * (this.isReversed ? p : 0)
                        : this.prevX[g - 1][u])
                  : this.prevXVal[g - 1][u] >= 0 &&
                    (b =
                      this.series[g][u] >= 0
              ...
              (n =
                null === this.series[g][u]
                  ...
                  : e +
                    ...
                    2 * (this.isReversed ? this.series[g][u] / this.invertedYRatio : 0)),
                this.xArrj.push(n),
              ...
              return (
                this.barHelpers.barBackground({ bc: f, i: g, y1: d, y2: a, elSeries: h }),
                (o += l),
                { pathTo: m.pathTo, pathFrom: m.pathFrom, x: n, y: o }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                (h > 0 && l.globals.isXNumeric && l.globals.seriesX[h - 1][c] === l.globals.seriesX[h][c])
              ) {
                var b,
                  m,
              ...
              (a =
                ...
                2 * (this.isReversed ? this.series[h][c] / this.yRatio[this.yaxisIndex] : 0)),
                this.yArrj.push(a),
              ...
              return (
                this.barHelpers.barBackground({ bc: d, i: h, x1: f, x2: r, elSeries: o }),
                (i += s),
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              ...
              (t = r.getLogSeries(t)),
                ...
                this.barHelpers.initVariables(t);
              for (
                var n = a.group({ class: 'apexcharts-candlestick-series apexcharts-plot-series' }), o = 0;
                o < t.length;
                o++
              ) {
                var l,
                ...
                (d = w.y),
                  ...
                  f.push(c + y / 2);
                for (
                  var k = a.group({ class: 'apexcharts-datalabels', 'data:realIndex': x }), A = 0;
                  ...
                  (d = P.y), (c = P.x), (S = P.color), A > 0 && f.push(c + y / 2), u.push(d);
                  var T = s.fillPath({ seriesNumber: x, dataPointIndex: A, color: S, value: t[o][A] }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              void 0 === this.series[h][c] || null === this.series[h][c]
                ? (y = r)
                : ((y = r - y / f), (w = r - w / f), (m = r - b.h / f), (v = r - b.l / f));
              var A = l.move(k, r),
                S = l.move(k, y);
              return (
                o.globals.previousPaths.length > 0 && (S = this.getPreviousPath(x, c, !0)),
                (A =
                  l.move(k, w) +
                  l.line(k + s / 2, w) +
                  l.line(k + s / 2, m) +
                ...
                for (var f = 0, x = 0; x < l[h].length; x++) {
                  ...
                  b =
                    e.globals.hasNegs || this.negRange
                      ? e.config.plotOptions.heatmap.reverseNegativeShade
                        ? v.percent < 0
                          ? (v.percent / 100) * (1.25 * m)
                          : (1 - v.percent / 100) * (1.25 * m)
                        : v.percent <= 0
                          ? 1 - (1 + v.percent / 100) * m
                          : (1 - v.percent / 100) * m
                      : 1 - v.percent / 100;
                  ...
                  if (
                    (e.config.plotOptions.heatmap.enableShades &&
                      (b < 0 && (b = 0), (y = g.hexToRgba(w.shadeColor(b, v.color), e.config.fill.opacity))),
                    'image' === e.config.fill.type)
                  )
                    y = new L(this.ctx).fillPath({
                      seriesNumber: h,
                      dataPointIndex: x,
                  ...
                  if (e.globals.dataChanged) {
                    ...
                    if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                      ...
                      P || (P = 'rgba(255, 255, 255, 0)'),
                        this.animateHeatColor(
                          A,
                          g.isColorHex(P) ? P : g.rgb2hex(P),
                          g.isColorHex(y) ? y : g.rgb2hex(y),
                          C,
                        );
                    }
                  }
                  var T = this.calculateHeatmapDataLabels({
                    x: f,
                    y: n,
                    i: h,
                    j: x,
            ...
            value: function (t, e) {
              ...
              s.distributed || ((l = i.globals.minY), (h = i.globals.maxY)),
                void 0 !== s.colorScale.min &&
                  ((l = s.colorScale.min < i.globals.minY ? s.colorScale.min : i.globals.minY),
                  (h = s.colorScale.max > i.globals.maxY ? s.colorScale.max : i.globals.maxY));
            ...
            value: function (t) {
              ...
              if (h.enabled) {
                ...
                var f = h.offsetX,
                  ...
                  v = g(l.globals.series[a][s], { seriesIndex: a, dataPointIndex: s, w: l });
    ...
    kt = (function () {
      function t(i) {
        ...
        (this.lineColorArr = void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors),
          (this.defaultSize = a.globals.svgHeight < a.globals.svgWidth ? a.globals.gridHeight : a.globals.gridWidth),
          ...
          (a.globals.radialSize =
            ...
            (a.config.chart.sparkline.enabled ? 0 : a.config.chart.dropShadow.blur)),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                o.attr({ transform: 'translate('.concat(v, ', ').concat(y, ') scale(').concat(x, ')') }),
                o.add(k),
                this.ret.add(o),
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                if (
                  (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                    ...
                    : (0 === (k = ((h - o) / this.fullAngle) * i.config.chart.animations.speed) && (k = 1),
                  ...
                  if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                    ...
                    void 0 !== P && (C = P(i.globals.seriesPercent[d][0], { seriesIndex: d, w: i }));
                    ...
                    z.node.classList.add('apexcharts-pie-label'),
                      i.config.chart.animations.animate &&
                        ...
                        (z.node.style.animationDelay = i.config.chart.animations.speed / 940 + 's')),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              void 0 !== e.prevStartAngle &&
                ...
                ((r = e.prevEndAngle), (s = e.prevEndAngle - e.prevStartAngle)),
                e.i === i.config.series.length - 1 &&
                  (a + n > this.fullAngle
                    ? (e.endAngle = e.endAngle - (a + n))
                    : a + n < this.fullAngle && (e.endAngle = e.endAngle + (this.fullAngle - (a + n)))),
              ...
              l.globals.dataChanged &&
                ...
                0 !== r.dur
                  ? t
                      ...
                      .during(function (l) {
                        (d = u + (a - u) * l),
                          r.animateStartingPos && ((d = s + (a - s) * l), (g = e - s + (i - (e - s)) * l)),
                          (n = o.getPiePath({ me: o, startAngle: g, angle: d, size: c })),
                          t.node.setAttribute('data:pathOrig', n),
                          t.attr({ d: n });
                      })
                  : ((n = o.getPiePath({ me: o, startAngle: g, angle: a, size: c })),
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                ...
                s = i.globals.dom.Paper.select('.apexcharts-'.concat(this.chartType.toLowerCase(), '-slice-').concat(t))
                  .members[0];
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var l = (Math.PI * (o - 90)) / 180,
                ...
                x = a > 180 ? 1 : 0,
                b = ['M', h, c, 'A', s, s, 0, x, 1, d, u];
              return 'donut' === e.chartType
                ? []
                    .concat(b, ['L', f.x, f.y, 'A', e.donutSize, e.donutSize, 0, x, 0, p.x, p.y, 'L', h, c, 'z'])
                    .join(' ')
            ...
            value: function () {
              ...
              for (var c = t.globals.radialSize, d = c / (h - 1), g = 0; g < h - 1; g++) {
                ...
                if (
                  ...
                  var f = a.drawYAxisTexts(
                    this.centerX,
                    this.centerY - c + parseInt(t.config.yaxis[0].labels.style.fontSize, 10) / 2,
                    g,
                    l[g],
                  );
                  r.add(f);
            ...
            value: function (t, e) {
              ...
              if (
                (r
                  ...
                  : 1 === i.globals.series.length && ((f = u(i.globals.series[0], i)), (x = i.globals.seriesNames[0])),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              a
                ? (s =
                    void 0 === t.name.color
                      ? r.globals.colors[parseInt(a.parentNode.getAttribute('rel'), 10) - 1]
                      : t.name.color)
                : r.globals.series.length > 1 && t.total.show && (s = t.total.color);
              ...
              (i = (0, t.value.formatter)(i, r)),
                a || 'function' != typeof t.total.formatter || (i = t.total.formatter(r));
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if ((l({ makeSliceOut: !0, printLabel: !1 }), e.total.show && s.globals.series.length > 1))
                  ...
                  if (s.globals.selectedDataPoints[0].length > 0) {
                    var h = s.globals.selectedDataPoints[0],
                      c = s.globals.dom.baseEl.querySelector(
                        '.apexcharts-'.concat(this.chartType.toLowerCase(), '-slice-').concat(h),
                      );
    ...
    At = (function () {
      function t(i) {
        ...
        (this.strokeWidth = a.config.stroke.show ? a.config.stroke.width : 0),
          ...
          a.config.xaxis.labels.show && (this.size = this.size - r.width / 1.75),
            ...
            value: function (t) {
              ...
              if (
                ...
                t.forEach(function (t, o) {
                  ...
                  var c = e.createPaths(f, { x: 0, y: 0 });
                  (p = e.graphics.group({ class: 'apexcharts-series-markers-wrap apexcharts-element-hidden' })),
                    (x = e.graphics.group({ class: 'apexcharts-datalabels', 'data:realIndex': o })),
                  ...
                  t.forEach(function (t, a) {
                    ...
                    c && c.add(l), p.add(c), h.add(p);
                    var d = i.config.dataLabels;
                    if (d.enabled) {
                      var g = d.formatter(i.globals.series[o][a], { seriesIndex: o, dataPointIndex: a, w: i });
      ...
      function i(t) {
        ...
        return (
          ...
          (a.totalAngle = Math.abs(
            s.config.plotOptions.radialBar.endAngle - s.config.plotOptions.radialBar.startAngle,
          )),
          ...
          (a.fullAngle = 360 - s.config.plotOptions.radialBar.endAngle - s.config.plotOptions.radialBar.startAngle),
            ...
            value: function (t) {
              ...
              var o = e.config.plotOptions.radialBar.hollow.background,
                l =
                  ...
                  (n * parseInt(e.config.plotOptions.radialBar.track.strokeWidth, 10)) / 100 / 2,
              ...
              var c = this.drawHollow({ size: h, centerX: t.centerX, centerY: t.centerY, fill: o || 'transparent' });
              ...
              for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                ...
                var y = a.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                  w = this.startAngle,
                  k = void 0,
                ...
                e.globals.dataChanged &&
                  ((k = this.startAngle),
                  (C = Math.round((this.totalAngle * g.negToZero(e.globals.previousPaths[m])) / 100) + k)),
                ...
                if (
                  (p.setAttrs(z.node, { 'data:angle': P, 'data:value': t.series[m] }),
                  e.config.chart.dropShadow.enabled)
                ) {
                  var I = e.config.chart.dropShadow;
                  s.dropShadow(z, I, m);
                }
                this.addListeners(z, this.radialDataLabels), v.add(z), z.attr({ index: 0, j: m });
                var M = 0;
                !this.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
                  ...
                  this.animBeginArr.push(this.animDur)),
                  e.globals.dataChanged &&
                    ((M = ((S - w) / 360) * e.config.chart.animations.dynamicAnimation.speed),
                    (this.animDur = M / (1.2 * t.series.length) + this.animDur),
                    this.animBeginArr.push(this.animDur)),
                  this.animatePaths(z, {
                    centerX: t.centerX,
              ...
              if (s.config.plotOptions.radialBar.hollow.imageClipped)
                ...
                if (void 0 === l && void 0 === h) {
                  var c = s.globals.dom.Paper.image(o).loaded(function (e) {
                    this.move(
                      t.centerX - e.width / 2 + s.config.plotOptions.radialBar.hollow.imageOffsetX,
                      t.centerY - e.height / 2 + s.config.plotOptions.radialBar.hollow.imageOffsetY,
                    );
                  });
                  e.add(c);
                } else {
                  var d = s.globals.dom.Paper.image(o).loaded(function (e) {
                    this.move(
                      t.centerX - l / 2 + s.config.plotOptions.radialBar.hollow.imageOffsetX,
                      t.centerY - h / 2 + s.config.plotOptions.radialBar.hollow.imageOffsetY,
                    ),
                      this.size(l, h);
                  });
                  e.add(d);
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                new m(this.lineCtx.ctx, i).seriesHaveSameValues(t)
              ) {
                var a = e[t].slice();
            ...
            value: function (t) {
              ...
              if (0 === n) {
                ...
                l.globals.isXNumeric &&
                  ...
                  h.push(d),
                  c.push(g.isNumber(e[r][0]) ? o + l.config.markers.offsetY : null),
                  h.push(a + l.config.markers.offsetX),
                  c.push(g.isNumber(e[r][n + 1]) ? s + l.config.markers.offsetY : null);
              } else
                h.push(a + l.config.markers.offsetX),
                  c.push(g.isNumber(e[r][n + 1]) ? s + l.config.markers.offsetY : null);
              return { x: h, y: c };
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = t.pathFromLine, i = t.pathFromArea, a = t.realIndex, s = this.w, r = 0;
                ...
                ('line' === n.type || 'area' === n.type) &&
                  ...
                  ('line' === n.type
                    ? ((this.lineCtx.appendPathFrom = !1), (e = s.globals.previousPaths[r].paths[0].d))
                    : 'area' === n.type &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (void 0 !== i[e][0])
                a =
                  (s = r.config.chart.stacked && e > 0 ? this.lineCtx.prevSeriesY[e - 1][0] : this.lineCtx.zeroY) -
                  i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] +
                  2 * (this.lineCtx.isReversed ? i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0);
    ...
    Lt = (function () {
      function t(i, a, s) {
        e(this, t),
          ...
          (this.w = i.w),
          (this.xyRatios = a),
          (this.pointsChart = !('bubble' !== this.w.config.chart.type && 'scatter' !== this.w.config.chart.type) || s),
          (this.scatter = new T(this.ctx)),
          (this.noNegatives = this.w.globals.minX === Number.MAX_VALUE),
          (this.lineHelpers = new Ct(this)),
        ...
        a(t, [
              ...
              for (var l = [], h = 0; h < t.length; h++) {
                ...
                this.ctx.series.addCollapsedClassToSeries(this.elSeries, c),
                  a.globals.isXNumeric &&
                    ...
                    (u = (a.globals.seriesX[c][0] - a.globals.minX) / this.xRatio),
                  g.push(u);
                var f,
                  x = u,
                  b = x,
                  v = this.zeroY;
                (v = this.lineHelpers.determineFirstPrevY({ i: h, series: t, prevY: v, lineYPosition: 0 }).prevY),
                  d.push(v),
                  (f = v);
                var y = this._calculatePathsFrom({ series: t, i: h, realIndex: c, prevX: b, prevY: v }),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = this.w,
                s = new p(this.ctx);
              (this.xDivision =
                a.globals.gridWidth / (a.globals.dataPoints - ('on' === a.config.xaxis.tickPlacement ? 1 : 0))),
                ...
                this.zeroY > a.globals.gridHeight && (this.areaBottomY = a.globals.gridHeight),
              ...
              this.elSeries.attr({ 'data:longestSeries': r, rel: e + 1, 'data:realIndex': i }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if ('area' === e)
                for (var c = l.fillPath({ seriesNumber: i }), d = 0; d < s.areaPaths.length; d++) {
                  var g = o.renderPaths(
                    n({}, h, {
            ...
            value: function (t) {
              for (
                var e = t.series,
                  ...
                  A = l.pathFromLine,
                  S = l.pathFromArea,
                  C = g.isNumber(b.globals.minYArr[i]) ? b.globals.minYArr[i] : b.globals.minY,
                  L = b.globals.dataPoints > 1 ? b.globals.dataPoints - 1 : b.globals.dataPoints,
                  P = 0;
                P < L;
                P++
              ) {
                ...
                if (b.globals.isXNumeric) {
                  ...
                  void 0 === b.globals.seriesX[i][P + 1] && (z = b.globals.seriesX[i][L - 1]),
                    (s = (z - b.globals.minX) / this.xRatio);
                } else s += this.xDivision;
                if (b.config.chart.stacked)
                ...
                (r = T
                  ? u - C / v[this.yaxisIndex] + 2 * (this.isReversed ? C / v[this.yaxisIndex] : 0)
                  : u -
                    e[a][P + 1] / v[this.yaxisIndex] +
                    2 * (this.isReversed ? e[a][P + 1] / v[this.yaxisIndex] : 0)),
                  f.push(s),
                  x.push(r);
                var I = this.lineHelpers.calculatePoints({ series: e, x: s, y: r, realIndex: i, i: a, j: P, prevY: y }),
                  M = this._createPaths({
                    series: e,
                    i: a,
                    realIndex: i,
                ...
                (c = M.areaPaths),
                  ...
                  (k = M.areaPath),
                  (w = M.linePath),
                  this.appendPathFrom && ((A += m.line(s, this.zeroY)), (S += m.line(s, this.zeroY))),
            ...
            value: function (t) {
              ...
              if (
                (Array.isArray(f.config.stroke.curve) &&
                  (b = Array.isArray(u) ? f.config.stroke.curve[u[i]] : f.config.stroke.curve[i]),
                'smooth' === b)
              ) {
                var v = 0.35 * (r - o);
                f.globals.hasNullValues
                  ? (null !== e[i][s] &&
                      (null !== e[i][s + 1]
                        ? ((h = x.move(o, l) + x.curve(o + v, l, r - v, n, r + 1, n)),
                          (c =
                            x.move(o + 1, l) +
                            x.curve(o + v, l, r - v, n, r + 1, n) +
                            x.line(r, m) +
                            x.line(o, m) +
                            'z'))
                        : ((h = x.move(o, l)), (c = x.move(o, l) + 'z'))),
                    d.push(h),
                    g.push(c))
                  : ((h += x.curve(o + v, l, r - v, n, r, n)), (c += x.curve(o + v, l, r - v, n, r, n))),
                  (o = r),
                  (l = n),
                  s === e[i].length - 2 &&
                    ((c = c + x.curve(o, l, r, n, r, m) + x.move(r, n) + 'z'),
                ...
                null === e[i][s] && ((h += x.move(r, n)), (c += x.move(r, m))),
                  'stepline' === b
                    ? ((h = h + x.line(r, null, 'H') + x.line(null, n, 'V')),
                      (c = c + x.line(r, null, 'H') + x.line(null, n, 'V')))
                    : 'straight' === b && ((h += x.line(r, n)), (c += x.line(r, n))),
                  s === e[i].length - 2 && ((c = c + x.line(r, m) + x.move(r, n) + 'z'), d.push(h), g.push(c));
              }
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              this.determineInterval(r),
                ...
                r < 0.005 ? (a.globals.disableZoomIn = !0) : r > 5e4 && (a.globals.disableZoomOut = !0);
              ...
              return m.filter(function (t) {
                var e = 1,
                  ...
                  r = t.value;
                void 0 !== a.config.xaxis.tickAmount && (s = a.config.xaxis.tickAmount),
            ...
            value: function (t) {
              ...
              if (e.minDate > 1 || e.minMonth > 0) {
                ...
                (o = (l.determineDaysOfYear(e.minYear) - h + 1) * s),
                  (n = e.minYear + 1),
                  this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: n, month: g.monthMod(i + 1) });
              } else
                1 === e.minDate &&
                  0 === e.minMonth &&
                  this.timeScaleArray.push({ position: o, value: n, unit: 'year', year: a, month: g.monthMod(i + 1) });
              for (var c = n, d = o, u = 0; u < r; u++)
                c++,
                  (d = l.determineDaysOfYear(c - 1) * s + d),
                  this.timeScaleArray.push({ position: d, value: c, unit: 'year', year: c, month: 1 });
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (e.minDate > 1) {
                ...
                var u = s + d,
                  f = g.monthMod(o),
                  p = o;
                0 === o && ((c = 'year'), (p = u), (f = 1), (u += d += 1)),
                  this.timeScaleArray.push({ position: l, value: p, unit: c, year: u, month: f });
          ...
          },
          {
            ...
            value: function (t) {
              ...
              0 === e.minHour &&
                1 === e.minDate &&
                ((d = 0), (u = g.monthMod(e.minMonth)), (o = 'month'), (h = e.minDate), r++),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                (i += 'minute' === t.unit ? ':' + ('0' + e).slice(-2) + ':00' : ':00:00'),
                this.utc && (i += '.000Z'),
                i
              );
            },
        ...
        a(t, [
          {
            ...
            value: function () {
              var t = this.w.globals,
                ...
                i = e.chart.type;
              (t.axisCharts =
                ['line', 'area', 'bar', 'rangeBar', 'candlestick', 'scatter', 'bubble', 'radar', 'heatmap'].indexOf(i) >
                -1),
              ...
              if (s.comboCharts) {
                if ((n.series.length > 0 && x.push(d.draw(n.series, 'area', n.i)), h.series.length > 0))
                  if (i.config.chart.stacked) {
                    ...
                    var m = new E(this.ctx, e);
                    x.push(m.draw(h.series, h.i));
                  }
                if (
                  (r.series.length > 0 && x.push(d.draw(r.series, 'line', r.i)),
                  c.series.length > 0 && x.push(g.draw(c.series, c.i)),
                  o.series.length > 0)
                ) {
                  var v = new Lt(this.ctx, e, !0);
                  x.push(v.draw(o.series, 'scatter', o.i));
                }
                if (l.series.length > 0) {
                  var y = new Lt(this.ctx, e, !0);
                ...
                switch (a.chart.type) {
                  ...
                  case 'bar':
                    ...
                    else x = new E(this.ctx, e).draw(s.series);
                    break;
                  case 'candlestick':
                  ...
                  case 'rangeBar':
                    ...
                    break;
                  case 'heatmap':
                    x = new yt(this.ctx, e).draw(s.series);
                    break;
                  case 'pie':
                  case 'donut':
                  case 'polarArea':
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ('%' === a
                  ? g.isNumber(i[0]) &&
                    (0 === i[0].width && (i = g.getDimensions(this.el.parentNode)),
              ...
              t.svgWidth < 0 && (t.svgWidth = 0),
                ...
                p.setAttrs(t.dom.Paper.node, { width: t.svgWidth, height: t.svgHeight });
          ...
          },
          {
            ...
            value: function () {
              ...
              p.setAttrs(t.dom.elGraphical.node, i),
                (t.x2SpaceAvailable = t.svgWidth - t.dom.elGraphical.x() - t.gridWidth);
            },
          },
          {
            ...
            value: function () {
              ...
              e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute('height', l),
                ...
                p.setAttrs(e.dom.Paper.node, { height: l }),
              ...
              if (e.globals.axisCharts) {
                ...
                if ('datetime' === e.config.xaxis.type && void 0 === e.config.xaxis.labels.formatter) {
                  ...
                  isFinite(e.globals.minX) && isFinite(e.globals.maxX) && !e.globals.isBarHorizontal
                    ...
                    : e.globals.isBarHorizontal && (a = i.calculateTimeScaleTicks(e.globals.minY, e.globals.maxY)),
              ...
              r && (o = this.ctx.getSyncedCharts()),
                ...
                o.forEach(function (r) {
                  ...
                  return (
                    ...
                    a || ((o.globals.resized = !0), (o.globals.dataChanged = !0), s && r.series.getPreviousPaths()),
                    e &&
                      'object' === t(e) &&
                      ((r.config = new D(e)),
                      (e = m.extendArrayProps(r.config, e, o)),
                      r.w.globals.chartID !== i.ctx.w.globals.chartID && delete e.series,
                      (o.config = g.extend(o.config, e)),
                      n &&
                        ((o.globals.lastXAxis = []),
                        (o.globals.lastYAxis = []),
                        (o.globals.initialConfig = g.extend({}, o.config)),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                s &&
                  ((r.globals.initialConfig.series = JSON.parse(JSON.stringify(r.config.series))),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                a
                  ? (new p(this.ctx).pathMouseDown(a, null), a.node ? a.node : null)
            ...
            value: function () {
              ...
              (e.config.xaxis.min = e.globals.lastXAxis.min),
                ...
                e.config.yaxis.map(function (i, a) {
                  e.globals.zoomed
                    ? void 0 !== e.globals.lastYAxis[a] &&
                      ((i.min = e.globals.lastYAxis[a].min), (i.max = e.globals.lastYAxis[a].max))
                    : void 0 !== t.ctx.opts.yaxis[a] &&
                      ((i.min = t.ctx.opts.yaxis[a].min), (i.max = t.ctx.opts.yaxis[a].max));
                });
            },
          },
        ]),
  ...
  (w = 'undefined' != typeof window ? window : void 0),
      ...
      (a.PathArray = function (t, e) {
        ...
        a.extend(a.PathArray, {
          ...
          at: function (t) {
            ...
            for (
              var e = this.value, i = this.destination.value, s = [], r = new a.PathArray(), n = 0, o = e.length;
              n < o;
              n++
            ) {
              s[n] = [e[n][0]];
          ...
          parse: function (t) {
            ...
            var r = [],
              ...
              c = t.length;
            do {
              a.regex.isPathLetter.test(t[l]) ? ((e = t[l]), ++l) : 'M' == e ? (e = 'L') : 'm' == e && (e = 'l'),
                r.push(s[e].call(null, t.slice(l, (l += i[e.toUpperCase()])).map(parseFloat), n, o));
            } while (c > l);
            return r;
          },
          bbox: function () {
            return (
              a.parser.draw || a.prepare(), a.parser.path.setAttribute('d', this.toString()), a.parser.path.getBBox()
            );
          },
        }),
        (a.Number = a.invent({
              ...
              'number' == typeof t
                ...
                : 'string' == typeof t
                  ? (e = t.match(a.regex.numberAndUnit)) &&
                    ...
                    (this.unit = e[5]))
                  : t instanceof a.Number && ((this.value = t.valueOf()), (this.unit = t.unit));
          },
          extend: {
            toString: function () {
              return (
        ...
        (a.FX = a.invent({
          ...
          extend: {
            ...
            queue: function (t) {
              return (
                ('function' == typeof t || t instanceof a.Situation) && this.situations.push(t),
            ...
            initAnimations: function () {
              ...
              for (var i in e.animations) {
                (t = this.target()[i]()),
                  Array.isArray(t) || (t = [t]),
                  Array.isArray(e.animations[i]) || (e.animations[i] = [e.animations[i]]);
                for (var s = t.length; s--; )
                  e.animations[i][s] instanceof a.Number && (t[s] = new a.Number(t[s])),
            ...
            step: function (t) {
              ...
              for (var r in this.situation.once)
                r > this.lastPos &&
                  r <= s &&
                  (this.situation.once[r].call(this.target(), this.pos, s), delete this.situation.once[r]);
              return (
                this.active &&
                  this.target().fire('during', { pos: this.pos, eased: s, fx: this, situation: this.situation }),
                this.situation
                  ? (this.eachAt(),
              ...
              if (s.transforms.length) {
                ...
                for (var n = s.transforms.length; r < n; r++) {
                  ...
                  o instanceof a.Matrix
                    ...
                    : (o.relative || o.undo(t.extract()), (t = t.multiply(o.at(s.ease(this.pos)))));
                }
                i.matrix(t);
              }
              return this;
          ...
          attr: function (e, i, s) {
            ...
            if ('object' === t(e)) for (var r in e) this.attr(r, e[r]);
              ...
              'stroke-width' == e
                ...
                ('fill' != e && 'stroke' != e) ||
                  (a.regex.isImage.test(i) && (i = this.doc().defs().image(i, 0, 0)),
        ...
        a.extend(a.Element, {
          transform: function (e, i) {
            var s;
            return 'object' !== t(e)
              ? ((s = new a.Matrix(this).extract()), 'string' == typeof e ? s[e] : s)
              : ((s = new a.Matrix(this)),
                (i = !!i || !!e.relative),
        ...
        (a.Transformation = a.invent({
          create: function (e, i) {
            ...
            if (Array.isArray(e)) for (var a = 0, s = this.arguments.length; a < s; ++a) this[this.arguments[a]] = e[a];
            else if ('object' === t(e))
        ...
        a.extend(a.Parent, {
          ungroup: function (t, e) {
            return 0 === e || this instanceof a.Defs || this.node == a.parser.draw
              ? this
              : ((t = t || (this instanceof a.Doc ? this : this.parent(a.Parent))),
                (e = e || 1 / 0),
                this.each(function () {
        ...
        (a.off = function (t, e, i) {
          ...
          if (-1 != s)
            if (i) {
              ...
              a.listeners[s][r] &&
                a.listeners[s][r][n || '*'] &&
                (t.removeEventListener(r, a.listeners[s][r][n || '*'][i], !1), delete a.listeners[s][r][n || '*'][i]);
            } else if (n && r) {
              ...
              for (var h in a.listeners[s]) for (var o in a.listeners[s][h]) n === o && a.off(t, [h, n].join('.'));
            else if (r) {
              if (a.listeners[s][r]) {
          ...
          fire: function (t, i) {
            return (
              t instanceof e.Event
                ...
                : this.node.dispatchEvent((t = new a.CustomEvent(t, { detail: i, cancelable: !0 }))),
              (this._event = t),
              this
            );
          },
          ...
          create: function (t) {
            t &&
              ('svg' == (t = 'string' == typeof t ? i.getElementById(t) : t).nodeName
                ? this.constructor.call(this, t)
                : (this.constructor.call(this, a.create('svg')), t.appendChild(this.node), this.size('100%', '100%')),
              this.namespace().defs());
          },
          inherit: a.Container,
          extend: {
        ...
        (a.Line = a.invent({
          ...
          extend: {
            ...
            plot: function (t, e, i, s) {
              return null == t
                ? this.array()
                : ((t = void 0 !== e ? { x1: t, y1: e, x2: i, y2: s } : new a.PointArray(t).toLine()), this.attr(t));
            },
            move: function (t, e) {
        ...
        a.extend(a.Polyline, a.Polygon, {
          ...
          plot: function (t) {
            return null == t
              ? this.array()
              : this.clear().attr('points', 'string' == typeof t ? t : (this._array = new a.PointArray(t)));
          },
          clear: function () {
        ...
        (a.Path = a.invent({
          ...
          extend: {
            ...
            plot: function (t) {
              return null == t
                ? this.array()
                : this.clear().attr('d', 'string' == typeof t ? t : (this._array = new a.PathArray(t)));
            },
            clear: function () {
              return delete this._array, this;
            },
            ...
            load: function (t) {
              ...
              return (
                a.on(s, 'load', function () {
                  ...
                  null !== e &&
                    (0 == i.width() && 0 == i.height() && i.size(s.width, s.height),
                    e && 0 == e.width() && 0 == e.height() && e.size(i.width(), i.height()),
                    'function' == typeof i._loaded &&
                      i._loaded.call(i, { width: s.width, height: s.height, ratio: s.width / s.height, url: t }));
                }),
      ...
      ['fill', 'stroke'].forEach(function (t) {
        ...
        a.extend(a.Element, {
          remember: function (e, i) {
            if ('object' === t(arguments[0])) for (var a in e) this.remember(a, e[a]);
            else {
    ...
    function () {
      ...
      var e = {
          ...
          gaussianBlur: function (t, e) {
            null != t || null != e
              ? this.attr('stdDeviation', r(Array.prototype.slice.call(arguments)))
      ...
      function t(t, s, r, n, o, l, h) {
        for (
          ...
          if (
            ((c[g] = e.call(u, c[g])),
            (d[g] = e.call(f, d[g])),
            c[g][0] != d[g][0] || 'M' == c[g][0] || ('A' == c[g][0] && (c[g][4] != d[g][4] || c[g][5] != d[g][5]))
            ...
            break;
          g == c.length && c.push(['C', u.pos[0], u.pos[1], u.pos[0], u.pos[1], u.pos[0], u.pos[1]]),
            g == d.length && d.push(['C', f.pos[0], f.pos[1], f.pos[0], f.pos[1], f.pos[0], f.pos[1]]);
        }
        ...
        switch (t[0]) {
          ...
          case 'A':
            t = (e = (function (t, e) {
              ...
              (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(new SVG.Matrix().rotate(I))),
                (a = (i.x * i.x) / (T * T) + (i.y * i.y) / (z * z)) > 1 && ((a = Math.sqrt(a)), (T *= a), (z *= a));
              (s = new SVG.Matrix()
                .rotate(I)
                .scale(1 / T, 1 / z)
                .rotate(-I)),
                ...
                M === X && (l *= -1);
              (h = new SVG.Point((R.x + F.x) / 2 + l * -r[1], (R.y + F.y) / 2 + l * r[0])),
              ...
              for (
                ...
                (y = Math.cos(m)),
                  ...
                  (b[k] = [new SVG.Point(w.x + x * v, w.y - x * y), w, new SVG.Point(w.x - x * v, w.y + x * y)]),
                  (m += f);
              for (
                b[0][0] = b[0][1].clone(),
    ...
    function () {
      ...
      (t.prototype.init = function (t, e) {
        ...
        (t.prototype.drag = function (t) {
          ...
          if (
            (this.el.fire('dragmove', { event: t, p: i, m: this.m, handler: this }), this.el.event().defaultPrevented)
          )
            return i;
          if ('function' == typeof r) {
            ...
            'object' == typeof r &&
              (null != r.minX && a < r.minX
                ...
                : null != r.maxX && a > r.maxX - e.width && (n = (a = r.maxX - e.width) - this.startPoints.box.x),
              null != r.minY && s < r.minY
                ? (o = (s = r.minY) - this.startPoints.box.y)
                : null != r.maxY && s > r.maxY - e.height && (o = (s = r.maxY - e.height) - this.startPoints.box.y),
              null != r.snapToGrid &&
                ((a -= a % r.snapToGrid), (s -= s % r.snapToGrid), (n -= n % r.snapToGrid), (o -= o % r.snapToGrid)),
              this.el instanceof SVG.G
                ? this.el.matrix(this.startPoints.transform).transform({ x: n, y: o }, !0)
                : this.el.move(a, s));
          return i;
        }),
        ...
        SVG.extend(SVG.Element, {
          draggable: function (e, i) {
            ...
            return (
              (e = void 0 === e || e) ? a.init(i || {}, e) : (this.off('mousedown.drag'), this.off('touchstart.drag')),
              this
            );
          },
        });
      ...
      (t.prototype.init = function (t, e) {
        ...
        (t.prototype.selectPoints = function (t) {
          return (
            ...
            this.pointSelection.set ? this : ((this.pointSelection.set = this.parent.set()), this.drawPoints(), this)
          );
        }),
        ...
        (t.prototype.transformPoint = function (t, e, i) {
              ...
              case 'rot':
                this.calc = function (t, e) {
                  ...
                  this.el
                    ...
                    .rotate(n - (n % this.options.snapToAngle), this.parameters.box.cx, this.parameters.box.cy);
                };
                break;
              case 'point':
                this.calc = function (t, e) {
                  ...
                  (a[this.parameters.i][0] = this.parameters.pointCoords[0] + i[0]),
                    (a[this.parameters.i][1] = this.parameters.pointCoords[1] + i[1]),
                    this.el.plot(a);
                };
            }
            ...
            return (
              ...
              (t -=
                Math.abs(s[0]) < this.options.snapToGrid / 2
                  ? s[0]
                  : s[0] - (t < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
              (e -=
                Math.abs(s[1]) < this.options.snapToGrid / 2
                  ? s[1]
                  : s[1] - (e < 0 ? -this.options.snapToGrid : this.options.snapToGrid)),
          ...
          (t.prototype.constraintToBox = function (t, e, i, a) {
            ...
            return (
              void 0 !== a
                ? ((s = i), (r = a))
                : ((s = this.parameters.box.x + (1 & i ? 0 : this.parameters.box.width)),
          ...
          (t.prototype.checkAspectRatio = function (t, e) {
            ...
            return (
              n < a
                ? ((i[1] = s / a - this.parameters.box.height), e && (i[1] = -i[1]))
                : n > a && ((i[0] = this.parameters.box.width - r * a), e && (i[0] = -i[0])),
              i
            );
          }),
          SVG.extend(SVG.Element, {
  ...
  !(function (t, e) {
    ...
    if (t && 'undefined' != typeof document) {
      ...
      (s.type = 'text/css'),
        'top' === i && a.firstChild ? a.insertBefore(s, a.firstChild) : a.appendChild(s),
    ...
    (function () {
      function t(t) {
        ...
        a && ((a.scrollLeft = a.scrollWidth), (a.scrollTop = a.scrollHeight)),
          s && ((s.style.width = i.offsetWidth + 1 + 'px'), (s.style.height = i.offsetHeight + 1 + 'px')),
        ...
        (window.removeResizeListener = function (t, i) {
          t &&
            ...
            t.__resizeListeners__.length ||
              ...
              t.__resizeTriggers__.parentNode && (t.__resizeTriggers__ = !t.removeChild(t.__resizeTriggers__))));
        });
    })(),
    (window.Apex = {});
  var It = (function () {
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.animations = new f(this.ctx)),
                (this.ctx.axes = new J(this.ctx)),
                (this.ctx.core = new Tt(this.ctx.el, this.ctx)),
                (this.ctx.config = new D({})),
                (this.ctx.data = new O(this.ctx)),
                (this.ctx.grid = new _(this.ctx)),
                (this.ctx.graphics = new p(this.ctx)),
                (this.ctx.coreUtils = new m(this.ctx)),
                ...
                (this.ctx.updateHelpers = new zt(this.ctx)),
  ...
  return (function () {
    function t(i, a) {
      e(this, t),
        ...
        (this.w = new N(a).init()),
        (this.el = i),
        (this.w.globals.cuid = g.randomId()),
        (this.w.globals.chartID = this.w.config.chart.id ? this.w.config.chart.id : this.w.globals.cuid),
        new It(this).initModules(),
        (this.create = g.bind(this.create, this)),
        ...
        [
              ...
              return new Promise(function (e, i) {
                if (null !== t.el) {
                  ...
                  'function' == typeof a && a(t, t.w),
                    ...
                    window.addResizeListener(t.el.parentNode, t._parentResizeCallback.bind(t));
                  var s = t.create(t.w.config.series, {});
                  if (!s) return e(t);
                  t.mount(s)
                    .then(function () {
                      'function' == typeof t.w.config.chart.events.mounted && t.w.config.chart.events.mounted(t, t.w),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.config.xaxis.convertedCatToNumeric) && new R(i.config).convertCatToNumericXaxis(i.config, this.ctx);
              ...
              (a.comboCharts = s.comboCharts),
                ...
                (a.noData && a.collapsedSeries.length !== a.series.length) || this.legend.init(),
              ...
              var n = this.core.plotChartType(t, r),
                o = new z(this);
              o.bringForward(),
                i.config.dataLabels.background.enabled && o.dataLabelsBackground(),
          ...
          },
          {
            ...
            value: function () {
              ...
              return new Promise(function (s, r) {
                ...
                (null === e || a.globals.allSeriesCollapsed) && i.series.handleNoData(),
                  i.axes.drawAxis(a.config.chart.type, e.xyRatios),
                  (i.grid = new _(i));
                var n = i.grid.drawGrid();
                (i.annotations = new C(i)),
                  i.annotations.drawShapeAnnos(),
                  i.annotations.drawImageAnnos(),
                  i.annotations.drawTextAnnos(),
                  'back' === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el);
                var o = new G(t.ctx),
                  l = new q(t.ctx);
                if (
                  (null !== n && (o.xAxisLabelCorrections(n.xAxisTickWidth), l.setYAxisTextAlignments()),
                  'back' === a.config.annotations.position &&
                    (a.globals.dom.Paper.add(a.globals.dom.elAnnotations), i.annotations.drawAxesAnnotations()),
                  e.elGraph instanceof Array)
                )
                  for (var h = 0; h < e.elGraph.length; h++) a.globals.dom.elGraphical.add(e.elGraph[h]);
                else a.globals.dom.elGraphical.add(e.elGraph);
                if (
                  ('front' === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el),
                  ...
                  if (
                    ...
                    a.globals.axisCharts && (a.globals.isXNumeric || a.config.xaxis.convertedCatToNumeric))
                  )
                    (a.config.chart.zoom.enabled ||
                      (a.config.chart.selection && a.config.chart.selection.enabled) ||
