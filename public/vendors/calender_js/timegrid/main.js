...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@fullcalendar/core'), require('@fullcalendar/daygrid'))
    : typeof define === 'function' && define.amd
      ? define(['exports', '@fullcalendar/core', '@fullcalendar/daygrid'], factory)
      : ((global = global || self),
        factory((global.FullCalendarTimeGrid = {}), global.FullCalendar, global.FullCalendarDayGrid));
  ...
  var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
      ...
      return (
        ...
        (timeText
          ? '<div class="fc-time"' +
            ' data-start="' +
            core.htmlEscape(startTimeText) +
            '"' +
            ' data-full="' +
            core.htmlEscape(fullTimeText) +
            '"' +
            '>' +
            '<span>' +
            ...
            '</div>'
          : '') +
        (eventDef.title ? '<div class="fc-title">' + core.htmlEscape(eventDef.title) + '</div>' : '') +
        '</div>' +
    ...
    TimeGridEventRenderer.prototype.computeSegForwardBack = function (
      seg,
  ...
  var TimeGrid = /** @class */ (function (_super) {
    ...
    function TimeGrid(el, renderProps) {
      ...
      _this.renderBusinessHours = core.memoizeRendering(
        fillRenderer.renderSegs.bind(fillRenderer, 'businessHours'),
        fillRenderer.unrender.bind(fillRenderer, 'businessHours'),
        [renderColumns],
      );
      _this.renderDateSelection = core.memoizeRendering(_this._renderDateSelection, _this._unrenderDateSelection, [
        renderColumns,
      ]);
      _this.renderFgEvents = core.memoizeRendering(
        eventRenderer.renderSegs.bind(eventRenderer),
        eventRenderer.unrender.bind(eventRenderer),
        [renderColumns],
      );
      _this.renderBgEvents = core.memoizeRendering(
        fillRenderer.renderSegs.bind(fillRenderer, 'bgEvent'),
        fillRenderer.unrender.bind(fillRenderer, 'bgEvent'),
        [renderColumns],
      );
      _this.renderEventSelection = core.memoizeRendering(
    ...
    TimeGrid.prototype._processOptions = function (options) {
      ...
      this.labelFormat = core.createFormatter(
        input || {
          hour: 'numeric',
          minute: '2-digit',
          omitZeroMinute: true,
    ...
    TimeGrid.prototype._renderSlats = function (dateProfile) {
      ...
      this.slatContainerEl.innerHTML =
        '<table class="' + theme.getClass('tableGrid') + '">' + this.renderSlatRowHtml(dateProfile) + '</table>';
      this.slatEls = core.findElements(this.slatContainerEl, 'tr');
      this.slatPositions = new core.PositionCache(
        this.el,
        this.slatEls,
        false,
        true, // vertical
    ...
    TimeGrid.prototype.renderSlatRowHtml = function (dateProfile) {
      ...
      while (core.asRoughMs(slotTime) < core.asRoughMs(dateProfile.maxTime)) {
        ...
        html +=
          '<tr data-time="' +
          core.formatIsoTimeString(slotDate) +
          '"' +
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
      ...
      skeletonEl = this.contentSkeletonEl = core.htmlToElement(
        '<div class="fc-content-skeleton">' + '<table>' + '<tr>' + parts.join('') + '</tr>' + '</table>' + '</div>',
      );
    ...
    TimeGrid.prototype.computeTimeTop = function (duration) {
      ...
      var slatCoverage =
        (duration.milliseconds - core.asRoughMs(dateProfile.minTime)) / core.asRoughMs(this.slotDuration); // floating-point value of # of slots covered
      var slatIndex;
      var slatRemainder;
    ...
    TimeGrid.prototype.positionToHit = function (positionLeft, positionTop) {
      ...
      if (colIndex != null && slatIndex != null) {
        ...
        var time = core.addDurations(
          this.props.dateProfile.minTime,
          core.multiplyDuration(this.snapDuration, snapIndex),
        );
  ...
  var AbstractTimeGridView = /** @class */ (function (_super) {
    ...
    AbstractTimeGridView.prototype._renderSkeleton = function (context) {
      ...
      this.scroller = new core.ScrollComponent(
        'hidden', // overflow x
        'auto', // overflow y
      );
    ...
    AbstractTimeGridView.prototype.renderSkeletonHtml = function () {
      ...
      return (
        ...
        '">' +
        (options.allDaySlot
          ? '<div class="fc-day-grid"></div>' + '<hr class="fc-divider ' + theme.getClass('widgetHeader') + '" />'
          : '') +
        '</td>' +
        '</tr>' +
        '</tbody>' +
  ...
  var SimpleTimeGrid = /** @class */ (function (_super) {
    ...
    SimpleTimeGrid.prototype.render = function (props, context) {
      ...
      timeGrid.receiveProps(
        __assign({}, this.slicer.sliceProps(props, dateProfile, null, context.calendar, timeGrid, dayRanges), {
          dateProfile: dateProfile,
  ...
  var TimeGridView = /** @class */ (function (_super) {
    ...
    TimeGridView.prototype.render = function (props, context) {
      ...
      this.simpleTimeGrid.receiveProps(
        __assign({}, splitProps['timed'], { dateProfile: dateProfile, dayTable: dayTable }),
        context,
      );
      if (this.simpleDayGrid) {
        this.simpleDayGrid.receiveProps(
          __assign({}, splitProps['allDay'], {
            dateProfile: dateProfile,
            dayTable: dayTable,
