...
// async function redirectToGamepage(gameType) {
//   const formattedGameName = gameType.replaceAll(" ", "-");
//   const params = new URLSearchParams({ game: formattedGameName });
                        ...
                        dataGameWise?.map((data) => (
                          <tr align="center">
                            ...
                            <td
                              ...
                              //         )
                              //   }
                            //   onClick={() => redirectToGamepage(game.gameType)}
